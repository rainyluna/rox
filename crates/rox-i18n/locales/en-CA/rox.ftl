...
bookmark-new-title = New Bookmark
bookmark-edit-title = Edit Bookmark
bookmark-window-title = rox - { $verb }
bookmark-name = Name
bookmark-name-placeholder = Optional, the time stands in for a blank name
bookmark-position = At { $time }
bookmark-color = Color
bookmark-color-accent = Theme accent
bookmark-color-custom = Custom...
bookmark-color-red = Red
bookmark-color-orange = Orange
bookmark-color-yellow = Yellow
bookmark-color-green = Green
bookmark-color-teal = Teal
bookmark-color-blue = Blue
bookmark-color-purple = Purple
bookmark-color-pink = Pink
bookmark-save = Save
bookmark-hint-before = Press
bookmark-hint-key = Enter
bookmark-hint-after = to save
bookmark-menu-play = Play from Here
bookmark-menu-rename = Rename...
bookmark-menu-color = Color
bookmark-menu-move = Move to Playhead
bookmark-menu-remove = Remove
...
panel-copy = Copy
panel-copy-title = Copy Title
panel-copy-artist = Copy Artist
panel-copy-album = Copy Album
panel-copy-filename = Copy Filename
...
playback-item-ab-repeat = A-B Repeat
playback-item-favourite = Favourite
playback-item-rating = Rating
playback-sleep-15 = Stop after 15 minutes
playback-sleep-30 = Stop after 30 minutes
playback-sleep-60 = Stop after an hour
playback-sleep-90 = Stop after 90 minutes
playback-sleep-off = No sleep timer
playback-sleep-off-remaining = Cancel sleep timer ({ $minutes } min left)
playback-sleep-tip = Sleep timer
playback-sleep-tip-remaining = Sleep timer, { $minutes } min left
menubar-button-tasks = Tasks button
menubar-button-sleep = Sleep timer button
menubar-button-rescan = Rescan button

## Custom button states

# The player state a custom button's icon, colour, and tooltip can follow.
# One label per state, then one per case the state can be in.
...
# The app-wide flags a button can follow as well as the player's own:
# the theme side, the panel chrome, and the rest of the Window menu.
...
library-column-rename = Rename...
library-column-rename-reset = Reset Name
library-column-rename-name = Header
library-column-rename-note = Shown in place of the built-in header; empty goes back to it, and a single space leaves the header blank
library-sort-on-click = Click to Sort
    .description = Sort by clicking anywhere in a header instead of on its icon; reordering a column then takes Alt and a drag
library-group-search-results = Group Search Results
    .description = Keep the current group headers while searching; turn this off to show matching tracks as a flat list
...
settings-appearance-milkdrop-beat-sensitivity = Beat Sensitivity
    .description = How readily projectM calls something a beat. A quiet mix wants more than a loud one
settings-appearance-milkdrop-color = Color
    .description = Preset keeps the file's own colors. Theme flips them light on the light theme. Palette paints them in the theme's background and accent. Cover paints them in the playing cover's own color, song theming or not
settings-appearance-milkdrop-duration = Preset Duration
    .description = How long a preset holds before the next one comes up
settings-appearance-milkdrop-enabled = Milkdrop Backdrop
    .description = Run a Milkdrop visual behind the whole app while music plays
settings-appearance-milkdrop-error-title = The Milkdrop backdrop couldn't start
settings-appearance-milkdrop-fade-duration = Fade Time
    .description = How long the fade takes, out on a pause or stop and back in on play
settings-appearance-milkdrop-flip-horizontal = Flip Horizontal
    .description = Mirror the visual left to right
settings-appearance-milkdrop-flip-vertical = Flip Vertical
    .description = Mirror the visual top to bottom
settings-appearance-milkdrop-fps = Frame Rate
    .description = What the render thread aims for. 30 halves what reading each frame back costs, and a backdrop under a blur rarely needs more
settings-appearance-milkdrop-hard-cuts = Hard Cuts
    .description = Let a loud enough beat cut straight to the next preset
settings-appearance-milkdrop-idle = When Idle
    .description = What the visual does while playback is paused or stopped. Hold keeps the last frame behind the app. Fade takes it down to the cover backdrop and brings it back on play
settings-appearance-milkdrop-locked = Lock Preset
    .description = Stay on the current preset, across tracks and restarts
settings-appearance-milkdrop-preset = Preset
    .description = Which preset the backdrop shows. Works with nothing playing, and comes back after a restart
settings-appearance-milkdrop-rotation = Rotation
    .description = Which presets Next, Previous and the timed switch walk through
settings-appearance-milkdrop-scale = Render Scale
    .description = How much of the window's resolution the visual renders at. Lower costs less; a backdrop this soft rarely needs more
settings-appearance-milkdrop-strength = Strength
    .description = How far the visual carries over the blurred cover art
...
settings-appearance-section-milkdrop = Milkdrop Backdrop
...
settings-application-menu-entry = App Menu Entry
    .description = A launcher entry and file associations for this AppImage, kept pointing at wherever the file lives
...
settings-integrations-ffmpeg-binary = FFmpeg Binary
    .description = Which ffmpeg runs conversions; leave empty for the one on PATH, or for a build in rox's data folder
...
settings-integrations-ffmpeg-missing-note-flatpak = Convert stays hidden. Drop a static ffmpeg build into rox's data folder; one installed on your system can't run inside the sandbox.
...
settings-integrations-ffmpeg-reveal = Reveal Data Folder
...
settings-integrations-librefm-intro = Connect your Libre.fm account: authorize rox in the browser and played tracks scrobble to it once they cross the threshold
settings-integrations-listenbrainz-get-token = Get Token
settings-integrations-listenbrainz-intro = Paste the user token from listenbrainz.org/settings. Listens send once a play crosses the scrobble threshold.
settings-integrations-listenbrainz-token-placeholder = Token
settings-integrations-listenbrainz-token-row = User Token
...
settings-integrations-scrobble-connect = Connect
settings-integrations-scrobble-disconnect = Disconnect
settings-integrations-scrobble-finish-connecting = Finish Connecting
settings-integrations-scrobble-reconnect = Reconnect
settings-integrations-scrobble-status-checking = Checking the token
settings-integrations-scrobble-status-confirming = Confirming...
settings-integrations-scrobble-status-connected = Connected as { $username }
settings-integrations-scrobble-status-failed = Connection failed: { $error }
settings-integrations-scrobble-status-invalid = { $service } rejected that token
settings-integrations-scrobble-status-not-connected = Not connected
settings-integrations-scrobble-status-rejected = { $service } rejected the session and it was dropped. Connect again to keep scrobbling
settings-integrations-scrobble-status-requesting = Requesting a token...
settings-integrations-scrobble-status-waiting = Authorize rox in the browser, then finish connecting
settings-integrations-scrobble-threshold = Scrobble Threshold
    .description = How much of a track has to play before it scrobbles, to every connected service; the seek strip and waveform can mark it
settings-integrations-scrobble-tracks = Scrobble Tracks
    .description = Send played tracks to every connected service once they cross the threshold
settings-integrations-scrobble-working = Working...
...
settings-library-portal-hint = Replace /path/to with where the folder really lives.
settings-library-portal-note = That works, but it's slow for a library and rox can't watch it for changes. Give rox the folder's real location, then remove and re-add it:
settings-library-portal-title = rox reaches this folder through the file portal
...
settings-library-tempo-refused = { $count ->
    [one] . One track has no beat rox could count, so Analyze Missing leaves it alone
   *[other] . { $count } tracks have no beat rox could count, so Analyze Missing leaves them alone
}
settings-library-tempo-retry = Retry Refused
...
settings-library-tempo-status-measured-some = { $covered } of { $total } scanned tracks have a tempo, { $measured } of them worked out by rox
settings-library-tempo-status-none = { $total ->
    [one] The one scanned track doesn't say how fast it runs. Analyze Missing works it out
   *[other] None of the { $total } scanned tracks say how fast they run. Analyze Missing works them out
}
settings-library-tempo-status-partial = { $covered } of { $total } scanned tracks have a tempo, { $measured } of them worked out by rox. Analyze Missing works through the other { $missing }
...
settings-show-readings = Show readings
    .description = Put the romanized reading after a name written in a script this alphabet can't sound out: 秋ノ風 (Aki no kaze). The reading is the sort name the value already carries, so a name without one shows nothing and a Latin name never gets one
...
settings-dictionary-download-failed = The dictionary could not be downloaded: { $reason }
settings-dictionary-downloading = Downloading the dictionary: { $done } of { $total }
settings-dictionary-heading = Romanization
settings-dictionary-stopping = Stopping the dictionary download...
...
settings-providers-acoustid = AcoustID
    .description = Fingerprint the audio and ask acoustid.org which recording it is; the metadata compare's identify button finds a release for a file whose tags are too wrong to search
settings-providers-acoustid-key = AcoustID Key
settings-providers-acoustid-key-hint = Optional; this build ships its own key
settings-providers-acoustid-key-placeholder = Application key
...
settings-storage-looks-layouts = Looks and Layouts
    .description = The look the app is using (workspace.json) with your saved workspaces and ejected shader files beside it. Small, and every byte of it is something you set up
...
tasks-tempo-counted = { $count ->
    [one] The one track has a tempo
   *[other] { $count } tracks have a tempo
}
...
tasks-tempo-refused = { $count ->
    [one] One track has no beat rox could count
   *[other] { $count } tracks have no beat rox could count
}
tasks-timing = Timing { $progress }
tasks-filling = Filling { $progress }
tasks-job-sortnames = Sort Names
tasks-sortnames-all = { $count ->
    [one] The one artist has a sort name
   *[other] All { $count } artists have a sort name
}
tasks-sortnames-non-latin = , { $count } of them not in Latin letters, { $estimate }
tasks-sortnames-nothing = Nothing scanned to look up yet
tasks-sortnames-partial = { $missing } of { $total } artists have no sort name
tasks-start-fill-missing = Fill Missing
tasks-job-romanize = Romanize
tasks-reading-takes = , reading them takes { $estimate }
tasks-romanize-all = { $count ->
    [one] The one title, album or artist has a sort name
   *[other] All { $count } titles, albums and artists have a sort name
}
tasks-romanize-nothing = Nothing scanned to read yet
tasks-romanize-partial = { $missing } of { $total } titles, albums and artists have no sort name
tasks-romanizing = Reading { $progress }
tasks-romanize-skipped = { $count } were skipped for want of the Japanese dictionary
tasks-romanize-skipping = { $kanji } of them are kanji and need the Japanese dictionary from Settings > Library
tasks-start-romanize = Romanize
...
stats-bars-daily = Daily bars, click one to open it
stats-bars-days = { $days }-day bars, click one to open them
stats-bars-hourly = Hourly bars, the closest view
stats-bars-hours = { $hours }-hour bars, click one to open its day
stats-bars-weekly = Weekly bars, click one to open it
stats-bucket-listens = { $count ->
    [one] { $count } listen, { $ago } ({ $date })
   *[other] { $count } listens, { $ago } ({ $date })
}
stats-chart-end-day = Midnight
...
health-caption-art = { $albums } of { $total }, { $tracks }
health-caption-duplicates = { $groups } over { $tracks }
health-caption-formats = { $unwritable } of { $total }
health-caption-gaps = { $albums } of { $total }
health-caption-missing = { $missing } missing of { $total }
health-caption-sort = Album artists { $album_artists }, albums { $albums }, titles { $titles }
health-caption-split = { $tagged } tagged, { $measured } measured, { $missing } missing
health-caption-split-refused = { $tagged } tagged, { $measured } measured, { $missing } missing, { $refused } no beat
health-checks-menu = Counted Tags
    .description = Which of the five core tags the readout counts; the hover list always shows them all
health-click-opens = Click Opens Library Health
health-click-section = Click
health-complete = Nothing missing
health-count-groups = { $count ->
    [one] { $count } group
   *[other] { $count } groups
}
health-desc-acoustic = Tracks with no acoustic fingerprint, so nothing similar-sounding can be found for them.
health-desc-art = Albums with no cover, either embedded in the files or sitting beside them as an image.
health-desc-duplicates = Groups of tracks that share an artist and a title and run about the same length.
health-desc-gaps = Albums whose track numbers skip a number, or where a track carries no number at all.
health-desc-genre = Tracks whose files carry no genre.
health-desc-rating = Tracks you haven't rated yet.
...
health-fix-duplicates = Open Duplicates
health-fix-genres = Tag Genres
health-fix-measure = Measure Missing
health-fix-fill = Fill Missing
health-measuring-art = Probing album art, { $done } of { $total }
health-measuring-duplicates = Matching duplicates
health-measuring-formats = Reading file formats
health-measuring-gaps = Checking track numbers
health-open = Open Library Health
health-open-on-click = Open Library Health on Click
    .description = Click the widget to open the library health window, where the coverage is broken down
health-overview-complete = { $complete } of { $total } fully tagged
health-overview-missing = { $missing } missing
health-readout-section = Readout
health-running = Running
health-section-audio = Audio
health-section-files = Files and Structure
health-section-overview = Overview
health-section-tags = Tagging
health-show-percent = Show the Percentage
    .description = Draw the coverage beside the icon; off leaves a bare icon with the counts on hover
health-tile-acoustic = Acoustic Vectors
health-tile-album = Album
health-tile-art = Album Art
health-tile-artist = Artist
health-tile-duplicates = Duplicates
health-tile-gaps = Album Gaps
health-tile-genre = Genre
health-tile-rating = Rating
health-tile-replaygain = ReplayGain
health-tile-sort-names = Sort Names
health-tile-tempo = Tempo
health-tile-writable = Unsupported
health-tile-year = Year
health-tile-title = Title
health-tooltip-missing = Missing tags
health-waiting = Waiting
health-widget-title = Health Widget
health-window-title = rox - Library Health

## Power search window

search-seed-caption = { $source }: { $count }
search-window-title = rox - Power Search
...
welcome-menu-add = Add to App Menu
welcome-menu-failed = Couldn't add the menu entry
welcome-menu-not-now = Not Now
welcome-menu-note = An AppImage doesn't register itself. This adds a launcher entry and the audio file associations; nothing outside your home folder changes.
welcome-menu-title = Add rox to your app menu?
...
autoeq-placeholder = Search headphone or IEM (e.g. HD 600, AirPods, Zero)...
autoeq-search = Search AutoEq
autoeq-searching = Searching AutoEq...
autoeq-loading = Loading AutoEq database...
autoeq-none = No headphone profiles match "{ $text }"
autoeq-failed = AutoEq error: { $reason }
autoeq-apply = Apply
autoeq-applied = Applied
autoeq-import-file = Import preset file
eq-convolver-spatial = Spatial
eq-convolver-title = Convolver & Spatial
eq-convolver-no-file = No IR loaded (Built-in Crossfeed)
eq-convolver-load = Load IR...
eq-convolver-clear = Clear
eq-convolver-mode-label = Mode
eq-convolver-mode-virtual-stereo = Virtual Stereo
eq-convolver-mode-surround-71 = Surround 7.1
eq-convolver-wet-label = Wet Mix
eq-convolver-width-label = Width
eq-convolver-crossfeed-label = Crossfeed
eq-convolver-gain-label = Gain
eq-convolver-speakers-title = Speaker Levels
eq-convolver-reset-levels = Reset
eq-convolver-fl = Front L
eq-convolver-fr = Front R
eq-convolver-fc = Center
eq-convolver-sl = Side L
eq-convolver-sr = Side R
eq-convolver-bl = Rear L
eq-convolver-br = Rear R
eq-flatten = Flatten
eq-freq-label = Freq
eq-gain-label = Gain
...
keymap-mod-win = Win
keymap-new-window = New Window
    .description = Open another workspace window on the saved layout
keymap-next-track = Next Track
    .description = Skip to the next track in the queue
keymap-open-about = About
    .description = Show the version and credits
...
keymap-open-console = Console
    .description = Open the log console
keymap-open-equalizer = Equalizer
    .description = Open the equalizer window
keymap-open-preset-picker = Backdrop Presets
    .description = Open the Milkdrop preset picker over the backdrop
...
keymap-open-health = Library Health
    .description = Open the library health window, where the tag coverage and the structural gaps are counted
keymap-open-power-search = Power Search
    .description = Open a search window over its own query, so a search here leaves the workspace alone
...
keymap-ab-repeat = A-B Repeat
    .description = Mark A, then B, then clear
keymap-ab-clear = Clear A-B Section
    .description = Drop the A-B section and any half-marked step with it
keymap-bookmark = Add Bookmark
    .description = Drop a bookmark at the playing position
keymap-bookmark-named = Add Named Bookmark
    .description = Drop a bookmark at the playing position and name it
keymap-prev-bookmark = Previous Bookmark
...
keymap-type-ahead-next = Next Type-Ahead Match
...
keymap-toggle-mute = Mute
    .description = Silence the output without losing the level. Press again to bring it back
keymap-toggle-shuffle = Toggle Shuffle
    .description = Turn shuffle on or off for the queue
keymap-cycle-shuffle-mode = Cycle Shuffle Order
    .description = Step the order shuffle sorts by, random or nearest by sound
keymap-cycle-loop = Cycle Loop
    .description = Step loop from off to all to one and back around
keymap-toggle-stop-after = Stop After
    .description = Let the playing track finish, then pause. Press again to disarm
...
keymap-volume-up = Volume Up
    .description = Raise the volume one notch
keymap-volume-down = Volume Down
    .description = Lower the volume one notch
...
keymap-close-panel = Close Panel
    .description = Close the active panel in the focused panel group
keymap-new-empty-window = Empty Window
    .description = Open a workspace window with nothing in it
keymap-open-signals = Signals
    .description = Open the signals window, the pool behind every panel's routes
keymap-import-workspace = Import Workspace
    .description = Pick a workspace file and add it to the collection
...
keymap-toggle-quit-to-tray = Toggle Remain in Tray
    .description = Flip whether closing the last window keeps rox running in the tray
keymap-toggle-design-mode = Toggle Design Mode
    .description = Flip whether panels can be rearranged in place
keymap-toggle-theme = Toggle Light / Dark
    .description = Switch to the other palette side. Bound everywhere, since every window shares the theme
keymap-toggle-resize-lock = Toggle Lock Panel Resize
    .description = Flip whether panel resizing is reserved for design mode
keymap-toggle-menubar = Toggle Hide Menubar
    .description = Show the in-window menubar, or hide it until alt is held
keymap-toggle-decorations = Toggle OS Decorations
    .description = Switch the workspace windows between the OS frame and rox's own
keymap-toggle-art-theming = Toggle Song Theming
    .description = Flip whether the playing track's art tints the palette
...
keymap-rescan-library = Rescan Library
    .description = Scan every remembered library folder again
keymap-abort-scan = Stop Scan
    .description = Stop a running library scan at the next file. What it already indexed stays
keymap-measure-replaygain = Measure ReplayGain
    .description = Raise the prompt that measures loudness for the tracks that carry none
keymap-analyze-tempo = Analyze Tempo
    .description = Raise the prompt that listens for a beat in the tracks with no BPM
keymap-build-acoustic = Build Acoustic Vectors
    .description = Raise the prompt that builds the vectors the acoustic search reads
keymap-fill-sort-names = Fill Sort Names
    .description = Raise the prompt that asks MusicBrainz for the sort names the files don't carry
keymap-romanize-library = Romanize Library
    .description = Raise the prompt that reads non-Latin titles, albums and artists into Latin letters
keymap-find-duplicates = Find Duplicates
    .description = Open the duplicate finder over the library
keymap-tag-genres = Tag Genres
    .description = Open the genre tagger over the tracks with no genre
...
panel-catalog-health-widget = Health Widget
...
tags-editor-additional-tags = Additional Tags ({ $count })
tags-editor-remove = remove
tags-editor-replace = replace
tags-editor-replace-apply = Apply
tags-editor-replace-find = Find
tags-editor-replace-help = Every match rewrites. With regex on, $1 inserts the first group. Results trim their edges.
tags-editor-replace-ignore-case = Ignore case
tags-editor-replace-match-count = { $hits } of { $total } change
tags-editor-replace-regex = Regex
tags-editor-replace-with = Replace
tags-editor-reveal = Reveal
tags-editor-save-errors = { $count } files failed; { $error }
tags-editor-saving-progress = Saving { $done }/{ $total }...
tags-editor-sort-names = Sort names
tags-editor-table-view = Table
tags-editor-tag-columns = Additional tags
tags-editor-tag-field-conflict = the { $field } field writes this tag
tags-editor-tag-key-placeholder = Tag name
tags-editor-tag-value-placeholder = Value
...
tags-matcher-identify = Identify by Sound
tags-matcher-identify-no-duration = No track length to identify with
...
tags-rename-pattern-help = { $placeholders }; / makes a folder from the library root, no / renames in place, the extension follows the file
...
tag-genres-empty = Every track has a genre. Play something to retag it.
tag-genres-heading = Tag Genres
tag-genres-input-placeholder = Type a genre
tag-genres-keys-hint = 1-8 pick a row, Shift+1-8 add it to the box, Ctrl+1-8 pick it for the whole album, Enter applies what you typed, L looks up on Last.fm, S skips, Ctrl+Z undoes
tag-genres-library-loading = The library is still loading; try again shortly.
tag-genres-no-file = The library has no file for this track.
tag-genres-no-suggestions = Nothing to suggest; type a genre.
tag-genres-progress = { $at } of { $total } untagged
tag-genres-skip = Skip
tag-genres-thinking = Reading the neighbourhood...
tag-genres-undo = Undo
tag-genres-unwritable = This track lives inside a shared cue image, so its genre can't be written. Skip it.
tag-genres-window-title = rox - Tag Genres
tag-genres-looking-up = Asking Last.fm...
tag-genres-lookup = Look up on Last.fm
tag-genres-auto-lookup = Automatically
tag-genres-lookup-found = Last.fm tags { $artist } as: { $tags }
tag-genres-lookup-none = Last.fm has no tags for { $artist }.
tag-genres-lookup-off = Online artist lookups are off in Settings.
tag-genres-why-acoustic = { $count ->
    [one] { $count } track that sounds alike
   *[other] { $count } tracks that sound alike
}
tag-genres-why-album = { $count ->
    [one] { $count } track on this album
   *[other] { $count } tracks on this album
}
tag-genres-why-artist = { $count ->
    [one] { $count } track by this artist
   *[other] { $count } tracks by this artist
}
tag-genres-why-lookup = Last.fm
tag-genres-album-too = { $count ->
    [one] Tag the track's whole album and its { $count } sibling
   *[other] Tag the track's whole album and its { $count } siblings
}
tag-genres-apply = Apply
tag-genres-begin = Begin queue
tag-genres-col-genre = Genre
tag-genres-col-match = Match
tag-genres-col-why = Why
tag-genres-current-genre = Genre: { $genre }
tag-genres-idle = Nothing is playing. Begin the queue to work through the untagged tracks, or play something to retag it.
tag-genres-no-genre = No genre yet
tag-genres-stop = Stop queue
tag-genres-untagged-count = { $count ->
    [one] { $count } untagged track
   *[other] { $count } untagged tracks
}
tag-genres-write-error = { $name }: { $error }
tag-genres-writing = Writing { $done } of { $total }...
...
pass-tempo-retry-title = { $count ->
   ...
   *[other] Listen to { $count } refused tracks again?
}
...
pass-fill = Fill
pass-sortnames-body = Each artist is looked up on MusicBrainz for the Latin spelling they file under, so 米津玄師 lands under Y. The service allows one request a second, and that's what sets the pace. The answers go in the library database; your files are never touched.
pass-sortnames-scope-all = Also look up names that already file in Latin
pass-romanize = Romanize
pass-romanize-body = Every title, album and artist that still has no sort name is read into Latin letters, so レモン is found by typing "lemon". Korean and Chinese need nothing. Japanese kanji needs the dictionary from Settings > Library, and IPADIC gets names wrong often enough that the tag editor is there to correct it. The answers go in the library database; your files are never touched.
pass-romanize-title = { $count ->
    [one] Read 1 name into Latin letters?
   *[other] Read { $count } names into Latin letters?
}
pass-romanize-skips-kanji = { $kanji } of { $total } values are kanji and will be skipped until the Japanese dictionary is installed. Get it from Settings > Library.
pass-sortnames-title = { $count ->
    [one] Look up 1 artist?
   *[other] Look up { $count } artists?
}
...
quick-play-syntax-absent = Rows with no value at all
    .example = -year
quick-play-syntax-exclude = Everything but the matches
    .example = -genre:rock
quick-play-syntax-field = Pin one field, quote a value with spaces
    .example = artist:"Daft Punk"
quick-play-syntax-free = Match the title, artist, album artist, album, or genre
    .example = daft punk
quick-play-syntax-numeric = Compare a number; plays:0 and added:<90d work the same way
    .example = rating:>=4
quick-play-syntax-title = Search Syntax
quick-play-syntax-year = Digits, so a prefix takes the whole decade
    .example = year:199
...
waveform-loudness = Loudness Band
    .description = Draw the RMS level as a flatter band inside the peak envelope
waveform-gradient-mode = Color Source
    .description = Where the envelope and band take their colors: the accent, the theme ramp, the cover art, or a custom pair
waveform-scrobble-marker = Scrobble Marker
    .description = A thin line where the track counts as scrobbled to Last.fm
waveform-bookmarks = Bookmarks
...
shader-edit-here = Edit
shader-editor-window-title = rox - Shader Editor
shader-editor-target-screen = Screen Shader
shader-editor-target-backdrop = Backdrop Shader
shader-editor-origin-pool = A workspace shader: an apply reaches every surface using it
shader-editor-origin-pool-file = A workspace shader, with its working copy at { $path }
shader-editor-origin-file = Bookmarked to { $path }, which an apply writes too
shader-editor-origin-inline = This surface's own source
shader-editor-apply = Apply
shader-editor-revert = Revert
shader-editor-close = Close
shader-editor-hint-press = Press
shader-editor-hint-apply = to apply
shader-editor-status-unchecked = Nothing to check yet
shader-editor-status-ok = Compiles
shader-editor-status-error = This shader didn't compile:
shader-editor-section-uniforms = Uniforms
shader-editor-section-textures = Textures
shader-editor-section-slots = Slots
shader-editor-section-signals = Signals
shader-editor-slot-unnamed = Slot { $n }
shader-editor-signals-empty = The pool has no signals yet. Add some in the Signals window and they show here with live meters.
shader-editor-uniform-time = Seconds the shader has run, frozen while the feed is
shader-editor-uniform-delta = Seconds since its last frame, 0 on the first
shader-editor-uniform-resolution = The surface in device pixels
shader-editor-uniform-mouse = xy the cursor in device pixels, z and w the buttons
shader-editor-uniform-meta-0 = x volume, y track position, z playing, w track length in seconds
shader-editor-uniform-meta-1 = x page brightness, y light theme, z cursor presence, w content shape
shader-editor-texture-screen = What's under the surface this frame
shader-editor-texture-prev = This surface's own last frame, for trails
...
metadata-copy-field = Copy { $field }
metadata-cover-background = Cover Background
    .description = The track's cover art behind the fields
metadata-cover-opacity = Cover Opacity
    .description = How strongly the cover shows through behind the fields
...
metadata-field-album-artist-sort = Album artist sort
metadata-field-album-sort = Album sort
metadata-field-artist-sort = Artist sort
metadata-field-bit-depth = Bit Depth
metadata-field-bitrate = Bitrate
metadata-field-bookmarks = Bookmarks
metadata-field-bpm-measured = { $bpm } (measured by rox)
...
metadata-field-folder = Folder
metadata-field-gain-album = Album gain
metadata-field-gain-track = Track gain
metadata-field-last-played = Last played
metadata-field-lastfm-listeners = Global listeners
metadata-field-lastfm-loved = Loved on Last.fm
metadata-field-lastfm-plays = Global plays
metadata-field-lastfm-tags = Last.fm tags
metadata-field-lastfm-user-plays = Your scrobbles
metadata-field-lyrics = Lyrics
metadata-field-mb-country = Release country
metadata-field-mb-date = Released
metadata-field-mb-first-release = First released
metadata-field-mb-isrc = ISRC
metadata-field-mb-label = Label
metadata-field-missing = Missing
metadata-field-rank = Library rank
metadata-field-recent-plays = Plays (30 days)
metadata-field-sample-rate = Sample Rate
metadata-field-similar = Similar tracks
metadata-field-size = Size
metadata-field-title-sort = Title sort
metadata-field-track = Track
metadata-fields = Fields
    .description = Which fields the sheet lists; a field the track has nothing for reads n/a, and a sort name only shows where it differs
metadata-find-online = Find Metadata Online...
metadata-no-library = No library
metadata-romanize = Romanize
metadata-romanize-needs-dictionary = A kanji name needs the Japanese dictionary. Get it from Settings > Library.
metadata-romanize-sort-names = Romanize Sort Names
metadata-row-borders-description = The hairline under each row of the table
metadata-cover-embedded = Embedded, { $px }
metadata-cover-folder = { $file }, { $px }
metadata-hide-empty = Hide Empty Fields
    .description = Leave out a shown field the track has nothing for, instead of listing it as n/a
metadata-loved-no = No
metadata-loved-yes = Yes
metadata-lyrics-plain = Plain
metadata-lyrics-synced = Synced
metadata-missing-none = Nothing
metadata-rank-value = #{ $rank }
metadata-tags-scope-album = (album tags)
metadata-tags-scope-artist = (artist tags)
metadata-track-of = { $track } of { $total }
metadata-value-none = n/a
...
art-perspective = Perspective
    .description = Turn the side covers at the angle below; off leaves them flat and square, the only mode where cover rounding applies
art-recede = Depth Light
    .description = How lit the deepest cover in the rack is; the covers between it and the center share the distance evenly
art-spacing = Cover Spacing
    .description = How far the first cover on each side sits from the centered one; past the halfway mark it clears the center cover and leaves it room
art-stride = Stack Spacing
    .description = How far apart the covers behind the first one sit; it also sets how far a drag travels per cover
art-visible = Covers Shown
    .description = How many covers stand to each side of the center one; the last one fades out as it goes
art-tilt = Turn Angle
    .description = How far the side covers rotate away from you
...
biography-active-between = Active { $from } to { $to }
biography-active-since = Active since { $from }
biography-background = Background
    .description = The artist fanart behind the text, dimmed and fading out toward the bottom
biography-background-opacity = Background Opacity
    .description = How strongly the fanart shows through behind the text
biography-cycle = Cycle Header Images
    .description = Rotate through the artist's banner and fanart in the header with a crossfade, and step through them by hand with the arrows that show on hover
biography-cycle-interval = Cycle Interval
    .description = How long each header image stays before the next fades in
biography-fill-width = Fill Width
    .description = Let a tall header span the full width instead of staying capped and centered
biography-flag = Country Flag
    .description = Show the country as its flag instead of its two-letter code
biography-from-lastfm = From Last.fm
biography-header-banner = Banner Strip
    .description = The wide logo strip TheAudioDB keeps for the artist, in the header
biography-header-blur = Fit with Blurred Fill
    .description = With the proportions off, fit the whole image into the band over a blurred wash of itself instead of cropping it
biography-header-fanart = Fanart
    .description = The artist's 16:9 fanarts from TheAudioDB, in the header
biography-header-height = Header Height
    .description = The header band's height in px, and the cap on one kept at its own proportions
...
biography-header-overlay = Title on Header
    .description = Lay the name, origin, and years over the bottom of the header image instead of below it
...
biography-name-source = Name From
    .description = Which tag names the artist: the track's own artist, or the album artist for a compilation or a guest-heavy record
...
biography-profile = Origin and Years
    .description = The country code and the years active, from TheAudioDB
biography-refresh = Refresh
biography-seconds = { $count } s
biography-similar-artists = Similar Artists
    .description = Related artists by listening data, as chips: a click turns the sheet to one, and a search glyph on the ones the library holds picks them on the search
...
biography-top-tracks = Top Tracks
    .description = The most played tracks on Last.fm, with a click playing any the library has and the plus queuing it
biography-top-tracks-count = Track Count
    .description = How many of the top tracks to list
biography-top-tracks-heading = Top tracks
...
columns-album-artist-sort = Album artist sort
columns-album-sort = Album sort
columns-artist-sort = Artist sort
columns-bits = Bits
columns-bpm = BPM
columns-codec = Codec
columns-cover = Cover
...
filter-over-cap = { $count } more, search to narrow
...
playback-ab-clear = Clear A-B
playback-ab-set-a = Set A
playback-ab-set-b = Set B
playback-ab-tip-a = A at { $a }. Press again to mark B
playback-ab-tip-looping = Repeating { $a } to { $b }
playback-ab-tip-off = Mark the start of a section to repeat
...
playback-menu-ab-repeat = A-B Repeat Button
...
dictionary-summary-lindera-ipadic = The Japanese dictionary behind kanji readings. Without it, kana and hangul still romanize and Chinese still reads as pinyin, but a kanji title is skipped
...
milkdrop-tuning = Tuning
milkdrop-roots = Preset Folders
milkdrop-add-root = Add Folder
milkdrop-remove-root = Remove
milkdrop-folder = Where rox Looks
milkdrop-filter-presets = Filter presets
milkdrop-preset-count = { $count } of { $total } presets
milkdrop-locked = Lock Preset
    .description = Stay on this one: no timed switch, no cut on a beat
milkdrop-duration = Preset Duration
    .description = How long a preset holds before the next one comes up
milkdrop-beat-sensitivity = Beat Sensitivity
    .description = How readily projectM calls something a beat. A quiet mix wants more than a loud one
milkdrop-hard-cuts = Hard Cuts
    .description = Let a loud enough beat cut straight to the next preset
milkdrop-fps = Frame Rate
    .description = What the render thread aims for. 30 halves what reading each frame back costs
milkdrop-scale = Render Scale
    .description = Render below the panel's own size and upscale. Costs sharpness, saves the same fraction of the readback
milkdrop-tint = Album Color
    .description = Turn the visual's hues toward the playing track's cover art. Zero leaves the preset's own colors alone
milkdrop-fade-duration = Fade Time
milkdrop-idle = When Idle
    .description = What the visual does while playback is paused or stopped. Hold keeps the last frame on screen. Fade takes it down to the panel background and brings it back on play
milkdrop-idle-hold = Hold
milkdrop-idle-fade = Fade
milkdrop-run-focused = Run While Focused
    .description = Keep the visual moving while the panel has focus, playing or not. Off, a held frame stays held even with the panel focused
milkdrop-show-name = Show Preset Name
    .description = Name the preset in the corner for a few seconds when it changes
milkdrop-next = Next Preset
milkdrop-previous = Previous Preset
milkdrop-random = Random Preset
milkdrop-open-folder = Open Presets Folder
milkdrop-rescan = Rescan
milkdrop-rotation = Rotation
    .description = Which presets Next, Previous and the timed switch walk through
milkdrop-rotation-all = All presets
milkdrop-empty = No presets found.
    .description = Drop a pack into the folder below, then hit Rescan. These are the three worth having, all under projectM-visualizer on GitHub.
milkdrop-packs-hint = Drop preset packs in here. The three worth having are presets-cream-of-the-crop, presets-milkdrop-original and presets-milkdrop-texture-pack, all on GitHub under projectM-visualizer.
milkdrop-no-gl = Milkdrop couldn't start.
milkdrop-still-starting = Milkdrop is still starting.
milkdrop-still-starting-detail = Waiting on the graphics driver for an OpenGL context.
milkdrop-no-frames = Milkdrop is running but no frame has arrived.
milkdrop-no-frames-detail = Rendering on { $renderer }, { $version }. The console has the details.
milkdrop-favorite = Favorite Preset
milkdrop-favorite-short = Favorite
milkdrop-favorited = Favorited
milkdrop-favorites-only = Favorites Only
milkdrop-rotation-favorites = Favorites ({ $count })
milkdrop-no-favorites = Nothing is starred yet, so this shuffles the whole library. Star a preset from the list, the panel menu, or the Now Showing row.
milkdrop-reveal = Reveal Preset
milkdrop-reveal-short = Reveal
milkdrop-current = Now Showing
milkdrop-no-preset = Nothing loaded yet
milkdrop-color = Color
    .description = Preset keeps the file's own colors. Theme flips them light on the light theme. Palette paints them in the theme's background and accent, and skips the album color. Cover paints them in the playing cover's own color, song theming or not
milkdrop-color-preset = Preset
milkdrop-color-theme = Theme
milkdrop-color-palette = Palette
milkdrop-color-cover = Cover
milkdrop-name-always = Keep Name On Screen
    .description = Keep the name up the whole time instead of a few seconds
milkdrop-flip-horizontal = Flip Horizontal
    .description = Mirror the visual left to right
milkdrop-flip-vertical = Flip Vertical
    .description = Mirror the visual top to bottom
milkdrop-choose = Choose Preset
milkdrop-picker-title = Choose Preset
milkdrop-picker-backdrop = Backdrop
milkdrop-picker-host = Picking for { $host }
milkdrop-view-tree = Tree
milkdrop-view-grid = Grid
milkdrop-nested = Nested
milkdrop-locate-current = Go to Active
milkdrop-load-preset = Load Preset
milkdrop-unfavorite = Unfavorite Preset
