...
settings-search-scope = Шукати лише на відкритій сторінці

## Embed dialog
bookmark-new-title = Нова закладка
bookmark-edit-title = Змінити закладку
bookmark-window-title = rox - { $verb }
bookmark-name = Назва
bookmark-name-placeholder = Необов'язково, без назви показується час
bookmark-position = На { $time }
bookmark-color = Колір
bookmark-color-accent = Акцент теми
bookmark-color-custom = Власний...
bookmark-color-red = Червоний
bookmark-color-orange = Помаранчевий
bookmark-color-yellow = Жовтий
bookmark-color-green = Зелений
bookmark-color-teal = Бірюзовий
bookmark-color-blue = Синій
bookmark-color-purple = Фіолетовий
bookmark-color-pink = Рожевий
bookmark-save = Зберегти
bookmark-hint-before = Натисніть
bookmark-hint-key = Enter
bookmark-hint-after = щоб зберегти
bookmark-menu-play = Відтворити звідси
bookmark-menu-rename = Перейменувати...
bookmark-menu-color = Колір
bookmark-menu-move = Перемістити до позиції відтворення
bookmark-menu-remove = Вилучити
bookmark-menu-remove-many = Вилучити закладки: { $count }
bookmarks-title = Закладки
bookmarks-empty = Закладок ще немає. Натисніть M під час відтворення, щоб поставити закладку, або Shift+M, щоб дати їй назву.
cue-menu-insert = Вставити позначку тут
cue-menu-bookmark = Додати закладку тут
cue-menu-remove = Вилучити позначку
position-bound-streaming = Недоступно під час трансляції
...
playback-item-ab-repeat = Повтор A-B
playback-item-favourite = Улюблене
playback-item-rating = Оцінка
playback-sleep-15 = Зупинити через 15 хвилин
playback-sleep-30 = Зупинити через 30 хвилин
playback-sleep-60 = Зупинити через годину
playback-sleep-90 = Зупинити через 90 хвилин
playback-sleep-off = Без таймера сну
playback-sleep-off-remaining = Скасувати таймер сну (лишилось { $minutes } хв)
playback-sleep-tip = Таймер сну
playback-sleep-tip-remaining = Таймер сну, лишилось { $minutes } хв
menubar-button-tasks = Кнопка завдань
menubar-button-sleep = Кнопка таймера сну
menubar-button-rescan = Кнопка пересканування
...
library-group-search-results = Групувати результати пошуку
    .description = Зберігає поточні заголовки груп під час пошуку; вимкніть, щоб показувати знайдені треки плоским списком
...
stations-import-empty = У цьому файлі немає жодного URL потоку
stations-not-a-stream = Станції відтворюються через http або https; це не URL потоку
stations-empty-title = Станцій ще немає
stations-empty = Знайдіть станцію в каталозі або ведіть свій список у налаштуваннях.
stations-on-air = В ефірі
stations-clocks = Час на цьому треку і на цій станції
stations-homepage = Відкрити сайт

## Station directory

directory-window-title = Каталог радіостанцій
directory-placeholder = Знайти станції на radio-browser.info
directory-search = Шукати в каталозі
directory-add = Додати
directory-add-play = Додати і відтворити
directory-added = Вже серед ваших станцій
directory-searching = Пошук на radio-browser.info...
directory-none = На radio-browser.info нічого не знайдено за запитом «{ $text }»
directory-failed = radio-browser.info не відповів: { $reason }
directory-bitrate = { $kbps } кбіт/с
...
settings-appearance-milkdrop-beat-sensitivity = Чутливість до біту
    .description = Наскільки охоче projectM вважає щось бітом. Тихому міксу треба більше, ніж гучному
settings-appearance-milkdrop-color = Колір
    .description = Пресет лишає кольори файлу. Тема перевертає їх у світлі на світлій темі. Палітра фарбує їх у тло й акцент теми. Обкладинка фарбує їх у колір обкладинки, що грає, незалежно від теми за треком
settings-appearance-milkdrop-duration = Тривалість пресету
    .description = Скільки тримається пресет, перш ніж прийде наступний
settings-appearance-milkdrop-enabled = Тло Milkdrop
    .description = Крутити візуалізацію Milkdrop позаду всього застосунку, поки грає музика
settings-appearance-milkdrop-error-title = Тло Milkdrop не змогло запуститися
settings-appearance-milkdrop-fade-duration = Тривалість згасання
    .description = Скільки триває згасання: на виході при паузі чи зупинці та на вході при відтворенні
settings-appearance-milkdrop-flip-horizontal = Віддзеркалити по горизонталі
    .description = Дзеркалить візуал зліва направо
settings-appearance-milkdrop-flip-vertical = Віддзеркалити по вертикалі
    .description = Дзеркалить візуал згори донизу
settings-appearance-milkdrop-fps = Частота кадрів
    .description = До чого прагне потік малювання. 30 удвічі зменшує ціну зворотного читання кожного кадру, а розмитому тлу рідко треба більше
settings-appearance-milkdrop-hard-cuts = Різкі переходи
    .description = Досить гучний біт одразу перемикає на наступний пресет
settings-appearance-milkdrop-idle = У простої
    .description = Що робить візуалізація, поки відтворення на паузі або зупинене. Тримати залишає останній кадр за застосунком. Згасати зводить його до фону обкладинки й повертає при відтворенні
settings-appearance-milkdrop-locked = Закріпити пресет
    .description = Лишатися на поточному пресеті між треками й перезапусками
settings-appearance-milkdrop-preset = Пресет
    .description = Який пресет показує тло. Працює без відтворення й повертається після перезапуску
settings-appearance-milkdrop-rotation = Ротація
    .description = Які пресети перебирають «Далі», «Назад» і зміна за таймером
settings-appearance-milkdrop-scale = Масштаб рендеру
    .description = Яку частку роздільності вікна рендерить візуалізація. Менше коштує дешевше; такому м'якому тлу рідко треба більше
settings-appearance-milkdrop-strength = Сила
    .description = Наскільки далеко візуалізація проступає поверх розмитої обкладинки
...
settings-appearance-section-milkdrop = Тло Milkdrop
...
settings-application-menu-entry = Пункт у меню програм
    .description = Ярлик запуску й прив'язки файлів для цього AppImage, які завжди вказують туди, де зараз лежить файл
...
settings-integrations-ffmpeg-binary = Виконуваний файл FFmpeg
    .description = Який ffmpeg виконує конвертації; лишіть порожнім, щоб узяти той, що в PATH, або збірку з теки даних rox
...
settings-integrations-ffmpeg-missing-note-flatpak = Конвертація лишається прихованою. Покладіть статичну збірку ffmpeg до теки даних rox; встановлена в системі всередині пісочниці не запуститься.
...
settings-integrations-ffmpeg-reveal = Показати теку даних
...
settings-integrations-librefm-intro = Під'єднайте свій акаунт Libre.fm: авторизуйте rox у браузері, і прослухані треки підуть туди у скробл, щойно перетнуть поріг
settings-integrations-listenbrainz-get-token = Отримати токен
settings-integrations-listenbrainz-intro = Вставте користувацький токен із listenbrainz.org/settings. Прослуховування надсилаються, щойно трек перетне поріг скроблу.
settings-integrations-listenbrainz-token-placeholder = Токен
settings-integrations-listenbrainz-token-row = Користувацький токен
...
settings-integrations-scrobble-connect = Під'єднати
settings-integrations-scrobble-disconnect = Від'єднати
settings-integrations-scrobble-finish-connecting = Завершити під'єднання
settings-integrations-scrobble-reconnect = Під'єднатися знову
settings-integrations-scrobble-status-checking = Перевірка токена
settings-integrations-scrobble-status-confirming = Підтверджуємо...
settings-integrations-scrobble-status-connected = Під'єднано як { $username }
settings-integrations-scrobble-status-failed = Не вдалося під'єднатися: { $error }
settings-integrations-scrobble-status-invalid = { $service } відхилив цей токен
settings-integrations-scrobble-status-not-connected = Не під'єднано
settings-integrations-scrobble-status-rejected = { $service } відхилив сеанс, і його скинуто. Під'єднайтеся знову, щоб скробл тривав
settings-integrations-scrobble-status-requesting = Запитуємо токен...
settings-integrations-scrobble-status-waiting = Авторизуйте rox у браузері, а потім завершіть під'єднання
settings-integrations-scrobble-threshold = Поріг скроблу
    .description = Скільки треку має відіграти, перш ніж він піде у скробл до кожного під'єднаного сервісу; смуга перемотки й хвиля можуть це позначити
settings-integrations-scrobble-tracks = Скроблити треки
    .description = Надсилати прослухані треки до кожного під'єднаного сервісу, щойно вони перетнуть поріг
settings-integrations-scrobble-working = Працюємо...
...
settings-integrations-subsonic-connect = Підключити
settings-integrations-subsonic-credentials = Вхід
    .description = Обліковий запис на сервері; пароль зберігається в accounts.json і ніколи в settings.json
settings-integrations-subsonic-enable = Використовувати сервер Subsonic
    .description = Читати медіатеку із сервера Subsonic або OpenSubsonic і грати з нього
settings-integrations-subsonic-password-placeholder = Пароль
settings-integrations-subsonic-server = Сервер
    .description = Адреса сервера з http:// або https://, і без /rest у кінці
settings-integrations-subsonic-status-failed = Не вдалося зв'язатися із сервером: { $error }
settings-integrations-subsonic-status-ok = Підключено до { $server }
settings-integrations-subsonic-sync-count = { $n ->
    [one] { $n } трек, синхронізовано { $date }
    [few] { $n } треки, синхронізовано { $date }
    [many] { $n } треків, синхронізовано { $date }
   *[other] { $n } трека, синхронізовано { $date }
}
settings-integrations-subsonic-sync-failed = Синхронізація не вдалася: { $error }
settings-integrations-subsonic-sync-never = Ще не синхронізовано
settings-integrations-subsonic-sync-now = Синхронізувати
    .description = Запитати в сервера, що він має, і привести медіатеку до цього; треки, яких він більше не віддає, видаляються
settings-integrations-subsonic-syncing = Синхронізація альбому { $done } з { $total }
settings-integrations-subsonic-url-placeholder = https://music.example.com
settings-integrations-subsonic-user-placeholder = Ім'я користувача
...
settings-library-portal-hint = Замініть /path/to на те, де тека насправді розташована.
settings-library-portal-note = Це працює, але для бібліотеки повільно, і rox не може стежити за змінами. Дайте rox доступ до справжнього розташування теки, потім вилучіть її та додайте знову:
settings-library-portal-title = rox відкриває цю теку через файловий портал
...
settings-playback-live-buffer = Буфер ефіру
    .description = Наскільки далеко можна відмотати станцію назад. На паузі з'єднання лишається відкритим і буфер далі заповнюється, тож відтворення продовжиться з місця зупинки, а не з ефіру. Дванадцять годин це практична нескінченність: ніщо, залишене грати за один раз, не встигне його перекрити.
settings-playback-live-buffer-memory = Близько { $low } при 128 kbps, { $high } при 320 kbps.
settings-playback-live-buffer-playing = Поточна станція: близько { $size }.
settings-playback-capture-album = Альбом для записів
    .description = Що записується в тег альбому збереженої пісні. Порожньо означає без альбому: пісня з ефіру не має релізу, а назви станцій у полі альбому засмічують усі подання за альбомами. %station% ставить туди станцію; слово на кшталт Radio чи Singles складає їх на окрему полицю. Станція та URL потоку завжди йдуть у коментар.
settings-playback-capture-album-placeholder = Залиште порожнім
settings-playback-capture-choose = Вибрати теку...
settings-playback-capture-enable = Зберігати пісні з потокових джерел
    .description = Записує до теки для записів кожну пісню, яку потік відтворює від початку до кінця, у форматі самого потоку та без перекодування, з тегами станції. Обкладинка пісні зберігається поруч під тією ж назвою, якщо її вдається знайти. Межі між піснями беруться з назв, які надсилає станція, а вони надходять на кілька секунд раніше або пізніше за звук, тож до запису може потрапити хвіст попередньої пісні. Пісня, довша за живий буфер, ніколи не зберігається, тож подкаст чи мікс лишаються в ефірі.
settings-playback-capture-folder = Тека для записів
settings-playback-capture-pattern = Імена записів
    .description = Як називається збережена пісня в теці для записів. Символ / створює теку, тому типово вечір радіо розкладається за станціями, а не звалюється в одну купу. Розширення береться з потоку.
settings-playback-capture-pattern-date = %date% підставляє день, коли пісню було збережено, у вигляді 2026-09-18.
settings-playback-capture-pattern-preview = Перегляд: { $name }
settings-playback-capture-pattern-station = %station% підставляє назву станції, і %album% робить те саме.
settings-playback-section-capture = Запис
...
settings-playback-section-radio = Радіо
...
settings-providers-acoustid = AcoustID
    .description = Зняти відбиток звуку й спитати acoustid.org, що це за запис; кнопка розпізнавання у порівнянні метаданих знаходить видання навіть для файлу, теги якого надто хибні для пошуку
settings-providers-acoustid-key = Ключ AcoustID
settings-providers-acoustid-key-hint = Необов'язково; ця збірка має власний ключ
settings-providers-acoustid-key-placeholder = Ключ застосунку
...
settings-sources-folders-note = Теки, які сканує rox, є на сторінці «Медіатека», поруч із налаштуваннями сканування та тегів, що їх читають.
settings-sources-folders-open = Сторінка медіатеки
settings-sources-section-folders = Локальні теки
settings-sources-section-stations = Радіостанції
settings-sources-stations-find = Знайти станції...
settings-sources-stations-import = Імпортувати станції...
settings-sources-stations-name-placeholder = Назва (необов'язково)
settings-sources-stations-none = Станцій ще немає
settings-sources-stations-url-placeholder = URL потоку
...
settings-storage-looks-layouts = Вигляд і розкладки
    .description = Вигляд, яким зараз користується застосунок (workspace.json), а поруч ваші збережені робочі простори й вивантажені файли шейдерів. Мало місця, і кожен байт цього ви налаштували самі
...
menu-quick-play = Швидкий запуск
...
health-desc-writable = Треки у форматах, які rox читає, але не може записати в них теги. Рідкісний різновид фрагментованих MP4 теж відмовляє у записі, і тут він не врахований.
...
welcome-menu-add = Додати до меню програм
welcome-menu-failed = Не вдалося додати пункт меню
welcome-menu-not-now = Не зараз
welcome-menu-note = AppImage сам себе не реєструє. Це додасть ярлик запуску й прив'язки аудіофайлів; поза домашньою текою нічого не зміниться.
welcome-menu-title = Додати rox до меню програм?
...
autoeq-placeholder = Пошук навушників (напр. HD 600, AirPods, Zero)...
autoeq-search = Шукати в AutoEq
autoeq-searching = Пошук в AutoEq...
autoeq-loading = Завантаження бази даних AutoEq...
autoeq-none = Профілі для «{ $text }» не знайдені
autoeq-failed = Помилка AutoEq: { $reason }
autoeq-apply = Застосувати
autoeq-applied = Застосовано
autoeq-import-file = Імпортувати файл пресету
eq-flatten = Вирівняти
eq-freq-label = Частота
eq-gain-label = Підсилення
eq-heading = Еквалайзер
eq-help-text = Тягніть смугу, щоб її пересунути, крутіть колесо над нею, щоб розширити чи звузити. Обробка працює перед буфером, який подає звук на карту, тож, поки це вікно відкрите, рухові треба близько 120 мс, щоб дійти до колонок.
...
keymap-open-preset-picker = Пресети тла
    .description = Відкрити вибір пресетів Milkdrop для тла
...
keymap-ab-repeat = Повтор A-B
    .description = Позначте A, потім B, потім скиньте
keymap-ab-clear = Clear A-B Section
    .description = Drop the A-B section and any half-marked step with it
keymap-bookmark = Додати закладку
    .description = Поставити закладку на поточній позиції
keymap-bookmark-named = Додати закладку з назвою
    .description = Поставити закладку на поточній позиції та дати їй назву
keymap-prev-bookmark = Попередня закладка
    .description = Повернутися до закладки перед позицією відтворення
keymap-next-bookmark = Наступна закладка
    .description = Перейти до наступної закладки
keymap-cue = Додати позначку
    .description = Поставити сеансову позначку в поточній позиції. Позначки живуть до закриття rox
keymap-cue-prev = Попередня позначка
    .description = Повернутися до позначки перед курсором
keymap-cue-next = Наступна позначка
    .description = Перейти до наступної позначки
...
tags-editor-replace = замінити
tags-editor-replace-apply = Застосувати
tags-editor-replace-find = Знайти
tags-editor-replace-help = Кожен збіг переписується. З regex $1 вставляє першу групу. Результати обрізаються по краях.
tags-editor-replace-ignore-case = Без урахування регістру
tags-editor-replace-match-count = Зміниться: { $hits } з { $total }
tags-editor-replace-regex = Regex
tags-editor-replace-with = Замінити на
...
tags-matcher-identify = Упізнати за звуком
tags-matcher-identify-no-duration = Немає тривалості треку для розпізнавання
...
tags-rename-pattern-help = { $placeholders }; / робить теку від кореня бібліотеки, без / перейменовує на місці, розширення йде за файлом
...
lyrics-edit-offset = Зсув
lyrics-edit-offset-unit = с
...
pass-tempo-body = З кожного файлу декодуються два вікна по пів хвилини, і в них рахуються біти, а якщо ці два розходяться, читаються ще вікна, щоб медіатека могла показати, з якою швидкістю йде трек. Найкраще це працює на музиці, записаній під клік, а те, що зміряти не вдається, пропускається. Числа лягають у базу медіатеки, а ваші файли лишаються недоторканими.
...
waveform-loudness = Смуга гучності
    .description = Малювати рівень RMS пласкішою смугою всередині обвідної піків
waveform-gradient-mode = Джерело кольору
    .description = Звідки обвідна та смуга беруть кольори: акцент, шкала теми, обкладинка або власна пара
waveform-scrobble-marker = Позначка скроблу
    .description = Тонка лінія там, де трек зараховується у скробл на Last.fm
waveform-bookmarks = Закладки
    .description = Закладки поточного треку у вигляді галочок уздовж нижнього краю: клік переходить до них, правий клік відкриває редагування
waveform-split-channels = Розділити канали
    .description = По рядку на канал, лівий над правим; моно-треки лишаються одним рядком
waveform-live-mode = Вигляд в ефірі
    .description = Що малює смуга, поки йде радіопотік: нічого, звук самого потоку або фігуру, яку вона малює сама
waveform-live-trace = Доріжка
waveform-live-motion = Рух
waveform-live-window = Вікно ефіру
    .description = Скільки секунд радіопотоку охоплює рухома доріжка; ширше вікно, повільніша прокрутка
waveform-live-expression = Формула руху
    .description = x іде від 0 до 1 по ширині смуги, t — це секунди за годинником панелі; sin cos tan abs sqrt exp ln floor min max clamp mix, а також + - * / ^ pi і дужки
waveform-live-expression-error = { $reason }, тому смуга малює фігуру за умовчанням
waveform-section-live = Ефір
waveform-streaming = ПОТІК
...
metadata-cover-opacity = Непрозорість обкладинки
    .description = Наскільки сильно обкладинка проступає за полями
...
metadata-field-bookmarks = Закладки
metadata-field-bpm-measured = { $bpm } (виміряно rox)
metadata-field-codec = Кодек
metadata-field-comment = Коментар
metadata-field-copies = Копії
metadata-field-cover = Обкладинка
metadata-field-source = Джерело
...
metadata-field-first-played = Перше прослуховування
metadata-field-folder = Тека
metadata-field-gain-album = Підсилення альбому
metadata-field-gain-track = Підсилення треку
metadata-field-last-played = Останнє прослуховування
metadata-field-lastfm-listeners = Слухачів у світі
metadata-field-lastfm-loved = Улюблений на Last.fm
metadata-field-lastfm-plays = Прослуховувань у світі
metadata-field-lastfm-tags = Теги Last.fm
metadata-field-lastfm-user-plays = Ваші скробли
metadata-field-lyrics = Текст
metadata-field-mb-country = Країна випуску
metadata-field-mb-date = Випущено
metadata-field-mb-first-release = Перший випуск
metadata-field-mb-isrc = ISRC
metadata-field-mb-label = Лейбл
metadata-field-missing = Бракує
metadata-field-rank = Місце в бібліотеці
metadata-field-recent-plays = Прослуховувань (30 днів)
metadata-field-sample-rate = Частота дискретизації
metadata-field-similar = Схожі треки
metadata-field-size = Розмір
metadata-field-title-sort = Сортування назви
metadata-field-track = Трек
metadata-fields = Поля
    .description = Які поля показує аркуш; поле без значення показує н/д, а імʼя для сортування зʼявляється лише там, де відрізняється
...
metadata-cover-embedded = Вбудована, { $px }
metadata-cover-folder = { $file }, { $px }
metadata-hide-empty = Ховати порожні поля
    .description = Не показувати ввімкнене поле без значення замість рядка н/д
metadata-loved-no = Ні
metadata-loved-yes = Так
metadata-lyrics-plain = Лише текст
metadata-lyrics-synced = З таймінгом
metadata-missing-none = Нічого
metadata-rank-value = № { $rank }
metadata-tags-scope-album = (теги альбому)
metadata-tags-scope-artist = (теги виконавця)
metadata-track-of = { $track } з { $total }
metadata-value-none = н/д
...
history-live-plays-file = Відтворить вашу копію цієї пісні
history-live-plays-station = Відтворить радіостанцію: цієї пісні немає в медіатеці
...
playlists-export-tooltip = Експортувати список
...
playlists-import = Імпортувати список...
...
## Biography panel
biography-active-between = Роки активності: з { $from } по { $to }
biography-active-since = Роки активності: з { $from }
biography-background = Тло
    .description = Фанарт виконавця за текстом, притлумлений і згасає донизу
biography-background-opacity = Непрозорість тла
    .description = Наскільки сильно фанарт проступає за текстом
biography-cycle = Змінювати зображення шапки
    .description = Перебирати банер і фанарт виконавця в шапці з плавним переходом, а стрілками, що зʼявляються при наведенні, гортати вручну
biography-cycle-interval = Інтервал зміни
    .description = Скільки тримається кожне зображення шапки, перш ніж проявиться наступне
...
biography-flag = Прапор країни
    .description = Показувати країну прапором, а не дволітерним кодом
biography-from-lastfm = З Last.fm
biography-header-banner = Банер
    .description = Широка смуга з логотипом, яку TheAudioDB зберігає для виконавця, у шапці
biography-header-blur = Вписати на розмитому тлі
    .description = З вимкненими пропорціями вписувати зображення цілком у смугу поверх розмитої копії замість обрізання
biography-header-fanart = Фанарт
    .description = Фанарти 16:9 виконавця з TheAudioDB, у шапці
biography-header-height = Висота шапки
    .description = Висота смуги шапки в px, а зі збереженими пропорціями її стеля
biography-header-image = Зображення шапки
    .description = Широкий банер виконавця вгорі або портрет, коли банера немає
biography-header-overlay = Заголовок на шапці
    .description = Покласти ім'я, країну й роки поверх нижньої частини зображення шапки, а не під ним
...
biography-name-source = Імʼя з
    .description = Який тег називає виконавця: виконавець треку або виконавець альбому для збірки чи запису з багатьма гостями
...
biography-profile = Країна й роки
    .description = Код країни та роки активності, з TheAudioDB
biography-refresh = Оновити
biography-seconds = { $count } с
biography-similar-artists = Схожі виконавці
    .description = Споріднені виконавці за даними прослуховувань, у вигляді чипів: клік відкриває їхню сторінку, а значок пошуку в тих, що є в бібліотеці, обирає їх у пошуку
...
biography-top-tracks = Популярні треки
    .description = Найбільш прослуховувані треки на Last.fm, клік запускає ті, що є в бібліотеці, а плюс ставить їх у чергу
biography-top-tracks-count = Кількість треків
    .description = Скільки популярних треків показувати
biography-top-tracks-heading = Популярні треки
...
playback-ab-clear = Скинути A-B
playback-ab-set-a = Позначити A
playback-ab-set-b = Позначити B
playback-ab-tip-a = A на { $a }. Натисніть ще раз, щоб позначити B
playback-ab-tip-looping = Повтор з { $a } до { $b }
playback-ab-tip-off = Позначте початок відрізка для повтору
...
playback-menu-ab-repeat = Кнопка повтору A-B
...
track-info-output-resample-exclusive-stream = Цей потік має { $source } кГц, а карта взяла { $device } кГц, тож кожен семпл перетворюється на виході. Пристрій не погодився працювати на власній частоті потоку.
track-info-output-resample-mixer-stream = Цей потік має { $source } кГц, а мікшер працює на { $device } кГц, тож кожен семпл перетворюється на виході. Ексклюзивний режим віддав би карті власну частоту потоку.
...
seek-bookmarks = Закладки
    .description = Закладки поточного треку у вигляді галочок під лінією: клік переходить до них, правий клік відкриває редагування
seek-show-timings = Показувати час
seek-dash-length = Довжина штриха
    .description = Довжина одного штриха на початку буфера, з таким самим проміжком після нього
seek-lead-in = Початок буфера
    .description = Як малюється ще не заповнена частина буфера станції, відрізок ліворуч від плівки
seek-lead-in-dashed = Пунктир
seek-lead-in-faint = Бліда
seek-lead-in-hidden = Схована
seek-lead-in-sweep = Біжучий градієнт
    .description = Градієнт пробігає ще не заповненою частиною, як у смужки завантаження
seek-section-live = Ефір
...
milkdrop-presets = Пресети
milkdrop-tuning = Налаштування
milkdrop-roots = Теки з пресетами
milkdrop-add-root = Додати теку
milkdrop-remove-root = Прибрати
milkdrop-folder = Де rox шукає
milkdrop-filter-presets = Фільтр пресетів
milkdrop-preset-count = { $count } з { $total } пресетів
milkdrop-locked = Закріпити пресет
    .description = Лишитися на цьому: без зміни за часом і без перемикання на біті
milkdrop-duration = Тривалість пресета
    .description = Скільки пресет тримається, поки не прийде наступний
milkdrop-beat-sensitivity = Чутливість до біту
    .description = Наскільки охоче projectM вважає щось бітом. Тихому міксу треба більше, ніж гучному
milkdrop-hard-cuts = Різкі переходи
    .description = Досить гучний біт одразу перемикає на наступний пресет
milkdrop-fps = Частота кадрів
    .description = До чого прагне потік малювання. 30 удвічі зменшує ціну зворотного читання кожного кадру
milkdrop-scale = Масштаб малювання
    .description = Малювати менше за розмір панелі й розтягувати. Коштує різкості й економить ту саму частку зворотного читання
milkdrop-tint = Колір альбому
    .description = Повертає відтінки картинки до обкладинки треку, що звучить. Нуль лишає кольори пресета як є
milkdrop-fade-duration = Тривалість згасання
milkdrop-idle = У простої
    .description = Що робить візуалізація, поки відтворення на паузі або зупинене. Тримати залишає останній кадр на екрані. Згасати зводить його до фону панелі й повертає при відтворенні
milkdrop-idle-hold = Тримати
milkdrop-idle-fade = Згасати
milkdrop-run-focused = Продовжувати при фокусі
    .description = Візуалізація продовжує рухатися, поки панель у фокусі, незалежно від відтворення. Вимкнено: утриманий кадр лишається нерухомим, навіть якщо панель у фокусі
milkdrop-show-name = Показувати назву пресета
    .description = Показувати назву пресета в кутку кілька секунд при зміні
milkdrop-next = Наступний пресет
milkdrop-previous = Попередній пресет
milkdrop-random = Випадковий пресет
milkdrop-open-folder = Відкрити теку з пресетами
milkdrop-rescan = Пересканувати
milkdrop-rotation = Ротація
    .description = Які пресети перебирають «Далі», «Назад» і зміна за таймером
milkdrop-rotation-all = Усі пресети
milkdrop-empty = Пресетів не знайдено.
    .description = Поклади пак у теку нижче й натисни «Пересканувати». Ось три, які варто взяти, усі в projectM-visualizer на GitHub.
milkdrop-packs-hint = Складай набори пресетів сюди. Три вартісні: presets-cream-of-the-crop, presets-milkdrop-original і presets-milkdrop-texture-pack, усі на GitHub у projectM-visualizer.
milkdrop-no-gl = Milkdrop не зміг запуститися.
milkdrop-still-starting = Milkdrop ще запускається.
milkdrop-still-starting-detail = Очікування контексту OpenGL від графічного драйвера.
milkdrop-no-frames = Milkdrop працює, але жодного кадру не надійшло.
milkdrop-no-frames-detail = Рендеринг на { $renderer }, { $version }. Подробиці в консолі.
milkdrop-favorite = Пресет в обране
milkdrop-favorite-short = В обране
milkdrop-favorited = В обраному
milkdrop-favorites-only = Лише обране
milkdrop-rotation-favorites = Обране ({ $count })
milkdrop-no-favorites = Поки нічого не позначено, тож перемішується вся бібліотека. Позначте пресет у списку, в меню панелі або в рядку «Зараз показується».
milkdrop-reveal = Показати пресет у теці
milkdrop-reveal-short = Показати
milkdrop-current = Зараз показується
milkdrop-no-preset = Поки нічого не завантажено
milkdrop-color = Колір
    .description = Пресет лишає кольори файлу. Тема перевертає їх у світлі на світлій темі. Палітра фарбує їх у тло й акцент теми й не чіпає колір альбому. Обкладинка фарбує їх у колір обкладинки, що грає, незалежно від теми за треком
milkdrop-color-preset = Пресет
milkdrop-color-theme = Тема
milkdrop-color-palette = Палітра
milkdrop-color-cover = Обкладинка
milkdrop-name-always = Тримати назву на екрані
    .description = Тримати назву на екрані весь час, а не кілька секунд
milkdrop-flip-horizontal = Віддзеркалити по горизонталі
    .description = Дзеркалить візуал зліва направо
milkdrop-flip-vertical = Віддзеркалити по вертикалі
    .description = Дзеркалить візуал згори донизу
milkdrop-choose = Вибрати пресет
milkdrop-picker-title = Вибрати пресет
milkdrop-picker-backdrop = Тло
milkdrop-picker-host = Вибір для { $host }
milkdrop-view-tree = Дерево
milkdrop-view-grid = Сітка
milkdrop-nested = За теками
milkdrop-locate-current = До активного
milkdrop-load-preset = Завантажити пресет
milkdrop-unfavorite = Прибрати з обраного
