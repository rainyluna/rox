...
bookmark-edit-title = Modifier le signet
bookmark-window-title = rox - { $verb }
bookmark-name = Nom
bookmark-name-placeholder = Facultatif, sans nom c'est l'heure qui s'affiche
bookmark-position = À { $time }
bookmark-color = Couleur
bookmark-color-accent = Accent du thème
bookmark-color-custom = Personnalisée...
bookmark-color-red = Rouge
bookmark-color-orange = Orange
bookmark-color-yellow = Jaune
bookmark-color-green = Vert
bookmark-color-teal = Turquoise
bookmark-color-blue = Bleu
bookmark-color-purple = Violet
bookmark-color-pink = Rose
bookmark-save = Enregistrer
bookmark-hint-before = Appuyez sur
bookmark-hint-key = Entrée
bookmark-hint-after = pour enregistrer
bookmark-menu-play = Lire à partir d'ici
bookmark-menu-rename = Renommer...
bookmark-menu-color = Couleur
bookmark-menu-move = Déplacer à la position de lecture
bookmark-menu-remove = Supprimer
...
panel-remove-bookmarks = { $count ->
    [one] Supprimer le signet
   *[other] Supprimer { $count } signets
}
panel-favourite-add = Ajouter aux favoris
panel-favourite-remove = Retirer des favoris
panel-copy = Copier
panel-copy-title = Copier le titre
panel-copy-artist = Copier l'artiste
panel-copy-album = Copier l'album
panel-copy-filename = Copier le nom du fichier
panel-copy-path = Copier le chemin
...
playback-item-ab-repeat = Répéter A-B
playback-item-favourite = Favori
playback-item-rating = Note
playback-sleep-15 = Arrêter après 15 minutes
playback-sleep-30 = Arrêter après 30 minutes
playback-sleep-60 = Arrêter après une heure
playback-sleep-90 = Arrêter après 90 minutes
playback-sleep-off = Pas de minuterie
playback-sleep-off-remaining = Annuler la minuterie ({ $minutes } min restantes)
playback-sleep-tip = Minuterie de sommeil
playback-sleep-tip-remaining = Minuterie, { $minutes } min restantes
menubar-button-tasks = Bouton des tâches
menubar-button-sleep = Bouton de la minuterie
menubar-button-rescan = Bouton de réanalyse
...
library-resume-description = Revenir à la ligne en cours quand tu arrêtes de parcourir
...
library-column-rename = Renommer...
library-column-rename-reset = Réinitialiser le nom
library-column-rename-name = En-tête
library-column-rename-note = Affiché à la place de l'en-tête intégré ; vide le rétablit, et une simple espace laisse l'en-tête vierge
library-sort-on-click = Trier au clic
    .description = Trie en cliquant n'importe où dans l'en-tête plutôt que sur son icône ; réordonner une colonne demande alors Alt et un glisser
library-group-search-results = Grouper les résultats de recherche
    .description = Conserve les en-têtes de groupe actuels pendant la recherche ; désactivez cette option pour afficher les pistes correspondantes dans une liste plate
library-compact-plays = Écoutes compactes
    .description = La colonne des écoutes en petit compteur avec un tiret à côté
library-line-height = Hauteur de ligne d'en-tête
...
grid-menu-sort = Tri
grid-sort-artist = Artiste
grid-sort-album = Album
grid-sort-year = Année
grid-sort-added = Ajoutés récemment
grid-sort-plays = Les plus écoutés
grid-letter-rail = Rail de lettres
    .description = Les initiales au bord du mur, un clic saute au premier album de la lettre
...
settings-appearance-milkdrop-beat-sensitivity = Sensibilité au rythme
    .description = À quel point projectM compte quelque chose comme un temps. Un mixage discret en demande plus qu'un mixage fort
settings-appearance-milkdrop-color = Couleur
    .description = Preset garde les couleurs du fichier. Thème les inverse vers le clair sur le thème clair. Palette les peint avec le fond et l'accent du thème. Pochette les peint avec la couleur de la pochette en cours, thème par morceau ou non
settings-appearance-milkdrop-duration = Durée du preset
    .description = Combien de temps un preset reste avant que le suivant arrive
settings-appearance-milkdrop-enabled = Fond Milkdrop
    .description = Faire tourner une visualisation Milkdrop derrière toute l'app pendant la lecture
settings-appearance-milkdrop-error-title = Le fond Milkdrop n'a pas pu démarrer
settings-appearance-milkdrop-fade-duration = Durée du fondu
    .description = Durée du fondu, en sortie à la pause ou à l'arrêt et en entrée à la lecture
settings-appearance-milkdrop-flip-horizontal = Retourner horizontalement
    .description = Reflète le visuel de gauche à droite
settings-appearance-milkdrop-flip-vertical = Retourner verticalement
    .description = Reflète le visuel de haut en bas
settings-appearance-milkdrop-fps = Images par seconde
    .description = Ce que vise le thread de rendu. 30 divise par deux le coût de relecture de chaque image, et un arrière-plan flouté en demande rarement plus
settings-appearance-milkdrop-hard-cuts = Coupes franches
    .description = Laisser un temps assez fort couper directement vers le préréglage suivant
settings-appearance-milkdrop-idle = Au repos
    .description = Ce que fait le visuel quand la lecture est en pause ou arrêtée. Figer garde la dernière image derrière l'application. Fondu la fait disparaître vers le fond de pochette et la ramène à la lecture
settings-appearance-milkdrop-locked = Verrouiller le preset
    .description = Rester sur le preset actuel, d'une piste à l'autre et après redémarrage
settings-appearance-milkdrop-preset = Preset
    .description = Quel preset le fond affiche. Marche sans lecture et revient après un redémarrage
settings-appearance-milkdrop-rotation = Rotation
    .description = Les presets que Suivant, Précédent et le changement minuté parcourent
settings-appearance-milkdrop-scale = Échelle de rendu
    .description = À quelle fraction de la résolution de la fenêtre la visualisation est rendue. Moins coûte moins ; un fond aussi doux en demande rarement plus
settings-appearance-milkdrop-strength = Intensité
    .description = Jusqu'où la visualisation porte par-dessus la pochette floutée
...
settings-appearance-section-milkdrop = Fond Milkdrop
...
settings-application-menu-entry = Entrée dans le menu des applications
    .description = Une entrée de lanceur et les associations de fichiers pour cette AppImage, toujours pointées vers l'emplacement actuel du fichier
...
settings-application-socket-path = Chemin du socket
    .description = L'interface machine de rox pendant qu'il tourne : JSON-RPC sur un socket local, rattaché à ce dossier de données. Le proxy rox-mcp sert les clients MCP par-dessus
...
settings-integrations-ffmpeg-binary = Binaire FFmpeg
    .description = Quel ffmpeg effectue les conversions ; laisse vide pour celui du PATH ou pour une version placée dans le dossier de données de rox
...
settings-integrations-ffmpeg-missing-note-flatpak = Convertir reste caché. Dépose une version statique de ffmpeg dans le dossier de données de rox ; celle installée sur ton système ne peut pas tourner dans le bac à sable.
...
settings-integrations-ffmpeg-reveal = Afficher le dossier de données
...
settings-integrations-lastfm-import-plays = Importer les lectures
    .description = Récupérer le nombre d'écoutes et l'historique depuis vos scrobbles Last.fm
settings-integrations-lastfm-import-plays-button = Importer lectures
...
settings-integrations-librefm-intro = Connecte ton compte Libre.fm : autorise rox dans le navigateur et les pistes jouées y sont scrobblées une fois le seuil franchi
settings-integrations-listenbrainz-get-token = Obtenir le jeton
settings-integrations-listenbrainz-intro = Collez le jeton utilisateur depuis listenbrainz.org/settings. Les écoutes partent dès qu'une piste franchit le seuil de scrobble.
settings-integrations-listenbrainz-token-placeholder = Jeton
settings-integrations-listenbrainz-token-row = Jeton utilisateur
...
settings-integrations-scrobble-connect = Connecter
settings-integrations-scrobble-disconnect = Déconnecter
settings-integrations-scrobble-finish-connecting = Terminer la connexion
settings-integrations-scrobble-reconnect = Reconnecter
settings-integrations-scrobble-status-checking = Vérification du jeton
settings-integrations-scrobble-status-confirming = Confirmation...
settings-integrations-scrobble-status-connected = Connecté en tant que { $username }
settings-integrations-scrobble-status-failed = La connexion a échoué : { $error }
settings-integrations-scrobble-status-invalid = { $service } a refusé ce jeton
settings-integrations-scrobble-status-not-connected = Non connecté
settings-integrations-scrobble-status-rejected = { $service } a rejeté la session et elle a été abandonnée. Reconnecte-toi pour continuer à scrobbler
settings-integrations-scrobble-status-requesting = Demande d'un jeton...
settings-integrations-scrobble-status-waiting = Autorise rox dans le navigateur, puis termine la connexion
settings-integrations-scrobble-threshold = Seuil de scrobble
    .description = Quelle part d'une piste doit être jouée avant qu'elle scrobble, vers chaque service connecté ; la barre de lecture et la forme d'onde peuvent le marquer
settings-integrations-scrobble-tracks = Scrobbler les pistes
    .description = Envoyer les pistes jouées à chaque service connecté une fois le seuil franchi
settings-integrations-scrobble-working = En cours...
...
settings-library-portal-hint = Remplace /path/to par l'emplacement réel du dossier.
settings-library-portal-note = Ça fonctionne, mais c'est lent pour une bibliothèque et rox ne peut pas surveiller ses changements. Donne à rox l'emplacement réel du dossier, puis retire-le et ajoute-le à nouveau :
settings-library-portal-title = rox atteint ce dossier via le portail de fichiers
...
settings-library-tempo-refused = { $count ->
    [one] . rox n'a pas pu compter le tempo de { $count } piste, Analyser les manquants la laisse de côté
   *[other] . rox n'a pas pu compter le tempo de { $count } pistes, Analyser les manquants les laisse de côté
}
settings-library-tempo-retry = Réessayer les refusées
...
settings-library-tempo-status-measured-some = { $covered } pistes analysées sur { $total } ont un tempo, dont { $measured } trouvées par rox
settings-library-tempo-status-none = { $total ->
    [one] La seule piste analysée ne dit pas à quelle vitesse elle tourne. Analyser les manquants le détermine
   *[other] Aucune des { $total } pistes analysées ne dit à quelle vitesse elle tourne. Analyser les manquants le détermine
}
settings-library-tempo-status-partial = { $covered } pistes analysées sur { $total } ont un tempo, dont { $measured } trouvées par rox. Analyser les manquants s'occupe des { $missing } autres
...
settings-show-readings = Afficher les lectures
    .description = Placer la lecture romanisée après un nom écrit dans une écriture que cet alphabet ne sait pas prononcer : 秋ノ風 (Aki no kaze). La lecture est le nom de tri que la valeur porte déjà, donc un nom qui n'en a pas n'affiche rien et un nom latin n'en reçoit jamais
...
settings-dictionary-download-failed = Le dictionnaire n'a pas pu être téléchargé : { $reason }
settings-dictionary-downloading = Téléchargement du dictionnaire : { $done } sur { $total }
settings-dictionary-heading = Romanisation
settings-dictionary-stopping = Arrêt du téléchargement du dictionnaire...
...
settings-providers-acoustid = AcoustID
    .description = Prendre une empreinte du son et demander à acoustid.org de quel enregistrement il s'agit ; le bouton d'identification de la comparaison de métadonnées trouve la sortie d'un fichier dont les tags sont trop faux pour être cherchés
settings-providers-acoustid-key = Clé AcoustID
settings-providers-acoustid-key-hint = Facultatif ; cette version embarque sa propre clé
settings-providers-acoustid-key-placeholder = Clé d'application
...
settings-storage-looks-layouts = Habillages et dispositions
    .description = L'habillage qu'utilise l'application (workspace.json) avec tes espaces de travail enregistrés et les fichiers de shader extraits à côté. Petit, et chaque octet est quelque chose que tu as réglé
...
menu-tasks = Tâches
menu-update-available = Mise à jour disponible
...
tasks-job-plays-import = Nombre d'écoutes Last.fm
...
tasks-tempo-counted = { $count ->
    [one] La seule piste a un tempo
   *[other] { $count } pistes ont un tempo
}
...
tasks-tempo-refused = { $count ->
    [one] rox n'a pas pu compter le tempo de { $count } piste
   *[other] rox n'a pas pu compter le tempo de { $count } pistes
}
tasks-timing = Chronométrage { $progress }
tasks-filling = Remplissage { $progress }
tasks-job-sortnames = Noms de tri
tasks-sortnames-all = { $count ->
    [one] Le seul artiste a un nom de tri
   *[other] Les { $count } artistes ont tous un nom de tri
}
tasks-sortnames-non-latin = , dont { $count } hors alphabet latin, { $estimate }
tasks-sortnames-nothing = Rien d'analysé à chercher pour l'instant
tasks-sortnames-partial = { $missing } artistes sur { $total } n'ont pas de nom de tri
tasks-start-fill-missing = Remplir les manquants
tasks-job-romanize = Romaniser
tasks-reading-takes = , les lire prend { $estimate }
tasks-romanize-all = { $count ->
    [one] Le seul titre, album ou artiste a un nom de tri
   *[other] Les { $count } titres, albums et artistes ont tous un nom de tri
}
tasks-romanize-nothing = Rien d'analysé à lire pour l'instant
tasks-romanize-partial = { $missing } titres, albums et artistes sur { $total } n'ont pas de nom de tri
tasks-romanizing = Lecture { $progress }
tasks-romanize-skipped = { $count } ont été passées faute du dictionnaire japonais
tasks-romanize-skipping = { $kanji } d'entre elles sont en kanji et demandent le dictionnaire japonais de Réglages > Bibliothèque
tasks-start-romanize = Romaniser
...
## Stats window
stats-bars-daily = Barres quotidiennes, cliquez sur l'une pour l'ouvrir
stats-bars-days = Barres de { $days } jours, cliquez sur l'une pour l'ouvrir
stats-bars-hourly = Barres horaires, la vue la plus fine
stats-bars-hours = Barres de { $hours } heures, cliquez sur l'une pour ouvrir son jour
stats-bars-weekly = Barres hebdomadaires, cliquez sur l'une pour l'ouvrir
stats-bucket-listens = { $count ->
    [one] { $count } écoute, { $ago } ({ $date })
   *[other] { $count } écoutes, { $ago } ({ $date })
}
stats-chart-end-day = Minuit
...
stats-range-span = Du { $from } au { $to }
...
health-caption-art = { $albums } sur { $total }, { $tracks }
health-caption-duplicates = { $groups } sur { $tracks }
health-caption-formats = { $unwritable } sur { $total }
health-caption-gaps = { $albums } sur { $total }
health-caption-missing = { $missing } manquants sur { $total }
health-caption-sort = Artistes de l'album { $album_artists }, albums { $albums }, titres { $titles }
health-caption-split = { $tagged } tagués, { $measured } mesurés, { $missing } manquants
health-caption-split-refused = { $tagged } tagués, { $measured } mesurés, { $missing } manquants, { $refused } sans tempo
health-checks-menu = Tags comptés
    .description = Lesquels des cinq tags essentiels le relevé compte ; la liste au survol les affiche toujours tous
health-click-opens = Le clic ouvre la santé de la bibliothèque
health-click-section = Clic
health-complete = Rien ne manque
health-count-groups = { $count ->
    [one] { $count } groupe
   *[other] { $count } groupes
}
health-desc-acoustic = Pistes sans empreinte acoustique, impossible donc de leur trouver quoi que ce soit de similaire.
health-desc-art = Albums sans pochette, ni intégrée aux fichiers ni posée à côté sous forme d'image.
health-desc-duplicates = Groupes de pistes qui partagent un artiste et un titre et durent à peu près pareil.
health-desc-gaps = Albums dont la numérotation saute un numéro, ou dont une piste n'en porte aucun.
health-desc-genre = Pistes dont les fichiers ne portent aucun genre.
health-desc-rating = Pistes que tu n'as pas encore notées.
health-desc-replaygain = Pistes sans mesure de volume, elles sortent donc plus fort ou moins fort que le reste.
health-desc-sort-names = Combien de noms portent un nom de tri, l'orthographe qui décide de leur place alphabétique.
health-desc-tempo = Pistes sans tempo, et c'est exactement ce que lisent le tri et la correspondance par BPM.
health-desc-writable = Pistes dans des formats que rox sait lire mais dans lesquels il ne peut pas réécrire les tags. Une variante rare de MP4 fragmenté refuse aussi l'écriture, et elle n'est pas comptée ici.
health-desc-year = Pistes sans année de sortie.
health-drill = Afficher ceux-ci
health-fix-analyze = Analyser les manquants
health-fix-duplicates = Ouvrir les doublons
health-fix-genres = Étiqueter les genres
health-fix-measure = Mesurer les manquants
health-fix-fill = Remplir les manquants
health-measuring-art = Analyse des pochettes, { $done } sur { $total }
health-measuring-duplicates = Recherche de doublons
health-measuring-formats = Lecture des formats de fichiers
health-measuring-gaps = Vérification des numéros de piste
health-open = Ouvrir la santé de la bibliothèque
health-open-on-click = Ouvrir la santé de la bibliothèque au clic
    .description = Cliquer sur le widget pour ouvrir la fenêtre de santé de la bibliothèque, où la couverture est détaillée
health-overview-complete = { $complete } sur { $total } entièrement tagués
health-overview-missing = { $missing } manquants
health-readout-section = Affichage
health-running = En cours
health-section-audio = Audio
health-section-files = Fichiers et structure
health-section-overview = Aperçu
health-section-tags = Tags
health-show-percent = Afficher le pourcentage
    .description = Dessiner la couverture à côté de l'icône ; désactivé, il ne reste que l'icône, avec les nombres au survol
health-tile-acoustic = Vecteurs acoustiques
health-tile-album = Album
health-tile-art = Pochette d'album
health-tile-artist = Artiste
health-tile-duplicates = Doublons
health-tile-gaps = Trous d'album
health-tile-genre = Genre
health-tile-rating = Note
health-tile-replaygain = ReplayGain
health-tile-sort-names = Noms de tri
health-tile-tempo = Tempo
health-tile-writable = Non pris en charge
health-tile-year = Année
health-tile-title = Titre
health-tooltip-missing = Tags manquants
health-waiting = En attente
health-widget-title = Widget Santé
health-window-title = rox - Santé de la bibliothèque

## Power search window

search-seed-caption = { $source }: { $count }
search-window-title = rox - Recherche avancée
...
welcome-menu-add = Ajouter au menu des applications
welcome-menu-failed = L'entrée de menu n'a pas pu être ajoutée
welcome-menu-not-now = Pas maintenant
welcome-menu-note = Une AppImage ne s'enregistre pas toute seule. Ceci ajoute une entrée de lanceur et les associations de fichiers audio ; rien ne change en dehors de ton dossier personnel.
welcome-menu-title = Ajouter rox au menu des applications ?
...
autoeq-placeholder = Rechercher un casque ou intra-auriculaires (ex. HD 600, AirPods, Zero)...
autoeq-search = Rechercher dans AutoEq
autoeq-searching = Recherche dans AutoEq en cours...
autoeq-loading = Chargement de la base AutoEq...
autoeq-none = Aucun profil de casque ne correspond à « { $text } »
autoeq-failed = Erreur AutoEq : { $reason }
autoeq-apply = Appliquer
autoeq-applied = Appliqué
autoeq-import-file = Importer un fichier de préréglage
eq-flatten = Aplatir
eq-freq-label = Fréq
eq-gain-label = Gain
eq-heading = Égaliseur
eq-help-text = Fais glisser une bande pour la déplacer, la molette dessus pour l'élargir ou la resserrer. Le traitement se fait en amont du tampon qui alimente la carte son, donc un geste met environ 120 ms à atteindre les enceintes tant que cette fenêtre est ouverte.
...
keymap-key-page-down = Page suivante
keymap-key-page-up = Page précédente
...
keymap-mod-win = Win
keymap-new-window = Nouvelle fenêtre
    .description = Ouvrir une autre fenêtre de travail avec la disposition enregistrée
keymap-next-track = Piste suivante
    .description = Passer à la piste suivante de la file d'attente
keymap-open-about = À propos
    .description = Afficher la version et les crédits
...
keymap-open-console = Console
    .description = Ouvrir la console de journalisation
keymap-open-equalizer = Égaliseur
    .description = Ouvrir la fenêtre de l'égaliseur
keymap-open-preset-picker = Presets de l'arrière-plan
    .description = Ouvrir le sélecteur de presets Milkdrop pour l'arrière-plan
...
keymap-open-health = Santé de la bibliothèque
    .description = Ouvrir la fenêtre de santé de la bibliothèque, où sont comptés la couverture des tags et les problèmes structurels
keymap-open-power-search = Recherche avancée
    .description = Ouvre une fenêtre de recherche avec sa propre requête, pour qu'une recherche ici laisse l'espace de travail intact
...
keymap-ab-repeat = Répéter A-B
    .description = Marquez A, puis B, puis effacez
keymap-ab-clear = Clear A-B Section
    .description = Drop the A-B section and any half-marked step with it
keymap-bookmark = Ajouter un signet
    .description = Poser un signet à la position de lecture
keymap-bookmark-named = Ajouter un signet nommé
    .description = Poser un signet à la position de lecture et le nommer
keymap-prev-bookmark = Signet précédent
...
keymap-type-ahead-next = Correspondance suivante
...
keymap-toggle-mute = Couper le son
    .description = Coupe la sortie sans perdre le niveau. Appuyez à nouveau pour le rétablir
keymap-toggle-shuffle = Basculer l'aléatoire
    .description = Active ou désactive la lecture aléatoire de la file
keymap-cycle-shuffle-mode = Cycle Shuffle Order
    .description = Step the order shuffle sorts by, random or nearest by sound
keymap-cycle-loop = Faire défiler la boucle
    .description = Passe la boucle de désactivée à tout, à un, puis revient au début
keymap-toggle-stop-after = Arrêter après
    .description = Laisse le morceau en cours finir, puis met en pause. Appuyez à nouveau pour annuler
...
keymap-volume-down = Baisser le volume
    .description = Baisse le volume d'un cran
...
keymap-close-panel = Fermer le panneau
    .description = Ferme le panneau actif du groupe de panneaux ciblé
keymap-new-empty-window = Fenêtre vide
    .description = Ouvre une fenêtre d'espace de travail sans rien dedans
keymap-open-signals = Signaux
    .description = Ouvre la fenêtre des signaux, le réservoir derrière les routes de chaque panneau
keymap-import-workspace = Importer un espace de travail
    .description = Choisit un fichier d'espace de travail et l'ajoute à la collection
...
keymap-toggle-quit-to-tray = Basculer rester dans la zone de notification
    .description = Détermine si fermer la dernière fenêtre laisse rox tourner dans la zone de notification
keymap-toggle-design-mode = Basculer le mode conception
    .description = Détermine si les panneaux peuvent être réorganisés sur place
keymap-toggle-theme = Basculer clair / sombre
    .description = Passe à l'autre côté de la palette. Actif partout, puisque toutes les fenêtres partagent le thème
keymap-toggle-resize-lock = Basculer le verrouillage du redimensionnement
    .description = Détermine si le redimensionnement des panneaux est réservé au mode conception
keymap-toggle-menubar = Basculer le masquage de la barre de menus
    .description = Affiche la barre de menus de la fenêtre, ou la masque jusqu'à ce qu'Alt soit maintenu
keymap-toggle-decorations = Basculer les décorations système
    .description = Fait passer les fenêtres d'espace de travail du cadre système à celui de rox
keymap-toggle-art-theming = Basculer les couleurs du morceau
    .description = Détermine si la pochette du morceau en cours teinte la palette
...
keymap-rescan-library = Réanalyser la bibliothèque
    .description = Réanalyser tous les dossiers mémorisés de la bibliothèque
keymap-abort-scan = Stop Scan
    .description = Stop a running library scan at the next file. What it already indexed stays
keymap-measure-replaygain = Mesurer le ReplayGain
    .description = Ouvrir la boîte de dialogue qui mesure le volume des pistes qui n'en portent pas
keymap-analyze-tempo = Analyser le tempo
    .description = Ouvrir la boîte de dialogue qui cherche le rythme des pistes sans BPM
keymap-build-acoustic = Créer les vecteurs acoustiques
    .description = Ouvrir la boîte de dialogue qui construit les vecteurs que lit la recherche acoustique
keymap-fill-sort-names = Remplir les noms de tri
    .description = Ouvrir la boîte de dialogue qui demande à MusicBrainz les noms de tri absents des fichiers
keymap-romanize-library = Romaniser la bibliothèque
    .description = Ouvrir la boîte de dialogue qui lit en lettres latines les titres, albums et artistes qui ne le sont pas
keymap-find-duplicates = Rechercher les doublons
    .description = Ouvrir le chercheur de doublons sur la bibliothèque
keymap-tag-genres = Étiqueter les genres
    .description = Ouvrir l'étiqueteur de genres sur les pistes sans genre
...
panel-catalog-health-widget = Widget Santé
...
lastfm-import-plays-stopped = { $count ->
    [one] Arrêt après { $count } piste
   *[other] Arrêt après { $count } pistes
}
lastfm-import-plays-matched = , { $count } avec correspondance
lastfm-import-plays-updated = { $count ->
    [one] , { $count } lecture ajoutée
   *[other] , { $count } lectures ajoutées
}

## Tag tools
tags-editor-add-tag = Ajouter
...
tags-editor-additional-tags = Tags supplémentaires ({ $count })
tags-editor-remove = retirer
tags-editor-replace = remplacer
tags-editor-replace-apply = Appliquer
tags-editor-replace-find = Rechercher
tags-editor-replace-help = Chaque occurrence est réécrite. Avec regex, $1 insère le premier groupe. Les résultats sont rognés aux bords.
tags-editor-replace-ignore-case = Ignorer la casse
tags-editor-replace-match-count = { $hits ->
    [one] { $hits } sur { $total } change
   *[other] { $hits } sur { $total } changent
}
tags-editor-replace-regex = Regex
tags-editor-replace-with = Remplacer
...
tags-editor-sort-names = Noms de tri
tags-editor-table-view = Tableau
tags-editor-tag-columns = Tags supplémentaires
tags-editor-tag-field-conflict = le champ { $field } écrit ce tag
tags-editor-tag-key-placeholder = Nom du tag
tags-editor-tag-value-placeholder = Valeur
...
tags-matcher-identify = Identifier par le son
tags-matcher-identify-no-duration = Pas de durée de piste pour identifier
...
convert-dialog-pick-folder = Choisis un dossier où écrire
...
## Étiqueteur de genres

tag-genres-empty = Toutes les pistes ont un genre. Lance quelque chose pour le réétiqueter.
tag-genres-heading = Étiqueter les genres
tag-genres-input-placeholder = Tape un genre
tag-genres-keys-hint = 1-8 choisissent une ligne, Maj+1-8 l'ajoutent au champ, Ctrl+1-8 pour tout l'album, Entrée applique ce que tu as tapé, L interroge Last.fm, S passe, Ctrl+Z annule
tag-genres-library-loading = La bibliothèque charge encore ; réessaie dans un instant.
tag-genres-no-file = La bibliothèque n'a aucun fichier pour cette piste.
tag-genres-no-suggestions = Rien à suggérer ; tape un genre.
tag-genres-progress = { $at } sur { $total } sans genre
tag-genres-skip = Passer
tag-genres-thinking = Lecture du voisinage...
tag-genres-undo = Annuler
tag-genres-unwritable = Cette piste vit dans une image cue partagée, son genre ne peut pas être écrit. Passe-la.
tag-genres-window-title = rox - Étiqueter les genres
tag-genres-looking-up = Demande à Last.fm...
tag-genres-lookup = Chercher sur Last.fm
tag-genres-auto-lookup = Automatiquement
tag-genres-lookup-found = Last.fm tague { $artist } comme : { $tags }
tag-genres-lookup-none = Last.fm n'a aucun tag pour { $artist }.
tag-genres-lookup-off = La recherche d'artistes en ligne est désactivée dans les Réglages.
tag-genres-why-acoustic = { $count ->
    [one] { $count } piste qui sonne pareil
   *[other] { $count } pistes qui sonnent pareil
}
tag-genres-why-album = { $count ->
    [one] { $count } piste sur cet album
   *[other] { $count } pistes sur cet album
}
tag-genres-why-artist = { $count ->
    [one] { $count } piste de cet artiste
   *[other] { $count } pistes de cet artiste
}
tag-genres-why-lookup = Last.fm
tag-genres-album-too = { $count ->
    [one] Étiqueter tout l'album de la piste et sa { $count } voisine
   *[other] Étiqueter tout l'album de la piste et ses { $count } voisines
}
tag-genres-apply = Appliquer
tag-genres-begin = Lancer la file
tag-genres-col-genre = Genre
tag-genres-col-match = Score
tag-genres-col-why = Pourquoi
tag-genres-current-genre = Genre : { $genre }
tag-genres-idle = Rien ne joue. Lance la file pour parcourir les pistes sans genre, ou joue quelque chose pour le réétiqueter.
tag-genres-no-genre = Pas encore de genre
tag-genres-stop = Arrêter la file
tag-genres-untagged-count = { $count ->
    [one] { $count } piste sans genre
   *[other] { $count } pistes sans genre
}
tag-genres-write-error = { $name } : { $error }
tag-genres-writing = Écriture de { $done } sur { $total }...
...
cover-editor-multiple = Multiples
...
pass-tempo-body = Deux fenêtres d'une demi-minute de chaque fichier sont décodées et les temps comptés, et d'autres fenêtres sont lues quand ces deux-là ne s'accordent pas, pour que la bibliothèque puisse montrer à quel tempo tourne une piste. Ça marche mieux sur de la musique enregistrée au clic et ça ignore tout ce qui ne se mesure pas. Les chiffres vont dans la base de données de la bibliothèque et tes fichiers ne sont pas touchés.
pass-tempo-retry-body = Une passe précédente a déjà écouté ces pistes et n'y a trouvé aucun tempo. Réessayer les décode toutes une fois de plus, ça ne vaut donc le coup qu'une fois le comptage des temps amélioré.
pass-tempo-retry-title = { $count ->
    [one] Réécouter { $count } piste refusée ?
   *[other] Réécouter { $count } pistes refusées ?
}
...
pass-fill = Remplir
pass-sortnames-body = Chaque artiste est cherché sur MusicBrainz pour la graphie latine sous laquelle il se classe, afin que 米津玄師 se range à Y. Le service autorise une requête par seconde, et c'est ce qui donne le rythme. Les réponses vont dans la base de la bibliothèque ; vos fichiers ne sont jamais touchés.
pass-sortnames-scope-all = Chercher aussi les noms qui se classent déjà en alphabet latin
pass-romanize = Romaniser
pass-romanize-body = Chaque titre, album et artiste encore sans nom de tri est lu en lettres latines, pour que レモン se trouve en tapant "lemon". Le coréen et le chinois n'ont besoin de rien. Les kanji japonais demandent le dictionnaire de Réglages > Bibliothèque, et IPADIC se trompe assez souvent sur les noms pour que l'éditeur d'étiquettes soit là pour corriger. Les réponses vont dans la base de la bibliothèque ; vos fichiers ne sont jamais touchés.
pass-romanize-title = { $count ->
    [one] Lire 1 nom en lettres latines ?
   *[other] Lire { $count } noms en lettres latines ?
}
pass-romanize-skips-kanji = { $kanji } valeurs sur { $total } sont en kanji et seront passées tant que le dictionnaire japonais n'est pas installé. À récupérer dans Réglages > Bibliothèque.
pass-sortnames-title = { $count ->
    [one] Chercher 1 artiste ?
   *[other] Chercher { $count } artistes ?
}
...
quick-play-syntax-absent = Les lignes sans aucune valeur
    .example = -year
quick-play-syntax-exclude = Tout sauf les correspondances
    .example = -genre:rock
quick-play-syntax-field = Cibler un champ, guillemets pour une valeur avec espaces
    .example = artist:"Daft Punk"
quick-play-syntax-free = Correspond au titre, à l'artiste, à l'artiste de l'album, à l'album ou au genre
    .example = daft punk
quick-play-syntax-numeric = Comparer un nombre ; plays:0 et added:<90d marchent pareil
    .example = rating:>=4
quick-play-syntax-title = Syntaxe de recherche
quick-play-syntax-year = Des chiffres, donc un préfixe prend toute la décennie
    .example = year:199
...
waveform-loudness = Bande de volume
    .description = Tracer le niveau RMS comme une bande plus plate à l'intérieur de l'enveloppe des crêtes
waveform-gradient-mode = Source des couleurs
    .description = Où l'enveloppe et la bande prennent leurs couleurs : l'accent, le dégradé du thème, la pochette, ou une paire personnalisée
waveform-scrobble-marker = Marque de scrobble
    .description = Une ligne fine là où la piste compte comme scrobblée sur Last.fm
waveform-bookmarks = Signets
...
shader-edit-here = Modifier
shader-editor-window-title = rox - Éditeur de shaders
shader-editor-target-screen = Shader d'écran
shader-editor-target-backdrop = Shader d'arrière-plan
shader-editor-origin-pool = Un shader de l'espace de travail : appliquer atteint chaque surface qui l'utilise
shader-editor-origin-pool-file = Un shader de l'espace de travail, avec sa copie de travail dans { $path }
shader-editor-origin-file = Lié à { $path }, écrit lui aussi à l'application
shader-editor-origin-inline = Le code propre à cette surface
shader-editor-apply = Appliquer
shader-editor-revert = Rétablir
shader-editor-close = Fermer
shader-editor-hint-press = Appuyez sur
shader-editor-hint-apply = pour appliquer
shader-editor-status-unchecked = Rien à vérifier pour l'instant
shader-editor-status-ok = Compile
shader-editor-status-error = Ce shader n'a pas compilé :
shader-editor-section-uniforms = Uniforms
shader-editor-section-textures = Textures
shader-editor-section-slots = Slots
shader-editor-section-signals = Signaux
shader-editor-slot-unnamed = Slot { $n }
shader-editor-signals-empty = Le pool n'a pas encore de signaux. Ajoutez-en dans la fenêtre Signaux et ils apparaîtront ici avec des vumètres en direct.
shader-editor-uniform-time = Secondes depuis le lancement du shader, figées quand le flux l'est
shader-editor-uniform-delta = Secondes depuis sa dernière image, 0 à la première
shader-editor-uniform-resolution = La surface en pixels physiques
shader-editor-uniform-mouse = xy le curseur en pixels physiques, z et w les boutons
shader-editor-uniform-meta-0 = x volume, y position dans la piste, z en lecture, w durée de la piste en secondes
shader-editor-uniform-meta-1 = x luminosité de la page, y thème clair, z présence du curseur, w forme du contenu
shader-editor-texture-screen = Ce qui se trouve sous la surface à cette image
shader-editor-texture-prev = La dernière image de cette surface, pour les traînées
...
## Metadata panel
metadata-copy-field = Copier { $field }
metadata-cover-background = Pochette en fond
    .description = La pochette de la piste derrière les champs
metadata-cover-opacity = Opacité de la pochette
    .description = À quel point la pochette transparaît derrière les champs
...
metadata-field-album-artist-sort = Tri de l'artiste d'album
metadata-field-album-sort = Tri de l'album
metadata-field-artist-sort = Tri de l'artiste
metadata-field-bit-depth = Profondeur de bits
metadata-field-bitrate = Débit
metadata-field-bookmarks = Signets
metadata-field-bpm-measured = { $bpm } (mesuré par rox)
...
metadata-field-folder = Dossier
metadata-field-gain-album = Gain de l'album
metadata-field-gain-track = Gain de la piste
metadata-field-last-played = Dernière écoute
metadata-field-lastfm-listeners = Auditeurs dans le monde
metadata-field-lastfm-loved = Aimé sur Last.fm
metadata-field-lastfm-plays = Écoutes dans le monde
metadata-field-lastfm-tags = Tags Last.fm
metadata-field-lastfm-user-plays = Vos scrobbles
metadata-field-lyrics = Paroles
metadata-field-mb-country = Pays de sortie
metadata-field-mb-date = Sortie
metadata-field-mb-first-release = Première sortie
metadata-field-mb-isrc = ISRC
metadata-field-mb-label = Label
metadata-field-missing = Manque
metadata-field-rank = Rang dans la bibliothèque
metadata-field-recent-plays = Écoutes (30 jours)
metadata-field-sample-rate = Fréquence d'échantillonnage
metadata-field-similar = Titres proches
metadata-field-size = Taille
metadata-field-title-sort = Tri du titre
metadata-field-track = Piste
metadata-fields = Champs
    .description = Quels champs la fiche liste ; un champ sans valeur affiche n/d, et un nom de tri n'apparaît que là où il diffère
metadata-find-online = Chercher les métadonnées en ligne...
metadata-no-library = Aucune bibliothèque
metadata-romanize = Romaniser
metadata-romanize-needs-dictionary = Un nom en kanji a besoin du dictionnaire japonais. À récupérer dans Réglages > Bibliothèque.
metadata-romanize-sort-names = Romaniser les noms de tri
metadata-row-borders-description = Le filet sous chaque ligne du tableau
metadata-cover-embedded = Intégrée, { $px }
metadata-cover-folder = { $file }, { $px }
metadata-hide-empty = Masquer les champs vides
    .description = Omettre un champ activé sans valeur plutôt que de le lister comme n/d
metadata-loved-no = Non
metadata-loved-yes = Oui
metadata-lyrics-plain = Texte seul
metadata-lyrics-synced = Synchronisées
metadata-missing-none = Rien
metadata-rank-value = n° { $rank }
metadata-tags-scope-album = (tags de l'album)
metadata-tags-scope-artist = (tags de l'artiste)
metadata-track-of = { $track } sur { $total }
...
folder-tree-collapse-branch = Replier la branche
...
folder-tree-expand-branch = Déplier la branche
...
art-label-position = Position du libellé
    .description = Où va le libellé de l'album, en haut, sous la pochette, en bas, ou masqué
art-letter-rail = Rail de lettres
    .description = Les initiales des artistes au bord de l'étagère, un clic saute au premier album de la lettre
art-layout-section = Disposition
art-perspective = Perspective
    .description = Tourner les pochettes latérales selon l'angle ci-dessous ; désactivé, elles restent plates et carrées, le seul mode où l'arrondi des pochettes s'applique
art-recede = Luminosité en profondeur
    .description = À quel point la pochette la plus au fond est éclairée ; celles qui la séparent du centre se partagent l'écart à parts égales
art-spacing = Espacement des pochettes
    .description = À quelle distance de la pochette centrale se place la première de chaque côté ; passé la moitié, elle la dégage et lui laisse de la place
art-stride = Espacement de la pile
    .description = L'écart entre les pochettes situées derrière la première ; il fixe aussi la distance parcourue par pochette lors d'un glissement
art-visible = Pochettes affichées
    .description = Combien de pochettes se tiennent de chaque côté de celle du centre ; la dernière s'efface en partant
art-tilt = Angle de rotation
    .description = De combien les pochettes latérales pivotent en s'éloignant de vous
...
## Biography panel
biography-active-between = Actif de { $from } à { $to }
biography-active-since = Actif depuis { $from }
biography-background = Fond
    .description = Le fanart de l'artiste derrière le texte, assombri et disparaissant vers le bas
biography-background-opacity = Opacité de l'arrière-plan
    .description = À quel point le fanart transparaît derrière le texte
biography-cycle = Faire défiler les images d'en-tête
    .description = Faire tourner la bannière et le fanart de l'artiste dans l'en-tête en fondu enchaîné, et passer de l'une à l'autre à la main avec les flèches qui apparaissent au survol
biography-cycle-interval = Intervalle de défilement
    .description = Combien de temps chaque image d'en-tête reste avant que la suivante apparaisse
...
biography-flag = Drapeau du pays
    .description = Afficher le pays par son drapeau plutôt que par son code à deux lettres
biography-from-lastfm = Depuis Last.fm
biography-header-banner = Bannière
    .description = La large bande avec le logo que TheAudioDB garde pour l'artiste, dans l'en-tête
biography-header-blur = Ajuster sur fond flouté
    .description = Proportions désactivées, placer l'image entière dans la bande sur une version floutée d'elle-même plutôt que de la rogner
biography-header-fanart = Fanart
    .description = Les fanarts 16:9 de l'artiste depuis TheAudioDB, dans l'en-tête
biography-header-height = Hauteur de l'en-tête
    .description = La hauteur de la bande d'en-tête en px, et le plafond d'une bande gardée à ses proportions
...
biography-header-overlay = Titre sur l'en-tête
    .description = Placer le nom, l'origine et les années sur le bas de l'image d'en-tête plutôt qu'en dessous
...
biography-name-source = Nom depuis
    .description = Quel tag nomme l'artiste : celui du morceau, ou l'artiste de l'album pour une compilation ou un disque plein d'invités
...
biography-profile = Origine et années
    .description = Le code pays et les années d'activité, depuis TheAudioDB
biography-refresh = Actualiser
biography-seconds = { $count } s
biography-similar-artists = Artistes proches
    .description = Les artistes proches d'après les données d'écoute, en puces : un clic ouvre leur fiche, et une loupe sur ceux que la bibliothèque possède les sélectionne dans la recherche
...
biography-top-tracks = Titres phares
    .description = Les titres les plus écoutés sur Last.fm, un clic lit ceux que la bibliothèque possède et le plus les met en file
biography-top-tracks-count = Nombre de titres
    .description = Combien de titres phares afficher
biography-top-tracks-heading = Titres phares
...
## Track columns
columns-album-artist-sort = Tri de l'artiste d'album
columns-album-sort = Tri de l'album
columns-artist-sort = Tri de l'artiste
columns-bits = Bits
columns-bpm = BPM
columns-codec = Codec
...
columns-title-sort = Tri du titre
...
filter-over-cap = { $count } de plus, cherchez pour affiner
...
playback-ab-clear = Effacer A-B
playback-ab-set-a = Marquer A
playback-ab-set-b = Marquer B
playback-ab-tip-a = A à { $a }. Appuyez encore pour marquer B
playback-ab-tip-looping = Répétition de { $a } à { $b }
playback-ab-tip-off = Marquez le début de la section à répéter
...
playback-menu-ab-repeat = Bouton Répéter A-B
...
dictionary-summary-lindera-ipadic = Le dictionnaire japonais derrière les lectures des kanji. Sans lui, les kana et le hangul se romanisent toujours et le chinois se lit toujours en pinyin, mais un titre en kanji est passé
...
milkdrop-presets = Préréglages
milkdrop-tuning = Réglages
milkdrop-roots = Dossiers de préréglages
milkdrop-add-root = Ajouter un dossier
milkdrop-remove-root = Retirer
milkdrop-folder = Où rox cherche
milkdrop-filter-presets = Filtrer les préréglages
milkdrop-preset-count = { $count } préréglages sur { $total }
milkdrop-locked = Verrouiller le préréglage
    .description = Rester sur celui-ci : pas de changement minuté, pas de coupe sur un temps
milkdrop-duration = Durée d'un préréglage
    .description = Combien de temps un préréglage tient avant le suivant
milkdrop-beat-sensitivity = Sensibilité au rythme
    .description = À quel point projectM compte quelque chose comme un temps. Un mixage discret en demande plus qu'un mixage fort
milkdrop-hard-cuts = Coupes franches
    .description = Laisser un temps assez fort couper directement vers le préréglage suivant
milkdrop-fps = Images par seconde
    .description = Ce que vise le thread de rendu. 30 divise par deux le coût de relecture de chaque image
milkdrop-scale = Échelle de rendu
    .description = Rendre en dessous de la taille du panneau puis agrandir. Coûte en netteté, économise autant sur la relecture
milkdrop-tint = Couleur de l'album
    .description = Tourne les teintes du visuel vers la pochette du morceau en cours. Zéro laisse les couleurs du préréglage telles quelles
milkdrop-fade-duration = Durée du fondu
milkdrop-idle = Au repos
    .description = Ce que fait le visuel quand la lecture est en pause ou arrêtée. Figer garde la dernière image à l'écran. Fondu la fait disparaître vers le fond du panneau et la ramène à la lecture
milkdrop-idle-hold = Figer
milkdrop-idle-fade = Fondu
milkdrop-run-focused = Continuer avec le focus
    .description = Le visuel continue tant que le panneau a le focus, qu'il y ait lecture ou non. Désactivé, une image figée reste figée même avec le panneau actif
milkdrop-show-name = Afficher le nom du préréglage
    .description = Afficher le nom du préréglage dans le coin pendant quelques secondes quand il change
milkdrop-next = Préréglage suivant
milkdrop-previous = Préréglage précédent
milkdrop-random = Préréglage au hasard
milkdrop-open-folder = Ouvrir le dossier des préréglages
milkdrop-rescan = Réanalyser
milkdrop-rotation = Rotation
    .description = Les presets que Suivant, Précédent et le changement minuté parcourent
milkdrop-rotation-all = Tous les presets
milkdrop-empty = Aucun preset trouvé.
    .description = Dépose un pack dans le dossier ci-dessous, puis clique sur Réanalyser. Voici les trois qui valent le coup, tous chez projectM-visualizer sur GitHub.
milkdrop-packs-hint = Dépose les packs de préréglages ici. Les trois qui valent le coup sont presets-cream-of-the-crop, presets-milkdrop-original et presets-milkdrop-texture-pack, tous sur GitHub sous projectM-visualizer.
milkdrop-no-gl = Milkdrop n'a pas pu démarrer.
milkdrop-still-starting = Milkdrop démarre encore.
milkdrop-still-starting-detail = En attente d'un contexte OpenGL du pilote graphique.
milkdrop-no-frames = Milkdrop tourne, mais aucune image n'est arrivée.
milkdrop-no-frames-detail = Rendu sur { $renderer }, { $version }. La console a les détails.
milkdrop-favorite = Preset favori
milkdrop-favorite-short = Favori
milkdrop-favorited = En favoris
milkdrop-favorites-only = Favoris seulement
milkdrop-rotation-favorites = Favoris ({ $count })
milkdrop-no-favorites = Rien n'est encore étoilé, donc ceci mélange toute la bibliothèque. Étoilez un preset depuis la liste, le menu du panneau ou la ligne À l'écran.
milkdrop-reveal = Afficher le preset dans le dossier
milkdrop-reveal-short = Afficher
milkdrop-current = À l'écran
milkdrop-no-preset = Rien de chargé pour l'instant
milkdrop-color = Couleur
    .description = Preset garde les couleurs du fichier. Thème les inverse vers le clair sur le thème clair. Palette les peint avec le fond et l'accent du thème et laisse la couleur de l'album de côté. Pochette les peint avec la couleur de la pochette en cours, thème par morceau ou non
milkdrop-color-preset = Preset
milkdrop-color-theme = Thème
milkdrop-color-palette = Palette
milkdrop-color-cover = Pochette
milkdrop-name-always = Garder le nom à l'écran
    .description = Garder le nom affiché en permanence plutôt que quelques secondes
milkdrop-flip-horizontal = Retourner horizontalement
    .description = Reflète le visuel de gauche à droite
milkdrop-flip-vertical = Retourner verticalement
    .description = Reflète le visuel de haut en bas
milkdrop-choose = Choisir un preset
milkdrop-picker-title = Choisir un preset
milkdrop-picker-backdrop = Arrière-plan
milkdrop-picker-host = Choix pour { $host }
milkdrop-view-tree = Arborescence
milkdrop-view-grid = Grille
milkdrop-nested = Imbriqué
milkdrop-locate-current = Aller à l'actif
milkdrop-load-preset = Charger le preset
milkdrop-unfavorite = Retirer des favoris
