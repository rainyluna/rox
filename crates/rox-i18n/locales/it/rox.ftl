...
settings-search-scope = Cerca solo nella pagina aperta

## Embed dialog
bookmark-new-title = Nuovo segnalibro
bookmark-edit-title = Modifica segnalibro
bookmark-window-title = rox - { $verb }
bookmark-name = Nome
bookmark-name-placeholder = Facoltativo, senza nome viene mostrato l'orario
bookmark-position = A { $time }
bookmark-color = Colore
bookmark-color-accent = Accento del tema
bookmark-color-custom = Personalizzato...
bookmark-color-red = Rosso
bookmark-color-orange = Arancione
bookmark-color-yellow = Giallo
bookmark-color-green = Verde
bookmark-color-teal = Turchese
bookmark-color-blue = Blu
bookmark-color-purple = Viola
bookmark-color-pink = Rosa
bookmark-save = Salva
bookmark-hint-before = Premi
bookmark-hint-key = Invio
bookmark-hint-after = per salvare
bookmark-menu-play = Riproduci da qui
bookmark-menu-rename = Rinomina...
bookmark-menu-color = Colore
bookmark-menu-move = Sposta alla posizione attuale
bookmark-menu-remove = Rimuovi
bookmark-menu-remove-many = Rimuovi { $count } segnalibri
bookmarks-title = Segnalibri
bookmarks-empty = Nessun segnalibro ancora. Premi M mentre suona una traccia per metterne uno, o Maiusc+M per dargli un nome.
cue-menu-insert = Inserisci punto qui
cue-menu-bookmark = Aggiungi segnalibro qui
cue-menu-remove = Rimuovi punto
position-bound-streaming = Non disponibile durante lo streaming
...
panel-remove-bookmarks = { $count ->
    [one] Rimuovi segnalibro
   *[other] Rimuovi { $count } segnalibri
}
...
playback-item-ab-repeat = Ripeti A-B
playback-item-favourite = Preferito
playback-item-rating = Valutazione
playback-sleep-15 = Ferma dopo 15 minuti
playback-sleep-30 = Ferma dopo 30 minuti
playback-sleep-60 = Ferma dopo un'ora
playback-sleep-90 = Ferma dopo 90 minuti
playback-sleep-off = Nessun timer
playback-sleep-off-remaining = Annulla il timer ({ $minutes } min rimasti)
playback-sleep-tip = Timer di spegnimento
playback-sleep-tip-remaining = Timer, { $minutes } min rimasti
menubar-button-tasks = Pulsante attività
menubar-button-sleep = Pulsante timer
menubar-button-rescan = Pulsante di nuova scansione
...
library-group-search-results = Raggruppa i risultati di ricerca
    .description = Mantiene le intestazioni di gruppo correnti durante la ricerca; disattiva per mostrare le tracce corrispondenti come elenco piatto
...
stations-import-empty = Quel file non contiene URL di stream
stations-not-a-stream = Le stazioni si ascoltano via http o https; quello non è un URL di stream
stations-empty-title = Nessuna stazione ancora
stations-empty = Trovane una nella directory, oppure tieni la tua lista nelle impostazioni.
stations-on-air = In onda
stations-clocks = Tempo su questo brano e su questa stazione
stations-homepage = Apri il sito

## Station directory

directory-window-title = Directory delle stazioni
directory-placeholder = Trova stazioni su radio-browser.info
directory-search = Cerca nella directory
directory-add = Aggiungi
directory-add-play = Aggiungi e riproduci
directory-added = Già tra le tue stazioni
directory-searching = Ricerca su radio-browser.info...
directory-none = Niente su radio-browser.info corrisponde a "{ $text }"
directory-failed = radio-browser.info non ha risposto: { $reason }
...
settings-page-sources = Sorgenti
...
settings-appearance-milkdrop-beat-sensitivity = Sensibilità al beat
    .description = Quanto facilmente projectM conta qualcosa come beat. Un mix sommesso ne chiede più di uno forte
settings-appearance-milkdrop-color = Colore
    .description = Preset tiene i colori del file. Tema li ribalta verso il chiaro sul tema chiaro. Tavolozza li dipinge con lo sfondo e l'accento del tema. Copertina li dipinge con il colore della copertina in riproduzione, con o senza tema per brano
settings-appearance-milkdrop-duration = Durata del preset
    .description = Quanto resta un preset prima che arrivi il successivo
settings-appearance-milkdrop-enabled = Sfondo Milkdrop
    .description = Far girare una visualizzazione Milkdrop dietro tutta l'app mentre suona la musica
settings-appearance-milkdrop-error-title = Lo sfondo Milkdrop non è riuscito ad avviarsi
settings-appearance-milkdrop-fade-duration = Durata della dissolvenza
    .description = Quanto dura la dissolvenza, in uscita alla pausa o allo stop e in entrata alla riproduzione
settings-appearance-milkdrop-flip-horizontal = Capovolgi in orizzontale
    .description = Riflette il visual da sinistra a destra
settings-appearance-milkdrop-flip-vertical = Capovolgi in verticale
    .description = Riflette il visual dall'alto in basso
settings-appearance-milkdrop-fps = Frequenza dei fotogrammi
    .description = Quello a cui punta il thread di rendering. 30 dimezza il costo della rilettura di ogni fotogramma, e uno sfondo sfocato raramente chiede di più
settings-appearance-milkdrop-hard-cuts = Tagli netti
    .description = Lascia che un beat abbastanza forte tagli dritto al preset successivo
settings-appearance-milkdrop-idle = A riposo
    .description = Cosa fa il visual mentre la riproduzione è in pausa o ferma. Mantieni lascia l'ultimo fotogramma dietro l'app. Dissolvi lo porta allo sfondo della copertina e lo riporta alla riproduzione
settings-appearance-milkdrop-locked = Blocca preset
    .description = Restare sul preset attuale, tra un brano e l'altro e dopo un riavvio
settings-appearance-milkdrop-preset = Preset
    .description = Quale preset mostra lo sfondo. Funziona anche senza riproduzione e torna dopo un riavvio
settings-appearance-milkdrop-rotation = Rotazione
    .description = Quali preset percorrono Successivo, Precedente e il cambio a tempo
settings-appearance-milkdrop-scale = Scala di rendering
    .description = A quale frazione della risoluzione della finestra viene resa la visualizzazione. Meno costa meno; uno sfondo così morbido raramente ne ha bisogno di più
settings-appearance-milkdrop-strength = Intensità
    .description = Quanto la visualizzazione arriva sopra la copertina sfocata
...
settings-appearance-section-milkdrop = Sfondo Milkdrop
...
settings-application-prerelease-updates = Includi le release candidate
    .description = Proporre anche le release candidate, le anteprime pubblicate prima di una versione per provarla; una build candidata vede la successiva in ogni caso
...
settings-application-menu-entry = Voce nel menu delle applicazioni
    .description = Una voce di avvio e le associazioni dei file per questa AppImage, sempre puntate a dove si trova il file
...
settings-integrations-ffmpeg-binary = Binario FFmpeg
    .description = Quale ffmpeg esegue le conversioni; lascia vuoto per quello nel PATH o per una build nella cartella dati di rox
...
settings-integrations-ffmpeg-missing-note-flatpak = Converti resta nascosto. Copia una build statica di ffmpeg nella cartella dati di rox; quella installata nel sistema non può girare dentro la sandbox.
...
settings-integrations-ffmpeg-reveal = Mostra cartella dati
...
settings-integrations-lastfm-import-plays = Importa riproduzioni
    .description = Recupera conteggi e cronologia di ascolto dagli scrobble di Last.fm
settings-integrations-lastfm-import-plays-button = Importa riproduzioni
...
settings-integrations-librefm-intro = Connetti il tuo account Libre.fm: autorizza rox nel browser e le tracce riprodotte vengono scrobblate lì una volta superata la soglia
settings-integrations-listenbrainz-get-token = Ottieni token
settings-integrations-listenbrainz-intro = Incolla il token utente da listenbrainz.org/settings. Gli ascolti partono quando un brano supera la soglia di scrobbling.
settings-integrations-listenbrainz-token-placeholder = Token
settings-integrations-listenbrainz-token-row = Token utente
...
settings-integrations-scrobble-connect = Connetti
settings-integrations-scrobble-disconnect = Disconnetti
settings-integrations-scrobble-finish-connecting = Completa la connessione
settings-integrations-scrobble-reconnect = Riconnetti
settings-integrations-scrobble-status-checking = Controllo del token
settings-integrations-scrobble-status-confirming = Conferma in corso...
settings-integrations-scrobble-status-connected = Connesso come { $username }
settings-integrations-scrobble-status-failed = Connessione fallita: { $error }
settings-integrations-scrobble-status-invalid = { $service } ha rifiutato quel token
settings-integrations-scrobble-status-not-connected = Non connesso
settings-integrations-scrobble-status-rejected = { $service } ha rifiutato la sessione ed è stata scartata. Riconnettiti per continuare lo scrobbling
settings-integrations-scrobble-status-requesting = Richiesta di un token...
settings-integrations-scrobble-status-waiting = Autorizza rox nel browser, poi completa la connessione
settings-integrations-scrobble-threshold = Soglia di scrobbling
    .description = Quanto deve suonare una traccia prima che venga scrobblata, verso ogni servizio connesso; la barra di avanzamento e la forma d'onda possono segnarlo
settings-integrations-scrobble-tracks = Scrobbla le tracce
    .description = Manda le tracce riprodotte a ogni servizio connesso una volta superata la soglia
settings-integrations-scrobble-working = In corso...
...
settings-integrations-subsonic-connect = Connetti
settings-integrations-subsonic-credentials = Accesso
    .description = L'account sul server; la password resta in accounts.json, mai in settings.json
settings-integrations-subsonic-enable = Usa un server Subsonic
    .description = Legge una libreria da un server Subsonic o OpenSubsonic e riproduce da lì
settings-integrations-subsonic-password-placeholder = Password
settings-integrations-subsonic-server = Server
    .description = L'indirizzo del server con http:// o https://, e senza /rest alla fine
settings-integrations-subsonic-status-failed = Server irraggiungibile: { $error }
settings-integrations-subsonic-status-ok = Connesso a { $server }
settings-integrations-subsonic-sync-count = { $n ->
    [one] { $n } traccia, ultima sincronizzazione il { $date }
   *[other] { $n } tracce, ultima sincronizzazione il { $date }
}
settings-integrations-subsonic-sync-failed = Sincronizzazione fallita: { $error }
settings-integrations-subsonic-sync-never = Mai sincronizzato
settings-integrations-subsonic-sync-now = Sincronizza ora
    .description = Chiede al server cosa ha e allinea la libreria; le tracce che non elenca più vengono tolte
settings-integrations-subsonic-syncing = Sincronizzazione dell'album { $done } di { $total }
settings-integrations-subsonic-url-placeholder = https://musica.example.com
settings-integrations-subsonic-user-placeholder = Nome utente
...
settings-library-portal-hint = Sostituisci /path/to con la posizione reale della cartella.
settings-library-portal-note = Funziona, ma per una libreria è lento e rox non può sorvegliarne i cambiamenti. Dai a rox la posizione reale della cartella, poi rimuovila e aggiungila di nuovo:
settings-library-portal-title = rox raggiunge questa cartella tramite il portale dei file
...
settings-playback-live-buffer = Buffer della diretta
    .description = Quanto indietro si può riavvolgere una stazione. La connessione resta aperta durante una pausa e continua a riempire il buffer, così alla ripresa riparti da dove ti sei fermato invece che dalla diretta. Dodici ore sono l'infinito pratico: niente che tu lasci acceso in una volta sola arriva a riempirle.
settings-playback-live-buffer-memory = Circa { $low } a 128 kbps, { $high } a 320 kbps.
settings-playback-live-buffer-playing = Stazione in riproduzione: circa { $size }.
settings-playback-capture-album = Album delle registrazioni
    .description = Cosa dice il tag album di un brano salvato. Vuoto non scrive alcun album, perché un brano preso dall'etere non ha una pubblicazione e i nomi delle stazioni nel campo album sporcano ogni vista per album. %station% ci mette la stazione; una parola come Radio o Singles li sistema su uno scaffale a parte. La stazione e l'URL dello stream vanno sempre nel commento.
settings-playback-capture-album-placeholder = Lascia vuoto
settings-playback-capture-choose = Scegli cartella...
settings-playback-capture-enable = Salva i brani dalle sorgenti in streaming
    .description = Scrive nella cartella delle registrazioni ogni brano che uno stream riproduce dall'inizio alla fine, nel formato dello stream stesso e senza ricodificare nulla, con i tag della stazione. La copertina del brano finisce accanto con lo stesso nome, quando se ne trova una. I confini tra i brani arrivano dai titoli che la stazione annuncia, e quelli precedono o seguono l'audio di qualche secondo, quindi una registrazione può contenere la coda del brano precedente. Un brano più lungo del buffer dal vivo non viene mai salvato, così un podcast o un mix resta in onda.
settings-playback-capture-folder = Cartella delle registrazioni
settings-playback-capture-pattern = Nomi delle registrazioni
    .description = Come viene chiamato un brano salvato nella cartella delle registrazioni. Una / crea una cartella, così l'impostazione predefinita archivia una serata di radio per stazione invece di ammucchiare tutto. L'estensione viene dallo stream.
settings-playback-capture-pattern-date = %date% è il giorno in cui il brano è stato salvato, come 2026-09-18.
settings-playback-capture-pattern-preview = Anteprima: { $name }
settings-playback-capture-pattern-station = %station% è il nome della stazione, e %album% dice la stessa cosa.
settings-playback-section-capture = Registrazione
...
settings-providers-acoustid = AcoustID
    .description = Prendere un'impronta del suono e chiedere ad acoustid.org di quale registrazione si tratta; il pulsante di riconoscimento del confronto metadati trova l'edizione anche per un file con tag troppo sbagliati per cercarli
settings-providers-acoustid-key = Chiave AcoustID
settings-providers-acoustid-key-hint = Facoltativa; questa build ha già una chiave sua
settings-providers-acoustid-key-placeholder = Chiave applicazione
...
settings-sources-folders-note = Le cartelle che rox analizza si trovano nella pagina Libreria, accanto alle impostazioni di scansione e tag che le leggono.
settings-sources-folders-open = Pagina Libreria
settings-sources-section-folders = Cartelle locali
settings-sources-section-stations = Stazioni radio
settings-sources-stations-find = Trova stazioni...
settings-sources-stations-import = Importa stazioni...
settings-sources-stations-name-placeholder = Nome (facoltativo)
settings-sources-stations-none = Nessuna stazione ancora
settings-sources-stations-url-placeholder = URL dello stream
...
settings-storage-looks-layouts = Look e layout
    .description = Il look che l'app sta usando (workspace.json) con i tuoi spazi di lavoro salvati e i file shader estratti accanto. Piccolo, e ogni suo byte è qualcosa che hai impostato tu
...
menu-quick-play = Riproduzione rapida
...
tasks-job-plays-import = Conteggi riproduzioni Last.fm
...
welcome-menu-add = Aggiungi al menu delle applicazioni
welcome-menu-failed = Impossibile aggiungere la voce di menu
welcome-menu-not-now = Non ora
welcome-menu-note = Un'AppImage non si registra da sola. Questo aggiunge una voce di avvio e le associazioni dei file audio; fuori dalla tua cartella personale non cambia nulla.
welcome-menu-title = Aggiungere rox al menu delle applicazioni?
...
autoeq-placeholder = Cerca cuffie o auricolari (es. HD 600, AirPods, Zero)...
autoeq-search = Cerca in AutoEq
autoeq-searching = Ricerca in AutoEq in corso...
autoeq-loading = Caricamento database AutoEq...
autoeq-none = Nessun profilo cuffie corrisponde a "{ $text }"
autoeq-failed = Errore AutoEq: { $reason }
autoeq-apply = Applica
autoeq-applied = Applicato
autoeq-import-file = Importa file di preset
...
keymap-mod-win = Win
keymap-new-window = Nuova finestra
    .description = Apre un'altra finestra di lavoro con il layout salvato
keymap-next-track = Traccia successiva
    .description = Passa alla traccia successiva in coda
keymap-open-about = Informazioni
    .description = Mostra la versione e i crediti
...
keymap-open-console = Console
    .description = Apre la console dei log
keymap-open-equalizer = Equalizzatore
    .description = Apre la finestra dell'equalizzatore
keymap-open-preset-picker = Preset dello sfondo
    .description = Apre il selettore di preset Milkdrop per lo sfondo
...
keymap-open-tasks = Attività
    .description = Mostra a cosa sta lavorando rox in background
keymap-open-welcome = Benvenuto
    .description = Riapre la finestra di benvenuto
keymap-play-random = Riproduci a caso
    .description = Pesca una traccia a caso dalla libreria e la riproduce
...
keymap-previous-track = Traccia precedente
    .description = Torna alla traccia precedente
keymap-quit = Esci
...
keymap-ab-repeat = Ripeti A-B
    .description = Segna A, poi B, poi cancella
keymap-ab-clear = Clear A-B Section
    .description = Drop the A-B section and any half-marked step with it
keymap-bookmark = Aggiungi segnalibro
    .description = Metti un segnalibro alla posizione attuale
keymap-bookmark-named = Aggiungi segnalibro con nome
    .description = Metti un segnalibro alla posizione attuale e dagli un nome
keymap-prev-bookmark = Segnalibro precedente
    .description = Tornare al segnalibro prima della posizione attuale
keymap-next-bookmark = Segnalibro successivo
    .description = Saltare al segnalibro successivo
keymap-cue = Aggiungi punto
    .description = Mettere un punto di sessione alla posizione in riproduzione. I punti durano finché rox resta aperto
keymap-cue-prev = Punto precedente
    .description = Tornare al punto prima della testina
keymap-cue-next = Punto successivo
    .description = Saltare al punto successivo
keymap-stop-playback = Ferma
    .description = Ferma la riproduzione e rilascia la traccia
...
keymap-type-ahead-next = Corrispondenza successiva
    .description = Passa alla riga successiva che corrisponde a quanto digitato
keymap-type-ahead-prev = Corrispondenza precedente
    .description = Torna alla corrispondenza precedente di quanto digitato
keymap-next-tab = Scheda successiva
...
panel-catalog-bookmarks = Segnalibri
...
lastfm-import-plays-stopped = { $count ->
    [one] Fermato dopo { $count } brano
   *[other] Fermato dopo { $count } brani
}
lastfm-import-plays-matched = , { $count } con corrispondenza
lastfm-import-plays-updated = { $count ->
    [one] , { $count } riproduzione aggiunta
   *[other] , { $count } riproduzioni aggiunte
}
...
tags-editor-replace = sostituisci
tags-editor-replace-apply = Applica
tags-editor-replace-find = Trova
tags-editor-replace-help = Ogni occorrenza viene riscritta. Con regex, $1 inserisce il primo gruppo. I risultati vengono rifilati ai bordi.
tags-editor-replace-ignore-case = Ignora maiuscole
tags-editor-replace-match-count = { $hits ->
    [one] { $hits } di { $total } cambia
   *[other] { $hits } di { $total } cambiano
}
tags-editor-replace-regex = Regex
tags-editor-replace-with = Sostituisci
...
tags-matcher-identify = Riconosci dal suono
tags-matcher-identify-no-duration = Manca la durata del brano per il riconoscimento
...
waveform-loudness = Banda di intensità
    .description = Disegna il livello RMS come una banda più piatta dentro l'inviluppo dei picchi
waveform-gradient-mode = Origine del colore
    .description = Da dove inviluppo e banda prendono i colori: l'accento, la rampa del tema, la copertina, o una coppia personalizzata
waveform-scrobble-marker = Segno di scrobble
    .description = Una linea sottile dove la traccia conta come scrobblata su Last.fm
waveform-bookmarks = Segnalibri
    .description = I segnalibri della traccia in riproduzione come frecce lungo il bordo inferiore: clic per saltare, clic destro per modificare
...
waveform-live-mode = Forma in diretta
    .description = Cosa disegna la striscia mentre suona una stazione radio: niente, il suono della stazione stessa, o una forma che disegna da sé
waveform-live-trace = Traccia
waveform-live-motion = Movimento
waveform-live-window = Finestra in diretta
    .description = Secondi di una stazione radio coperti dalla traccia scorrevole; una finestra più ampia scorre a velocità minore
waveform-live-expression = Espressione del movimento
    .description = x va da 0 a 1 lungo la striscia, t sono i secondi dell'orologio del pannello; sin cos tan abs sqrt exp ln floor min max clamp mix, con + - * / ^ pi e le parentesi
waveform-live-expression-error = { $reason }, quindi la striscia disegna la forma predefinita
waveform-section-live = In diretta
waveform-streaming = IN STREAMING
...
metadata-cover-opacity = Opacità della copertina
    .description = Quanto la copertina traspare dietro i campi
...
metadata-field-bookmarks = Segnalibri
metadata-field-bpm-measured = { $bpm } (misurato da rox)
metadata-field-codec = Codec
metadata-field-comment = Commento
metadata-field-copies = Copie
metadata-field-cover = Copertina
metadata-field-source = Sorgente
...
metadata-field-first-played = Primo ascolto
metadata-field-folder = Cartella
metadata-field-gain-album = Guadagno album
metadata-field-gain-track = Guadagno traccia
metadata-field-last-played = Ultimo ascolto
metadata-field-lastfm-listeners = Ascoltatori globali
metadata-field-lastfm-loved = Preferito su Last.fm
metadata-field-lastfm-plays = Ascolti globali
metadata-field-lastfm-tags = Tag Last.fm
metadata-field-lastfm-user-plays = I tuoi scrobble
metadata-field-lyrics = Testo
metadata-field-mb-country = Paese di pubblicazione
metadata-field-mb-date = Pubblicato
metadata-field-mb-first-release = Prima pubblicazione
metadata-field-mb-isrc = ISRC
metadata-field-mb-label = Etichetta
metadata-field-missing = Manca
metadata-field-rank = Posizione in libreria
metadata-field-recent-plays = Ascolti (30 giorni)
metadata-field-sample-rate = Frequenza di campionamento
metadata-field-similar = Brani simili
metadata-field-size = Dimensione
metadata-field-title-sort = Ordinamento titolo
metadata-field-track = Traccia
metadata-fields = Campi
    .description = Quali campi elenca la scheda; un campo senza valore mostra n/d, e un nome di ordinamento compare solo dove differisce
...
metadata-cover-embedded = Incorporata, { $px }
metadata-cover-folder = { $file }, { $px }
metadata-hide-empty = Nascondi i campi vuoti
    .description = Omettere un campo attivo senza valore invece di elencarlo come n/d
metadata-loved-no = No
metadata-loved-yes = Sì
metadata-lyrics-plain = Solo testo
metadata-lyrics-synced = Sincronizzato
metadata-missing-none = Niente
metadata-rank-value = n. { $rank }
metadata-tags-scope-album = (tag dell'album)
metadata-tags-scope-artist = (tag dell'artista)
metadata-track-of = { $track } di { $total }
...
history-live-plays-file = Riproduce la tua copia di questo brano
history-live-plays-station = Riproduce la stazione; la tua libreria non ha questo brano
...
art-perspective = Prospettiva
    .description = Gira le copertine laterali secondo l'angolo qui sotto; da spenta restano piatte e quadrate, l'unica modalità in cui vale l'arrotondamento delle copertine
art-recede = Luce in profondità
    .description = Quanto è illuminata la copertina più in fondo alla pila; quelle tra lei e il centro si dividono la distanza in parti uguali
art-spacing = Spaziatura copertine
    .description = Quanto la prima copertina di ogni lato sta lontana da quella centrale; oltre la metà la libera e le lascia spazio
art-stride = Spaziatura della pila
    .description = Quanto distano tra loro le copertine dietro la prima; fissa anche quanto viaggia un trascinamento per copertina
art-visible = Copertine mostrate
    .description = Quante copertine stanno su ogni lato di quella centrale; l'ultima svanisce mentre esce
art-tilt = Angolo di rotazione
    .description = Quanto le copertine laterali ruotano allontanandosi da te
...
playlists-export-tooltip = Esporta playlist
...
playlists-import = Importa playlist...
...
## Biography panel
biography-active-between = Attivo dal { $from } al { $to }
biography-active-since = Attivo dal { $from }
biography-background = Sfondo
    .description = La fanart dell'artista dietro il testo, attenuata e sfumata verso il basso
biography-background-opacity = Opacità dello sfondo
    .description = Quanto la fanart traspare dietro il testo
biography-cycle = Alterna le immagini di intestazione
    .description = Scorre il banner e le fanart dell'artista nell'intestazione con una dissolvenza, e passa da una all'altra a mano con le frecce che compaiono al passaggio del mouse
biography-cycle-interval = Intervallo di alternanza
    .description = Quanto resta ogni immagine di intestazione prima che compaia la successiva
...
biography-flag = Bandiera del paese
    .description = Mostrare il paese come bandiera invece del codice di due lettere
biography-from-lastfm = Da Last.fm
biography-header-banner = Banner
    .description = La fascia larga con il logo che TheAudioDB tiene per l'artista, nell'intestazione
biography-header-blur = Adatta con sfondo sfocato
    .description = Con le proporzioni spente, inserire l'immagine intera nella fascia sopra una versione sfocata di sé invece di ritagliarla
biography-header-fanart = Fanart
    .description = Le fanart 16:9 dell'artista da TheAudioDB, nell'intestazione
biography-header-height = Altezza dell'intestazione
    .description = L'altezza della fascia di intestazione in px, e il tetto per una tenuta nelle sue proporzioni
...
biography-header-overlay = Titolo sull'intestazione
    .description = Mette nome, origine e anni in basso sull'immagine di intestazione invece che sotto
...
biography-name-source = Nome da
    .description = Quale tag nomina l'artista: quello del brano, o l'artista dell'album per una compilation o un disco pieno di ospiti
...
biography-profile = Origine e anni
    .description = Il codice del paese e gli anni di attività, da TheAudioDB
biography-refresh = Aggiorna
biography-seconds = { $count } s
biography-similar-artists = Artisti simili
    .description = Artisti correlati secondo i dati di ascolto, come chip: un clic apre la loro scheda, e una lente su quelli che la libreria possiede li seleziona nella ricerca
...
biography-top-tracks = Brani più ascoltati
    .description = I brani più riprodotti su Last.fm, un clic riproduce quelli che la libreria ha e il più li mette in coda
biography-top-tracks-count = Numero di brani
    .description = Quanti dei brani più ascoltati elencare
biography-top-tracks-heading = Brani più ascoltati
...
playback-ab-clear = Cancella A-B
playback-ab-set-a = Segna A
playback-ab-set-b = Segna B
playback-ab-tip-a = A a { $a }. Premi di nuovo per segnare B
playback-ab-tip-looping = Ripete da { $a } a { $b }
playback-ab-tip-off = Segna l'inizio della sezione da ripetere
...
playback-menu-ab-repeat = Pulsante Ripeti A-B
...
track-info-output-resample-exclusive-stream = Questo flusso è a { $source } kHz e la scheda ha accettato { $device } kHz, quindi ogni campione viene convertito in uscita. Il dispositivo non ha voluto girare alla frequenza del flusso.
track-info-output-resample-mixer-stream = Questo flusso è a { $source } kHz e il mixer gira a { $device } kHz, quindi ogni campione viene convertito in uscita. La modalità esclusiva passerebbe invece alla scheda la frequenza del flusso.
...
seek-scrobble-marker = Segno di scrobble
    .description = Una linea sottile dove la traccia conta come scrobblata su Last.fm
seek-bookmarks = Segnalibri
    .description = I segnalibri della traccia in riproduzione come frecce sotto la linea: clic per saltare, clic destro per modificare
seek-show-timings = Mostra i tempi
seek-dash-length = Lunghezza del tratto
    .description = La lunghezza di ogni tratto dell'avvio, con uno spazio della stessa misura dopo
seek-lead-in = Avvio del buffer
    .description = Come viene disegnata la parte del buffer della stazione non ancora riempita, il tratto a sinistra del nastro
seek-lead-in-dashed = Tratteggiata
seek-lead-in-faint = Tenue
seek-lead-in-hidden = Nascosta
seek-lead-in-sweep = Scorrimento dell'avvio
    .description = Una sfumatura che scorre lungo la parte non ancora riempita, come in una barra di caricamento
seek-section-live = In diretta
...
milkdrop-presets = Preset
milkdrop-tuning = Regolazioni
milkdrop-roots = Cartelle dei preset
milkdrop-add-root = Aggiungi cartella
milkdrop-remove-root = Rimuovi
milkdrop-folder = Dove cerca rox
milkdrop-filter-presets = Filtra i preset
milkdrop-preset-count = { $count } preset su { $total }
milkdrop-locked = Blocca il preset
    .description = Resta su questo: nessun cambio a tempo, nessun taglio su un beat
milkdrop-duration = Durata del preset
    .description = Quanto tiene un preset prima che arrivi il successivo
milkdrop-beat-sensitivity = Sensibilità al beat
    .description = Quanto facilmente projectM conta qualcosa come beat. Un mix sommesso ne chiede più di uno forte
milkdrop-hard-cuts = Tagli netti
    .description = Lascia che un beat abbastanza forte tagli dritto al preset successivo
milkdrop-fps = Frequenza dei fotogrammi
    .description = Quello a cui punta il thread di rendering. 30 dimezza il costo della rilettura di ogni fotogramma
milkdrop-scale = Scala di rendering
    .description = Renderizza sotto la dimensione del pannello e ingrandisci. Costa nitidezza e risparmia la stessa quota di rilettura
milkdrop-tint = Colore dell'album
    .description = Ruota le tinte del visual verso la copertina del brano in riproduzione. Zero lascia i colori del preset come sono
milkdrop-fade-duration = Durata della dissolvenza
milkdrop-idle = A riposo
    .description = Cosa fa il visual mentre la riproduzione è in pausa o ferma. Mantieni lascia l'ultimo fotogramma sullo schermo. Dissolvi lo porta allo sfondo del pannello e lo riporta alla riproduzione
milkdrop-idle-hold = Mantieni
milkdrop-idle-fade = Dissolvi
milkdrop-run-focused = Continua con il focus
    .description = Il visual continua a muoversi finché il pannello ha il focus, che stia riproducendo o no. Disattivato, un fotogramma mantenuto resta fermo anche con il pannello a fuoco
milkdrop-show-name = Mostra il nome del preset
    .description = Mostra il nome del preset nell'angolo per qualche secondo quando cambia
milkdrop-next = Preset successivo
milkdrop-previous = Preset precedente
milkdrop-random = Preset a caso
milkdrop-open-folder = Apri la cartella dei preset
milkdrop-rescan = Rianalizza
milkdrop-rotation = Rotazione
    .description = Quali preset percorrono Successivo, Precedente e il cambio a tempo
milkdrop-rotation-all = Tutti i preset
milkdrop-empty = Nessun preset trovato.
    .description = Metti un pacchetto nella cartella qui sotto, poi premi Rianalizza. Questi sono i tre che valgono, tutti sotto projectM-visualizer su GitHub.
milkdrop-packs-hint = Metti qui i pacchetti di preset. I tre che valgono sono presets-cream-of-the-crop, presets-milkdrop-original e presets-milkdrop-texture-pack, tutti su GitHub sotto projectM-visualizer.
milkdrop-no-gl = Milkdrop non è riuscito ad avviarsi.
milkdrop-still-starting = Milkdrop si sta ancora avviando.
milkdrop-still-starting-detail = In attesa di un contesto OpenGL dal driver grafico.
milkdrop-no-frames = Milkdrop è in esecuzione, ma non è arrivato nessun fotogramma.
milkdrop-no-frames-detail = Rendering su { $renderer }, { $version }. I dettagli sono nella console.
milkdrop-favorite = Preset preferito
milkdrop-favorite-short = Preferito
milkdrop-favorited = Nei preferiti
milkdrop-favorites-only = Solo preferiti
milkdrop-rotation-favorites = Preferiti ({ $count })
milkdrop-no-favorites = Non c'è ancora nulla di contrassegnato, quindi questo mescola l'intera libreria. Contrassegna un preset dalla lista, dal menu del pannello o dalla riga In riproduzione.
milkdrop-reveal = Mostra preset nella cartella
milkdrop-reveal-short = Mostra
milkdrop-current = In riproduzione
milkdrop-no-preset = Ancora niente caricato
milkdrop-color = Colore
    .description = Preset tiene i colori del file. Tema li ribalta verso il chiaro sul tema chiaro. Tavolozza li dipinge con lo sfondo e l'accento del tema e salta il colore dell'album. Copertina li dipinge con il colore della copertina in riproduzione, con o senza tema per brano
milkdrop-color-preset = Preset
milkdrop-color-theme = Tema
milkdrop-color-palette = Tavolozza
milkdrop-color-cover = Copertina
milkdrop-name-always = Tieni il nome sullo schermo
    .description = Tieni il nome sempre visibile invece che per qualche secondo
milkdrop-flip-horizontal = Capovolgi in orizzontale
    .description = Riflette il visual da sinistra a destra
milkdrop-flip-vertical = Capovolgi in verticale
    .description = Riflette il visual dall'alto in basso
milkdrop-choose = Scegli preset
milkdrop-picker-title = Scegli preset
milkdrop-picker-backdrop = Sfondo
milkdrop-picker-host = Scelta per { $host }
milkdrop-view-tree = Albero
milkdrop-view-grid = Griglia
milkdrop-nested = Nidificato
milkdrop-locate-current = Vai all'attivo
milkdrop-load-preset = Carica preset
milkdrop-unfavorite = Rimuovi dai preferiti
