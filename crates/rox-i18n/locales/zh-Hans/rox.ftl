...
autoeq-placeholder = 搜索耳机或耳塞（例如 HD 600、AirPods、Zero）...
autoeq-search = 搜索 AutoEq
autoeq-searching = 正在搜索 AutoEq...
autoeq-loading = 正在加载 AutoEq 数据库...
autoeq-none = 没有与“{ $text }”匹配的耳机配置文件
autoeq-failed = AutoEq 错误：{ $reason }
autoeq-apply = 应用
autoeq-applied = 已应用
autoeq-import-file = 导入预设文件
eq-flatten = 拉平
eq-freq-label = 频率
eq-gain-label = 增益
eq-heading = 均衡器
