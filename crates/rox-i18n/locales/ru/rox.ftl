...
bookmark-edit-title = Изменить закладку
bookmark-window-title = rox - { $verb }
bookmark-name = Название
bookmark-name-placeholder = Необязательно, без названия показывается время
bookmark-position = На { $time }
bookmark-color = Цвет
bookmark-color-accent = Акцент темы
bookmark-color-custom = Свой...
bookmark-color-red = Красный
bookmark-color-orange = Оранжевый
bookmark-color-yellow = Жёлтый
bookmark-color-green = Зелёный
bookmark-color-teal = Бирюзовый
bookmark-color-blue = Синий
bookmark-color-purple = Фиолетовый
bookmark-color-pink = Розовый
bookmark-save = Сохранить
bookmark-hint-before = Нажмите
bookmark-hint-key = Enter
bookmark-hint-after = чтобы сохранить
bookmark-menu-play = Воспроизвести отсюда
bookmark-menu-rename = Переименовать...
bookmark-menu-color = Цвет
bookmark-menu-move = Переместить к позиции воспроизведения
bookmark-menu-remove = Удалить
...
playback-sleep-15 = Стоп через 15 минут
playback-sleep-30 = Стоп через 30 минут
playback-sleep-60 = Стоп через час
playback-sleep-90 = Стоп через 90 минут
playback-sleep-off = Без таймера сна
playback-sleep-off-remaining = Отменить таймер сна (осталось { $minutes } мин)
playback-sleep-tip = Таймер сна
playback-sleep-tip-remaining = Таймер сна, осталось { $minutes } мин
menubar-button-tasks = Кнопка задач
menubar-button-sleep = Кнопка таймера сна
menubar-button-rescan = Кнопка пересканирования
...
library-group-search-results = Группировать результаты поиска
    .description = Сохраняет текущие заголовки групп во время поиска; отключите, чтобы показывать найденные треки плоским списком
...
settings-appearance-milkdrop-beat-sensitivity = Чувствительность к биту
    .description = Насколько охотно projectM считает что-то битом. Тихому миксу нужно больше, чем громкому
settings-appearance-milkdrop-color = Цвет
    .description = Пресет оставляет цвета файла. Тема переворачивает их в светлые на светлой теме. Палитра красит их в фон и акцент темы. Обложка красит их в цвет играющей обложки, независимо от темы по треку
settings-appearance-milkdrop-duration = Длительность пресета
    .description = Сколько держится пресет, прежде чем придёт следующий
settings-appearance-milkdrop-enabled = Подложка Milkdrop
    .description = Крутить визуализацию Milkdrop позади всего приложения, пока играет музыка
settings-appearance-milkdrop-error-title = Подложка Milkdrop не смогла запуститься
settings-appearance-milkdrop-fade-duration = Длительность затухания
    .description = Сколько длится затухание: на выходе при паузе или остановке и на входе при воспроизведении
settings-appearance-milkdrop-flip-horizontal = Отразить по горизонтали
    .description = Зеркалит визуал слева направо
settings-appearance-milkdrop-flip-vertical = Отразить по вертикали
    .description = Зеркалит визуал сверху вниз
settings-appearance-milkdrop-fps = Частота кадров
    .description = К чему стремится поток отрисовки. 30 вдвое снижает цену обратного чтения каждого кадра, а размытому фону редко нужно больше
settings-appearance-milkdrop-hard-cuts = Резкие переходы
    .description = Достаточно громкий бит переключает на следующий пресет сразу
settings-appearance-milkdrop-idle = В простое
    .description = Что делает визуализация, пока воспроизведение на паузе или остановлено. Держать оставляет последний кадр за приложением. Затухать уводит его к фону обложки и возвращает при воспроизведении
settings-appearance-milkdrop-locked = Закрепить пресет
    .description = Оставаться на текущем пресете между треками и перезапусками
settings-appearance-milkdrop-preset = Пресет
    .description = Какой пресет показывает подложка. Работает без воспроизведения и возвращается после перезапуска
settings-appearance-milkdrop-rotation = Ротация
    .description = Какие пресеты перебирают «Далее», «Назад» и смена по таймеру
settings-appearance-milkdrop-scale = Масштаб рендера
    .description = Какую долю разрешения окна рендерит визуализация. Меньше стоит дешевле; такой мягкой подложке редко нужно больше
settings-appearance-milkdrop-strength = Сила
    .description = Насколько далеко визуализация проступает поверх размытой обложки
...
settings-appearance-section-milkdrop = Подложка Milkdrop
...
settings-application-prerelease-updates = Предлагать кандидаты в выпуски
    .description = Предлагать и кандидаты в выпуски, предварительные сборки, которые выходят перед выпуском для проверки; сборка-кандидат видит следующую в любом случае
...
settings-application-menu-entry = Пункт в меню приложений
    .description = Ярлык запуска и привязки файлов для этого AppImage, которые всегда указывают туда, где сейчас лежит файл
...
settings-integrations-ffmpeg-binary = Исполняемый файл FFmpeg
    .description = Какой ffmpeg выполняет преобразования; оставьте пустым, чтобы взять тот, что в PATH, или сборку из папки данных rox
...
settings-integrations-ffmpeg-missing-note-flatpak = Преобразование останется скрытым. Положите статическую сборку ffmpeg в папку данных rox; установленная в системе внутри песочницы не запустится.
...
settings-integrations-ffmpeg-reveal = Показать папку данных
...
settings-integrations-lastfm-import-plays = Импорт количества прослушиваний
    .description = Заполнить историю и количество прослушиваний из скробблов Last.fm
settings-integrations-lastfm-import-plays-button = Импортировать прослушивания
...
settings-integrations-librefm-intro = Подключите свой аккаунт Libre.fm: разрешите доступ rox в браузере, и прослушанные треки уйдут туда в скробблинг, как только перейдут порог
settings-integrations-listenbrainz-get-token = Получить токен
settings-integrations-listenbrainz-intro = Вставьте пользовательский токен с listenbrainz.org/settings. Прослушивания отправляются, как только трек переходит порог скробблинга.
settings-integrations-listenbrainz-token-placeholder = Токен
settings-integrations-listenbrainz-token-row = Пользовательский токен
...
settings-integrations-scrobble-connect = Подключить
settings-integrations-scrobble-disconnect = Отключить
settings-integrations-scrobble-finish-connecting = Завершить подключение
settings-integrations-scrobble-reconnect = Переподключить
settings-integrations-scrobble-status-checking = Проверка токена
settings-integrations-scrobble-status-confirming = Подтверждение...
settings-integrations-scrobble-status-connected = Подключено как { $username }
settings-integrations-scrobble-status-failed = Подключение не удалось: { $error }
settings-integrations-scrobble-status-invalid = { $service } отклонил этот токен
settings-integrations-scrobble-status-not-connected = Не подключено
settings-integrations-scrobble-status-rejected = { $service } отклонил сессию, и она была сброшена. Подключитесь заново, чтобы скробблинг продолжился
settings-integrations-scrobble-status-requesting = Запрос токена...
settings-integrations-scrobble-status-waiting = Разрешите доступ rox в браузере, затем завершите подключение
settings-integrations-scrobble-threshold = Порог скробблинга
    .description = Какую часть трека надо проиграть, прежде чем он уйдёт в скробблинг во все подключённые сервисы; полоса перемотки и волновая форма умеют это отмечать
settings-integrations-scrobble-tracks = Скробблить треки
    .description = Отправлять прослушанные треки во все подключённые сервисы, как только они перешли порог
settings-integrations-scrobble-working = Выполняется...
...
settings-library-portal-hint = Замените /path/to на то, где папка находится на самом деле.
settings-library-portal-note = Это работает, но для библиотеки медленно, и rox не может следить за изменениями. Дайте rox доступ к настоящему расположению папки, затем удалите её и добавьте снова:
settings-library-portal-title = rox открывает эту папку через файловый портал
...
settings-providers-acoustid = AcoustID
    .description = Снять отпечаток звука и спросить acoustid.org, что это за запись; кнопка распознавания в сравнении метаданных находит издание даже для файла, теги которого слишком неверны для поиска
settings-providers-acoustid-key = Ключ AcoustID
settings-providers-acoustid-key-hint = Необязательно; в этой сборке есть свой ключ
settings-providers-acoustid-key-placeholder = Ключ приложения
...
settings-storage-looks-layouts = Внешний вид и макеты
    .description = Внешний вид, который сейчас использует приложение (workspace.json), рядом с сохранёнными рабочими пространствами и выгруженными файлами шейдеров. Места занимает мало, и каждый байт здесь настроен вами
...
menu-quick-play = Быстрый запуск
...
tasks-job-plays-import = Счетчики прослушиваний Last.fm
...
health-desc-writable = Треки в форматах, которые rox читает, но не может записать в них теги. Редкая разновидность фрагментированных MP4 тоже отказывает в записи, и здесь она не учтена.
...
welcome-menu-add = Добавить в меню приложений
welcome-menu-failed = Не удалось добавить пункт меню
welcome-menu-not-now = Не сейчас
welcome-menu-note = AppImage сам себя не регистрирует. Это добавит ярлык запуска и привязки аудиофайлов; за пределами домашней папки ничего не изменится.
welcome-menu-title = Добавить rox в меню приложений?
...
autoeq-placeholder = Поиск наушников (напр. HD 600, AirPods, Zero)...
autoeq-search = Искать в AutoEq
autoeq-searching = Поиск в AutoEq...
autoeq-loading = Загрузка базы данных AutoEq...
autoeq-none = Профили для «{ $text }» не найдены
autoeq-failed = Ошибка AutoEq: { $reason }
autoeq-apply = Применить
autoeq-applied = Применено
autoeq-import-file = Импортировать файл пресета
eq-flatten = Выровнять
eq-freq-label = Частота
eq-gain-label = Усиление
eq-heading = Эквалайзер
eq-help-text = Тяните полосу, чтобы её сдвинуть, крутите колесо над ней, чтобы расширить или сузить. Обработка идёт до буфера, из которого читает звуковая карта, поэтому, пока это окно открыто, движение доходит до колонок примерно за 120 мс.
...
keymap-mod-win = Win
keymap-new-window = Новое окно
    .description = Открыть ещё одно рабочее окно с сохранённым макетом
keymap-next-track = Следующий трек
    .description = Перейти к следующему треку в очереди
keymap-open-about = О программе
    .description = Показать версию и благодарности
...
keymap-open-console = Консоль
    .description = Открыть окно журнала
keymap-open-equalizer = Эквалайзер
    .description = Открыть окно эквалайзера
keymap-open-preset-picker = Пресеты фона
    .description = Открыть выбор пресетов Milkdrop для фона
...
keymap-ab-repeat = Повтор A-B
    .description = Отметьте A, затем B, затем сбросьте
keymap-ab-clear = Clear A-B Section
    .description = Drop the A-B section and any half-marked step with it
keymap-bookmark = Добавить закладку
    .description = Поставить закладку на текущей позиции
keymap-bookmark-named = Добавить закладку с названием
    .description = Поставить закладку на текущей позиции и дать ей название
keymap-prev-bookmark = Предыдущая закладка
...
keymap-type-ahead-next = Следующее совпадение
...
lastfm-import-plays-read = Прочитано треков с прослушиваниями: { $count }
lastfm-import-plays-stopped = Остановлено после { $count } треков
lastfm-import-plays-matched = , совпадений: { $count }
lastfm-import-plays-updated = , добавлено прослушиваний: { $count }
...
tags-editor-replace = заменить
tags-editor-replace-apply = Применить
tags-editor-replace-find = Найти
tags-editor-replace-help = Каждое совпадение переписывается. С regex $1 вставляет первую группу. Результаты обрезаются по краям.
tags-editor-replace-ignore-case = Без учёта регистра
tags-editor-replace-match-count = изменится { $hits } из { $total }
tags-editor-replace-regex = Regex
tags-editor-replace-with = Заменить на
...
tags-matcher-identify = Узнать по звуку
tags-matcher-identify-no-duration = Нет длительности трека для распознавания
...
tags-rename-pattern-help = { $placeholders }; / создаёт папку от корня библиотеки, без / переименовывает на месте, расширение берётся от файла
...
pass-tempo-body = Из каждого файла декодируются два окна по полминуты и в них считаются удары, а если эти два расходятся, читаются ещё окна, чтобы медиатека умела показать, на какой скорости идёт трек. Лучше всего работает на музыке, записанной под клик, и пропускает то, что измерить не выходит. Числа идут в базу медиатеки, а ваши файлы остаются нетронутыми.
...
waveform-loudness = Полоса громкости
    .description = Рисовать уровень RMS более плоской полосой внутри огибающей пиков
waveform-gradient-mode = Источник цвета
    .description = Откуда огибающая и полоса берут цвета: акцент, шкала темы, обложка или своя пара
...
metadata-cover-opacity = Непрозрачность обложки
    .description = Насколько сильно обложка проступает за полями
...
metadata-field-folder = Папка
metadata-field-gain-album = Усиление альбома
metadata-field-gain-track = Усиление трека
metadata-field-last-played = Последнее прослушивание
metadata-field-lastfm-listeners = Слушателей в мире
metadata-field-lastfm-loved = Любимый на Last.fm
metadata-field-lastfm-plays = Прослушиваний в мире
metadata-field-lastfm-tags = Теги Last.fm
metadata-field-lastfm-user-plays = Ваши скробблы
metadata-field-lyrics = Текст
metadata-field-mb-country = Страна выпуска
metadata-field-mb-date = Выпущен
metadata-field-mb-first-release = Первый выпуск
metadata-field-mb-isrc = ISRC
metadata-field-mb-label = Лейбл
metadata-field-missing = Не хватает
metadata-field-rank = Место в библиотеке
metadata-field-recent-plays = Прослушиваний (30 дней)
metadata-field-sample-rate = Частота дискретизации
metadata-field-similar = Похожие треки
metadata-field-size = Размер
metadata-field-title-sort = Сортировка названия
metadata-field-track = Трек
metadata-fields = Поля
    .description = Какие поля показывает лист; поле без значения показывает н/д, а имя для сортировки появляется только там, где отличается
...
metadata-cover-embedded = Встроенная, { $px }
metadata-cover-folder = { $file }, { $px }
metadata-hide-empty = Скрывать пустые поля
    .description = Не показывать включённое поле без значения вместо строки н/д
metadata-loved-no = Нет
metadata-loved-yes = Да
metadata-lyrics-plain = Только текст
metadata-lyrics-synced = С таймингом
metadata-missing-none = Ничего
metadata-rank-value = № { $rank }
metadata-tags-scope-album = (теги альбома)
metadata-tags-scope-artist = (теги исполнителя)
metadata-track-of = { $track } из { $total }
...
art-perspective = Перспектива
    .description = Разворачивать боковые обложки на угол ниже; выключено они остаются плоскими и квадратными, единственный режим, где работает скругление обложек
art-recede = Яркость в глубине
    .description = Насколько освещена самая дальняя обложка стопки; обложки между ней и центром делят расстояние поровну
art-spacing = Расстояние между обложками
    .description = Насколько далеко от центральной обложки стоит первая с каждой стороны; после половины она отходит от центральной и оставляет ей место
art-stride = Шаг стопки
    .description = Насколько далеко друг от друга стоят обложки за первой; этим же задаётся, сколько проходит перетаскивание на одну обложку
art-visible = Показывать обложек
    .description = Сколько обложек стоит с каждой стороны от центральной; последняя гаснет на выходе
art-tilt = Угол поворота
    .description = Насколько боковые обложки отворачиваются от вас
...
## Biography panel
biography-active-between = Годы активности: с { $from } по { $to }
biography-active-since = Годы активности: с { $from }
biography-background = Фон
    .description = Фанарт исполнителя за текстом, притушенный и растворяющийся книзу
biography-background-opacity = Непрозрачность фона
    .description = Насколько сильно фанарт проступает за текстом
biography-cycle = Сменять изображения шапки
    .description = Перебирать баннер и фанарт исполнителя в шапке с плавным переходом, а стрелками, появляющимися при наведении, листать вручную
biography-cycle-interval = Интервал смены
    .description = Сколько держится каждое изображение шапки, прежде чем проявится следующее
...
biography-flag = Флаг страны
    .description = Показывать страну флагом, а не двухбуквенным кодом
biography-from-lastfm = С Last.fm
biography-header-banner = Баннер
    .description = Широкая полоса с логотипом, которую TheAudioDB хранит для исполнителя, в шапке
biography-header-blur = Вписать на размытом фоне
    .description = При выключенных пропорциях вписывать изображение целиком в полосу поверх размытой копии, а не обрезать
biography-header-fanart = Фанарт
    .description = Фанарты 16:9 исполнителя с TheAudioDB, в шапке
biography-header-height = Высота шапки
    .description = Высота полосы шапки в px, а при сохранении пропорций её потолок
biography-header-image = Изображение шапки
    .description = Широкий баннер исполнителя сверху или портрет, когда баннера нет
biography-header-overlay = Заголовок на шапке
    .description = Положить имя, страну и годы поверх нижней части изображения шапки, а не под ним
...
biography-name-source = Имя из
    .description = Какой тег называет исполнителя: исполнитель трека или исполнитель альбома для сборника или записи с множеством гостей
...
biography-profile = Страна и годы
    .description = Код страны и годы активности, с TheAudioDB
biography-refresh = Обновить
biography-seconds = { $count } с
biography-similar-artists = Похожие исполнители
    .description = Похожие исполнители по данным прослушиваний, в виде чипов: клик открывает их страницу, а значок поиска у тех, что есть в библиотеке, выбирает их в поиске
...
biography-top-tracks = Популярные треки
    .description = Самые прослушиваемые треки на Last.fm, щелчок запускает те, что есть в библиотеке, а плюс ставит их в очередь
biography-top-tracks-count = Число треков
    .description = Сколько популярных треков показывать
biography-top-tracks-heading = Популярные треки
...
playback-ab-clear = Сбросить A-B
playback-ab-set-a = Отметить A
playback-ab-set-b = Отметить B
playback-ab-tip-a = A на { $a }. Нажмите ещё раз, чтобы отметить B
playback-ab-tip-looping = Повтор с { $a } до { $b }
playback-ab-tip-off = Отметьте начало отрезка для повтора
...
playback-menu-ab-repeat = Кнопка повтора A-B
...
milkdrop-presets = Пресеты
milkdrop-tuning = Настройка
milkdrop-roots = Папки с пресетами
milkdrop-add-root = Добавить папку
milkdrop-remove-root = Убрать
milkdrop-folder = Где rox ищет
milkdrop-filter-presets = Фильтр пресетов
milkdrop-preset-count = { $count } из { $total } пресетов
milkdrop-locked = Закрепить пресет
    .description = Остаться на этом: без смены по времени и без переключения на бите
milkdrop-duration = Длительность пресета
    .description = Сколько пресет держится, пока не придёт следующий
milkdrop-beat-sensitivity = Чувствительность к биту
    .description = Насколько охотно projectM считает что-то битом. Тихому миксу нужно больше, чем громкому
milkdrop-hard-cuts = Резкие переходы
    .description = Достаточно громкий бит переключает на следующий пресет сразу
milkdrop-fps = Частота кадров
    .description = К чему стремится поток отрисовки. 30 вдвое снижает цену обратного чтения каждого кадра
milkdrop-scale = Масштаб отрисовки
    .description = Рисовать меньше размера панели и растягивать. Стоит резкости и экономит ту же долю обратного чтения
milkdrop-tint = Цвет альбома
    .description = Поворачивает оттенки картинки к обложке звучащего трека. Ноль оставляет цвета пресета как есть
milkdrop-fade-duration = Длительность затухания
milkdrop-idle = В простое
    .description = Что делает визуализация, пока воспроизведение на паузе или остановлено. Держать оставляет последний кадр на экране. Затухать уводит его к фону панели и возвращает при воспроизведении
milkdrop-idle-hold = Держать
milkdrop-idle-fade = Затухать
milkdrop-run-focused = Продолжать при фокусе
    .description = Визуализация продолжает двигаться, пока панель в фокусе, идёт воспроизведение или нет. Выключено: удержанный кадр остаётся неподвижным, даже если панель в фокусе
milkdrop-show-name = Показывать имя пресета
    .description = Показывать имя пресета в углу несколько секунд при смене
milkdrop-next = Следующий пресет
milkdrop-previous = Предыдущий пресет
milkdrop-random = Случайный пресет
milkdrop-open-folder = Открыть папку с пресетами
milkdrop-rescan = Пересканировать
milkdrop-rotation = Ротация
    .description = Какие пресеты перебирают «Далее», «Назад» и смена по таймеру
milkdrop-rotation-all = Все пресеты
milkdrop-empty = Пресеты не найдены.
    .description = Положи пак в папку ниже и нажми «Пересканировать». Вот три, которые стоит взять, все у projectM-visualizer на GitHub.
milkdrop-packs-hint = Складывай наборы пресетов сюда. Три стоящих: presets-cream-of-the-crop, presets-milkdrop-original и presets-milkdrop-texture-pack, все на GitHub у projectM-visualizer.
milkdrop-no-gl = Milkdrop не смог запуститься.
milkdrop-still-starting = Milkdrop всё ещё запускается.
milkdrop-still-starting-detail = Ожидание контекста OpenGL от графического драйвера.
milkdrop-no-frames = Milkdrop работает, но ни одного кадра не пришло.
milkdrop-no-frames-detail = Рендеринг на { $renderer }, { $version }. Подробности в консоли.
milkdrop-favorite = Пресет в избранное
milkdrop-favorite-short = В избранное
milkdrop-favorited = В избранном
milkdrop-favorites-only = Только избранное
milkdrop-rotation-favorites = Избранное ({ $count })
milkdrop-no-favorites = Пока ничего не отмечено, так что перемешивается вся библиотека. Отметьте пресет в списке, в меню панели или в строке «Сейчас показывается».
milkdrop-reveal = Показать пресет в папке
milkdrop-reveal-short = Показать
milkdrop-current = Сейчас показывается
milkdrop-no-preset = Пока ничего не загружено
milkdrop-color = Цвет
    .description = Пресет оставляет цвета файла. Тема переворачивает их в светлые на светлой теме. Палитра красит их в фон и акцент темы и не трогает цвет альбома. Обложка красит их в цвет играющей обложки, независимо от темы по треку
milkdrop-color-preset = Пресет
milkdrop-color-theme = Тема
milkdrop-color-palette = Палитра
milkdrop-color-cover = Обложка
milkdrop-name-always = Держать имя на экране
    .description = Держать имя на экране всё время, а не несколько секунд
milkdrop-flip-horizontal = Отразить по горизонтали
    .description = Зеркалит визуал слева направо
milkdrop-flip-vertical = Отразить по вертикали
    .description = Зеркалит визуал сверху вниз
milkdrop-choose = Выбрать пресет
milkdrop-picker-title = Выбрать пресет
milkdrop-picker-backdrop = Фон
milkdrop-picker-host = Выбор для { $host }
milkdrop-view-tree = Дерево
milkdrop-view-grid = Сетка
milkdrop-nested = По папкам
milkdrop-locate-current = К активному
milkdrop-load-preset = Загрузить пресет
milkdrop-unfavorite = Убрать из избранного
