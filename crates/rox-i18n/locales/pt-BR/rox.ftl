...
letter-rail-compact = Barra compacta
    .description = Limita a barra a uma única linha que rola em vez de quebrar
letter-rail-side = Posição da barra
    .description = Em qual borda da parede a barra fica
...
panel-run-when-idle = Executar quando ocioso
...
settings-search-scope = Buscar apenas na página aberta

## Embed dialog
bookmark-new-title = Novo marcador
bookmark-edit-title = Editar marcador
bookmark-window-title = rox - { $verb }
bookmark-name = Nome
bookmark-name-placeholder = Opcional, sem nome o horário aparece no lugar
bookmark-position = Em { $time }
bookmark-color = Cor
bookmark-color-accent = Destaque do tema
bookmark-color-custom = Personalizada...
bookmark-color-red = Vermelho
bookmark-color-orange = Laranja
bookmark-color-yellow = Amarelo
bookmark-color-green = Verde
bookmark-color-teal = Turquesa
bookmark-color-blue = Azul
bookmark-color-purple = Roxo
bookmark-color-pink = Rosa
bookmark-save = Salvar
bookmark-hint-before = Pressione
bookmark-hint-key = Enter
bookmark-hint-after = para salvar
bookmark-menu-play = Tocar a partir daqui
bookmark-menu-rename = Renomear...
bookmark-menu-color = Cor
bookmark-menu-move = Mover para a posição atual
bookmark-menu-remove = Remover
bookmark-menu-remove-many = Remover { $count } marcadores
bookmarks-title = Marcadores
bookmarks-empty = Nenhum marcador ainda. Pressione M enquanto uma faixa toca para criar um, ou Shift+M para dar um nome.
cue-menu-insert = Inserir ponto aqui
cue-menu-bookmark = Adicionar marcador aqui
cue-menu-remove = Remover ponto
position-bound-streaming = Indisponível durante a transmissão
...
panel-copy-filename = Copiar nome do arquivo
panel-copy-path = Copiar caminho
...
playback-item-ab-repeat = Repetir A-B
playback-item-favourite = Favorito
playback-item-rating = Avaliação
playback-sleep-15 = Parar depois de 15 minutos
playback-sleep-30 = Parar depois de 30 minutos
playback-sleep-60 = Parar depois de uma hora
playback-sleep-90 = Parar depois de 90 minutos
playback-sleep-off = Sem temporizador
playback-sleep-off-remaining = Cancelar o temporizador (faltam { $minutes } min)
playback-sleep-tip = Temporizador de sono
playback-sleep-tip-remaining = Temporizador, faltam { $minutes } min
menubar-button-tasks = Botão de tarefas
menubar-button-sleep = Botão do temporizador
menubar-button-rescan = Botão de reescanear

## Custom button states

button-state-playback = Playback
button-state-playback-playing = Playing
button-state-playback-paused = Paused
button-state-repeat = Repeat
button-state-repeat-off = Off
button-state-repeat-all = Queue
button-state-repeat-one = Track
button-state-shuffle = Shuffle Order
button-state-shuffle-random = Random
button-state-shuffle-similar = Similar
button-state-shuffling = Shuffle
button-state-shuffling-on = On
button-state-shuffling-off = Off
button-state-mute = Mute
button-state-mute-muted = Muted
button-state-mute-unmuted = Unmuted
button-state-stop-after = Stop After Track
button-state-stop-after-armed = Armed
button-state-stop-after-off = Off
button-state-ab-repeat = A-B Repeat
button-state-ab-repeat-off = No Marks
button-state-ab-repeat-a-set = A Marked
button-state-ab-repeat-looping = Repeating
button-state-continuation = Keep Playing
button-state-continuation-off = Off
button-state-continuation-continue = Down the List
button-state-continuation-weighted = Never Played First
button-state-stop = Stop
button-state-stop-active = Something Loaded
button-state-stop-idle = Nothing Loaded
button-state-crossfade = Crossfade
button-state-crossfade-off = Off
button-state-crossfade-on = On
button-state-crossfade-albums = Crossfade Within Albums
button-state-crossfade-albums-off = Off
button-state-crossfade-albums-on = On
button-state-sleep = Sleep Timer
button-state-sleep-armed = Armed
button-state-sleep-off = Off
button-state-eq = Equalizer
button-state-eq-on = On
button-state-eq-off = Off
button-state-exclusive-output = Exclusive Output
button-state-exclusive-output-on = On
button-state-exclusive-output-off = Off
button-state-replaygain = ReplayGain
button-state-replaygain-off = Off
button-state-replaygain-track = Track
button-state-replaygain-album = Album

button-state-theme = Theme
button-state-theme-dark = Dark
button-state-theme-light = Light
button-state-design-mode = Design Mode
button-state-design-mode-on = On
button-state-design-mode-off = Off
button-state-resize-lock = Panel Resize Lock
button-state-resize-lock-locked = Locked
button-state-resize-lock-unlocked = Unlocked
button-state-menubar = Menubar
button-state-menubar-shown = Shown
button-state-menubar-hidden = Hidden
button-state-decorations = OS Decorations
button-state-decorations-on = On
button-state-decorations-off = Off
button-state-art-theming = Song Theming
button-state-art-theming-on = On
button-state-art-theming-off = Off
button-state-quit-to-tray = Remain in Tray
button-state-quit-to-tray-on = On
button-state-quit-to-tray-off = Off
button-state-seams = Panel Seams
button-state-seams-on = On
button-state-seams-off = Off
button-state-readings = Reading Names
button-state-readings-on = On
button-state-readings-off = Off

## Custom controls panel

# The panel of user-built buttons: its name in the catalog and on its tab,
# and the placeholder a button with no command wears.
panel-catalog-custom-controls = Custom Controls
panel-title-custom-controls = Custom Controls
panel-controls-unconfigured = Not set up yet

## Custom button editor

# The panel's settings page: the button list, what each button does, the
# state it follows, and the look it wears in each case of that state.
button-editor-section-buttons = Buttons
button-editor-section-layout = Layout
    .description = The buttons on the strip, in order. Every button starts in the tray below, and dragging one back down takes it off the strip without deleting it.
button-editor-add = Add Button
button-editor-empty = No buttons yet. Add one and pick what it does.
button-editor-unnamed = No command
button-editor-action = Command
    .description = What a click on this button does.
button-editor-action-none = Choose a command
button-editor-action-search = Search commands
button-editor-action-empty = No matches
button-editor-state = Follows
    .description = The player state this button's icon, color and tooltip track.
button-editor-state-none = Nothing
button-editor-case-always = Always
button-editor-preview = Preview
button-editor-icon = Icon
button-editor-color = Color
button-editor-tip = Tooltip
button-editor-tip-placeholder = What the hover says
...
library-column-rename = Renomear...
library-column-rename-reset = Redefinir nome
library-column-rename-name = Cabeçalho
library-column-rename-note = Mostrado no lugar do cabeçalho embutido; vazio o traz de volta, e um único espaço deixa o cabeçalho em branco
library-sort-on-click = Ordenar ao clicar
    .description = Ordena clicando em qualquer ponto do cabeçalho em vez do ícone; reordenar uma coluna passa a exigir Alt e arrastar
library-group-search-results = Agrupar resultados da busca
    .description = Mantém os cabeçalhos de grupo atuais durante a busca; desative para mostrar as faixas encontradas em uma lista simples
...
library-line-height = Altura das linhas do cabeçalho
...
library-text-size = Tamanho do texto
    .description = O texto das linhas de cabeçalho, independente da altura delas, para que a capa cresça sozinha
...
stations-import-empty = Esse arquivo não tem nenhuma URL de fluxo
stations-not-a-stream = As estações tocam por http ou https; isso não é uma URL de fluxo
stations-empty-title = Nenhuma estação ainda
stations-empty = Busque uma no diretório, ou mantenha sua lista nas configurações.
stations-on-air = No ar
stations-clocks = Tempo nesta música e nesta estação
stations-homepage = Abrir o site

## Station directory

directory-window-title = Diretório de estações
directory-placeholder = Encontrar estações no radio-browser.info
directory-search = Buscar no diretório
directory-add = Adicionar
directory-add-play = Adicionar e reproduzir
directory-added = Já está nas suas estações
directory-searching = Buscando no radio-browser.info...
directory-none = Nada no radio-browser.info corresponde a "{ $text }"
directory-failed = O radio-browser.info não respondeu: { $reason }
directory-bitrate = { $kbps } kbps

## Album grid panel
panel-title-album-grid = Grade de álbuns
grid-menu-scroll = Rolagem
grid-menu-sort = Ordenação
grid-sort-artist = Artista
grid-sort-album = Álbum
grid-sort-year = Ano
grid-sort-added = Adicionados recentemente
grid-sort-plays = Mais tocados
grid-letter-rail = Barra de letras
    .description = As iniciais na borda da parede; um clique pula para o primeiro álbum da letra
...
settings-appearance-milkdrop-beat-sensitivity = Sensibilidade à batida
    .description = Com que facilidade o projectM conta algo como batida. Uma mixagem baixa pede mais do que uma alta
settings-appearance-milkdrop-color = Cor
    .description = Preset mantém as cores do arquivo. Tema as inverte para o claro no tema claro. Paleta as pinta com o fundo e o destaque do tema. Capa as pinta com a cor da capa que está tocando, com ou sem tema por música
settings-appearance-milkdrop-duration = Duração do preset
    .description = Quanto tempo um preset fica antes do próximo aparecer
settings-appearance-milkdrop-enabled = Fundo Milkdrop
    .description = Rodar uma visualização Milkdrop atrás do app inteiro enquanto a música toca
settings-appearance-milkdrop-error-title = O fundo Milkdrop não conseguiu iniciar
settings-appearance-milkdrop-fade-duration = Duração do fade
    .description = Quanto o fade dura, de saída ao pausar ou parar e de entrada ao tocar
settings-appearance-milkdrop-flip-horizontal = Inverter horizontalmente
    .description = Espelha o visual da esquerda para a direita
settings-appearance-milkdrop-flip-vertical = Inverter verticalmente
    .description = Espelha o visual de cima para baixo
settings-appearance-milkdrop-fps = Taxa de quadros
    .description = O que a thread de render busca. 30 corta pela metade o custo de ler cada quadro de volta, e um fundo desfocado raramente precisa de mais
settings-appearance-milkdrop-hard-cuts = Cortes secos
    .description = Deixar uma batida forte o bastante cortar direto para o próximo preset
settings-appearance-milkdrop-idle = Em repouso
    .description = O que o visual faz enquanto a reprodução está pausada ou parada. Segurar mantém o último quadro atrás do app. Fade leva ao fundo da capa e traz de volta ao tocar
settings-appearance-milkdrop-locked = Travar preset
    .description = Ficar no preset atual, entre faixas e reinícios
settings-appearance-milkdrop-preset = Preset
    .description = Qual preset o fundo mostra. Funciona sem nada tocando e volta depois de reiniciar
settings-appearance-milkdrop-rotation = Rotação
    .description = Quais presets Próximo, Anterior e a troca por tempo percorrem
settings-appearance-milkdrop-scale = Escala de renderização
    .description = Em que fração da resolução da janela a visualização é renderizada. Menos custa menos; um fundo tão suave raramente precisa de mais
settings-appearance-milkdrop-strength = Intensidade
    .description = Até onde a visualização chega por cima da capa desfocada
...
settings-appearance-section-milkdrop = Fundo Milkdrop
...
settings-application-prerelease-updates = Incluir versões candidatas
    .description = Oferecer também as versões candidatas, as prévias publicadas antes de uma versão para teste; uma build candidata vê a próxima de qualquer jeito
...
settings-application-menu-entry = Entrada no menu de aplicativos
    .description = Uma entrada de lançador e as associações de arquivo para este AppImage, sempre apontando para onde o arquivo estiver
...
settings-application-socket-path = Caminho do socket
    .description = A interface de máquina do rox enquanto ele roda: JSON-RPC sobre um socket local, atrelado a esta pasta de dados. O proxy rox-mcp atende clientes MCP por ela
...
settings-integrations-ffmpeg-binary = Binário do FFmpeg
    .description = Qual ffmpeg roda as conversões; deixe vazio para o que está no PATH ou para um build na pasta de dados do rox
...
settings-integrations-ffmpeg-missing-note-flatpak = Converter fica escondido. Coloque um build estático do ffmpeg na pasta de dados do rox; um instalado no sistema não roda dentro do sandbox.
...
settings-integrations-ffmpeg-reveal = Mostrar pasta de dados
...
settings-integrations-librefm-intro = Conecte sua conta do Libre.fm: autorize o rox no navegador e as faixas tocadas viram scrobbles lá assim que passam do limiar
settings-integrations-listenbrainz-get-token = Obter token
settings-integrations-listenbrainz-intro = Cole o token de usuário de listenbrainz.org/settings. As audições são enviadas assim que uma faixa passa do limiar de scrobble.
settings-integrations-listenbrainz-token-placeholder = Token
settings-integrations-listenbrainz-token-row = Token de usuário
...
settings-integrations-scrobble-connect = Conectar
settings-integrations-scrobble-disconnect = Desconectar
settings-integrations-scrobble-finish-connecting = Concluir a conexão
settings-integrations-scrobble-reconnect = Reconectar
settings-integrations-scrobble-status-checking = Verificando o token
settings-integrations-scrobble-status-confirming = Confirmando...
settings-integrations-scrobble-status-connected = Conectado como { $username }
settings-integrations-scrobble-status-failed = A conexão falhou: { $error }
settings-integrations-scrobble-status-invalid = O { $service } rejeitou esse token
settings-integrations-scrobble-status-not-connected = Não conectado
settings-integrations-scrobble-status-rejected = O { $service } rejeitou a sessão e ela foi descartada. Conecte de novo para continuar fazendo scrobble
settings-integrations-scrobble-status-requesting = Pedindo um token...
settings-integrations-scrobble-status-waiting = Autorize o rox no navegador, depois conclua a conexão
settings-integrations-scrobble-threshold = Limiar de scrobble
    .description = Quanto de uma faixa precisa tocar antes de virar scrobble, em todos os serviços conectados; a barra de posição e a forma de onda podem marcar isso
settings-integrations-scrobble-tracks = Fazer scrobble das faixas
    .description = Enviar as faixas tocadas para todos os serviços conectados assim que passarem do limiar
settings-integrations-scrobble-working = Trabalhando...
...
settings-integrations-subsonic-connect = Conectar
settings-integrations-subsonic-credentials = Acesso
    .description = A conta no servidor; a senha fica em accounts.json, nunca em settings.json
settings-integrations-subsonic-enable = Usar um servidor Subsonic
    .description = Lê uma biblioteca de um servidor Subsonic ou OpenSubsonic e toca a partir dela
settings-integrations-subsonic-password-placeholder = Senha
settings-integrations-subsonic-server = Servidor
    .description = O endereço do servidor com http:// ou https://, e sem /rest no final
settings-integrations-subsonic-status-failed = Não foi possível alcançar o servidor: { $error }
settings-integrations-subsonic-status-ok = Conectado a { $server }
settings-integrations-subsonic-sync-count = { $n ->
    [one] { $n } faixa, última sincronização em { $date }
   *[other] { $n } faixas, última sincronização em { $date }
}
settings-integrations-subsonic-sync-failed = A sincronização falhou: { $error }
settings-integrations-subsonic-sync-never = Nunca sincronizado
settings-integrations-subsonic-sync-now = Sincronizar agora
    .description = Pergunta ao servidor o que ele tem e alinha a biblioteca com isso; as faixas que ele não lista mais saem
settings-integrations-subsonic-syncing = Sincronizando o álbum { $done } de { $total }
settings-integrations-subsonic-url-placeholder = https://musica.example.com
settings-integrations-subsonic-user-placeholder = Usuário
...
settings-library-portal-hint = Troque /path/to pelo local real da pasta.
settings-library-portal-note = Funciona, mas é lento para uma biblioteca e o rox não consegue monitorar mudanças nela. Dê ao rox o local real da pasta, depois remova e adicione de novo:
settings-library-portal-title = O rox chega a esta pasta pelo portal de arquivos
...
settings-library-tempo-auto = Medir o andamento de arquivos novos
...
settings-library-tempo-refused = { $count ->
    [one] . O rox não conseguiu contar a batida de 1 faixa, então Analisar o que falta deixa ela de lado
   *[other] . O rox não conseguiu contar a batida de { $count } faixas, então Analisar o que falta deixa elas de lado
}
settings-library-tempo-retry = Tentar de novo as recusadas
settings-library-tempo-status-measured = Todas as { $total } faixas escaneadas têm andamento, e o rox descobriu { $measured } delas
settings-library-tempo-status-measured-some = { $covered } de { $total } faixas escaneadas têm andamento, e o rox descobriu { $measured } delas
settings-library-tempo-status-none = { $total ->
    [one] A única faixa escaneada não diz em que andamento toca. Analisar o que falta descobre
   *[other] Nenhuma das { $total } faixas escaneadas diz em que andamento toca. Analisar o que falta descobre
}
settings-library-tempo-status-partial = { $covered } de { $total } faixas escaneadas têm andamento, e o rox descobriu { $measured } delas. Analisar o que falta cuida das outras { $missing }
settings-library-tempo-status-tagged = Todas as { $total } faixas escaneadas têm uma tag de andamento
settings-library-tempo-status-tagged-some = { $covered } de { $total } faixas escaneadas têm uma tag de andamento
...
settings-show-readings = Mostrar leituras
    .description = Colocar a leitura romanizada depois de um nome escrito numa grafia que este alfabeto não sabe pronunciar: 秋ノ風 (Aki no kaze). A leitura é o nome de ordenação que o valor já carrega, então um nome sem ela não mostra nada e um nome latino nunca a recebe
...
settings-dictionary-download-failed = Não foi possível baixar o dicionário: { $reason }
settings-dictionary-downloading = Baixando o dicionário: { $done } de { $total }
settings-dictionary-heading = Romanização
settings-dictionary-stopping = Parando o download do dicionário...
...
settings-playback-live-buffer = Buffer do ao vivo
    .description = Quanto dá para voltar em uma estação. A conexão continua aberta enquanto a estação está pausada e segue enchendo o buffer, então ao tocar de novo continua de onde você parou em vez do ao vivo. Doze horas é o infinito prático: nada que você deixe tocando de uma vez chega a dar a volta nele.
settings-playback-live-buffer-memory = Cerca de { $low } a 128 kbps, { $high } a 320 kbps.
settings-playback-live-buffer-playing = Estação tocando: cerca de { $size }.
settings-playback-capture-album = Álbum das capturas
    .description = O que a tag de álbum de uma música salva diz. Em branco não grava álbum, porque uma música tirada do ar não tem lançamento e nomes de estação no campo de álbum poluem toda visão por álbum. %station% coloca a estação ali; uma palavra como Radio ou Singles as guarda numa prateleira própria. A estação e a URL do fluxo sempre vão no comentário.
settings-playback-capture-album-placeholder = Deixar em branco
settings-playback-capture-choose = Escolher pasta...
settings-playback-capture-enable = Salvar músicas de fontes em streaming
    .description = Grava na pasta de capturas cada música que um stream toca do início ao fim, no formato do próprio stream e sem recodificar nada, com as tags da estação. A capa da música fica ao lado com o mesmo nome, quando alguma é encontrada. Os limites entre as músicas vêm dos títulos que a estação anuncia, e eles chegam alguns segundos antes ou depois do áudio, então uma captura pode carregar o fim da música anterior. Uma música mais longa que o buffer ao vivo nunca é salva, então um podcast ou um mix continua no ar.
settings-playback-capture-folder = Pasta de capturas
settings-playback-capture-pattern = Nomes das capturas
    .description = Como uma música salva é nomeada dentro da pasta de capturas. Uma / cria uma pasta, então o padrão arquiva uma noite de rádio por estação em vez de empilhar tudo. A extensão vem do stream.
settings-playback-capture-pattern-date = %date% é o dia em que a música foi salva, como 2026-09-18.
settings-playback-capture-pattern-preview = Prévia: { $name }
settings-playback-capture-pattern-station = %station% é o nome da estação, e %album% diz a mesma coisa.
settings-playback-section-capture = Captura
...
settings-playback-section-radio = Rádio
...
settings-providers-acoustid = AcoustID
    .description = Tirar uma impressão digital do áudio e perguntar ao acoustid.org de qual gravação se trata; o botão de identificar da comparação de metadados acha o lançamento de um arquivo com tags erradas demais para buscar
settings-providers-acoustid-key = Chave do AcoustID
settings-providers-acoustid-key-hint = Opcional; esta build já traz uma chave própria
settings-providers-acoustid-key-placeholder = Chave do aplicativo
...
settings-shader-backdrop-run-idle = Executar enquanto ocioso
...
settings-shader-screen-run-idle = Executar enquanto ocioso
...
settings-sources-folders-note = As pastas que o rox varre ficam na página Biblioteca, ao lado das configurações de varredura e de tags que as leem.
settings-sources-folders-open = Página Biblioteca
settings-sources-section-folders = Pastas locais
settings-sources-section-stations = Estações de rádio
settings-sources-stations-find = Buscar estações...
settings-sources-stations-import = Importar estações...
settings-sources-stations-name-placeholder = Nome (opcional)
settings-sources-stations-none = Nenhuma estação ainda
settings-sources-stations-url-placeholder = URL do fluxo
...
settings-storage-looks-layouts = Visuais e layouts
    .description = O visual que o aplicativo está usando (workspace.json), com seus espaços de trabalho salvos e os arquivos de shader exportados ao lado. Pequeno, e cada byte dele é algo que você montou
...
menu-quick-play = Reprodução rápida
...
menu-tasks = Tarefas
menu-update-available = Atualização disponível
...
tasks-tempo-counted = { $count ->
    [one] A única faixa tem andamento
   *[other] { $count } faixas têm andamento
}
...
tasks-tempo-refused = { $count ->
    [one] O rox não conseguiu contar a batida de 1 faixa
   *[other] O rox não conseguiu contar a batida de { $count } faixas
}
tasks-timing = Medindo o andamento de { $progress }
tasks-filling = Preenchendo { $progress }
tasks-job-sortnames = Nomes de ordenação
tasks-sortnames-all = Todos os { $count } artistas têm nome de ordenação
tasks-sortnames-non-latin = , { $count } deles fora do alfabeto latino, { $estimate }
tasks-sortnames-nothing = Nada escaneado para consultar ainda
tasks-sortnames-partial = { $missing } de { $total } artistas não têm nome de ordenação
tasks-start-fill-missing = Preencher o que falta
tasks-job-romanize = Romanizar
tasks-reading-takes = , lê-los leva { $estimate }
tasks-romanize-all = { $count ->
    [one] O único título, álbum ou artista tem nome de ordenação
   *[other] Todos os { $count } títulos, álbuns e artistas têm nome de ordenação
}
tasks-romanize-nothing = Nada escaneado para ler ainda
tasks-romanize-partial = { $missing } de { $total } títulos, álbuns e artistas não têm nome de ordenação
tasks-romanizing = Lendo { $progress }
tasks-romanize-skipped = { $count } foram pulados por falta do dicionário japonês
tasks-romanize-skipping = { $kanji } deles são kanji e precisam do dicionário japonês em Configurações > Biblioteca
...
## Stats window
stats-bars-daily = Barras diárias, clique em uma para abri-la
stats-bars-days = Barras de { $days } dias, clique em uma para abri-las
stats-bars-hourly = Barras por hora, a visão mais próxima
stats-bars-hours = Barras de { $hours } horas, clique em uma para abrir o dia
stats-bars-weekly = Barras semanais, clique em uma para abri-la
stats-bucket-listens = { $count ->
    [one] { $count } audição, { $ago } ({ $date })
   *[other] { $count } audições, { $ago } ({ $date })
}
stats-chart-end-day = Meia-noite
...
health-caption-duplicates = { $groups } em { $tracks }
health-caption-formats = { $unwritable } de { $total }
health-caption-gaps = { $albums } de { $total }
health-caption-missing = { $missing } faltando de { $total }
health-caption-sort = Artistas do álbum { $album_artists }, álbuns { $albums }, títulos { $titles }
health-caption-split = { $tagged } com tag, { $measured } medidos, { $missing } faltando
health-caption-split-refused = { $tagged } com tag, { $measured } medidos, { $missing } faltando, { $refused } sem batida
health-checks-menu = Tags contadas
    .description = Quais das cinco tags principais a leitura conta; a lista ao passar o mouse sempre mostra todas
health-click-opens = O clique abre a saúde da biblioteca
health-click-section = Clique
health-complete = Não falta nada
health-count-groups = { $count ->
    [one] { $count } grupo
   *[other] { $count } grupos
}
health-desc-acoustic = Faixas sem impressão acústica, então não dá para achar nada parecido com elas.
health-desc-art = Álbuns sem capa, nem embutida nos arquivos nem ao lado deles como imagem.
health-desc-duplicates = Grupos de faixas com o mesmo artista, o mesmo título e duração parecida.
health-desc-gaps = Álbuns cuja numeração pula um número, ou em que alguma faixa não tem número nenhum.
health-desc-genre = Faixas cujos arquivos não trazem gênero.
health-desc-rating = Faixas que você ainda não avaliou.
...
health-fix-duplicates = Abrir duplicatas
health-fix-genres = Marcar gêneros
health-fix-measure = Medir o que falta
health-fix-fill = Preencher o que falta
health-measuring-art = Analisando capas de álbum, { $done } de { $total }
health-measuring-duplicates = Comparando duplicatas
health-measuring-formats = Lendo formatos de arquivo
health-measuring-gaps = Verificando números de faixa
health-open = Abrir a saúde da biblioteca
health-open-on-click = Abrir a saúde da biblioteca ao clicar
    .description = Clicar no widget para abrir a janela de saúde da biblioteca, onde a cobertura é detalhada
health-overview-complete = { $complete } de { $total } totalmente com tag
health-overview-missing = { $missing } faltando
health-readout-section = Leitura
health-running = Em execução
health-section-audio = Áudio
health-section-files = Arquivos e estrutura
health-section-overview = Visão geral
health-section-tags = Tags
health-show-percent = Mostrar a porcentagem
    .description = Desenhar a cobertura ao lado do ícone; desligado, fica só o ícone e as contagens vêm ao passar o mouse
health-tile-acoustic = Vetores acústicos
health-tile-album = Álbum
health-tile-art = Capa do álbum
health-tile-artist = Artista
health-tile-duplicates = Duplicatas
health-tile-gaps = Lacunas nos álbuns
health-tile-genre = Gênero
health-tile-rating = Avaliação
health-tile-replaygain = ReplayGain
health-tile-sort-names = Nomes de ordenação
health-tile-tempo = Andamento
health-tile-writable = Sem suporte
health-tile-year = Ano
health-tile-title = Título
health-tooltip-missing = Tags faltando
health-waiting = Aguardando
health-widget-title = Widget de saúde
health-window-title = rox - Saúde da biblioteca

## Power search window

search-seed-caption = { $source }: { $count }
search-window-title = rox - Busca avançada
...
welcome-menu-add = Adicionar ao menu de aplicativos
welcome-menu-failed = Não foi possível adicionar a entrada no menu
welcome-menu-not-now = Agora não
welcome-menu-note = Um AppImage não se registra sozinho. Isto adiciona uma entrada de lançador e as associações de arquivos de áudio; nada fora da sua pasta pessoal muda.
welcome-menu-title = Adicionar o rox ao menu de aplicativos?
...
eq-autoeq = AutoEq
autoeq-window-title = AutoEq
autoeq-placeholder = Buscar fones de ouvido ou intra-auriculares (ex: HD 600, AirPods, Zero)...
autoeq-search = Buscar no AutoEq
autoeq-searching = Buscando no AutoEq...
autoeq-loading = Carregando banco de dados do AutoEq...
autoeq-none = Nenhum perfil de fone corresponde a "{ $text }"
autoeq-failed = Erro do AutoEq: { $reason }
autoeq-apply = Aplicar
autoeq-applied = Aplicado
autoeq-import-file = Importar arquivo de predefinição
eq-flatten = Aplanar
eq-freq-label = Freq
eq-gain-label = Ganho
...
keymap-mod-win = Win
keymap-new-window = Nova janela
    .description = Abrir outra janela de trabalho com o layout salvo
keymap-next-track = Próxima faixa
    .description = Pular para a próxima faixa da fila
keymap-open-about = Sobre
    .description = Mostrar a versão e os créditos
keymap-report-issue = Report an Issue
    .description = Open the issue form on the project's tracker
keymap-open-discussions = Discussions
    .description = Open the project's discussions board
keymap-open-chat = Chat
    .description = Open the project's chat channel
keymap-open-console = Console
    .description = Abrir o console de log
keymap-open-equalizer = Equalizador
    .description = Abrir a janela do equalizador
keymap-open-preset-picker = Presets do fundo
    .description = Abrir o seletor de presets do Milkdrop para o fundo
...
keymap-open-panel-settings = Configurações do painel
    .description = Abre a janela de configurações do painel em foco
keymap-open-health = Saúde da biblioteca
    .description = Abrir a janela de saúde da biblioteca, onde a cobertura de tags e os problemas estruturais são contados
keymap-open-power-search = Busca avançada
    .description = Abre uma janela de busca com a própria consulta, para que buscar aqui não mexa no espaço de trabalho
keymap-open-stats = Abrir estatísticas
    .description = Abrir a janela de estatísticas de audição
keymap-open-tasks = Tarefas
    .description = Mostrar no que o rox está trabalhando em segundo plano
keymap-open-welcome = Boas-vindas
    .description = Reabrir a janela de boas-vindas
keymap-play-random = Tocar aleatória
    .description = Sortear uma faixa da biblioteca e tocá-la
keymap-play-similar = Play Similar
    .description = Draw a track that sounds like the one playing. Needs the library described first
keymap-previous-track = Faixa anterior
    .description = Voltar para a faixa anterior
keymap-quit = Sair
...
keymap-ab-repeat = Repetir A-B
    .description = Marque A, depois B, depois limpe
keymap-ab-clear = Clear A-B Section
    .description = Drop the A-B section and any half-marked step with it
keymap-bookmark = Adicionar marcador
    .description = Criar um marcador na posição atual
keymap-bookmark-named = Adicionar marcador com nome
    .description = Criar um marcador na posição atual e dar um nome
keymap-prev-bookmark = Marcador anterior
    .description = Voltar ao marcador antes da posição atual
keymap-next-bookmark = Próximo marcador
    .description = Avançar ao próximo marcador
keymap-cue = Adicionar ponto
    .description = Colocar um ponto de sessão na posição que toca. Os pontos duram até o rox fechar
keymap-cue-prev = Ponto anterior
    .description = Voltar ao ponto antes do cursor
keymap-cue-next = Próximo ponto
    .description = Avançar ao próximo ponto
keymap-stop-playback = Parar
    .description = Parar a reprodução e liberar a faixa
...
keymap-type-ahead-next = Próxima correspondência
    .description = Ir para a próxima linha que corresponde ao que foi digitado
keymap-type-ahead-prev = Correspondência anterior
    .description = Voltar para a correspondência anterior do que foi digitado
keymap-next-tab = Próxima aba
    .description = Mostra a próxima aba do grupo de painéis em foco
keymap-prev-tab = Aba anterior
    .description = Mostra a aba anterior do grupo de painéis em foco
keymap-toggle-mute = Mudo
    .description = Silencia a saída sem perder o nível. Pressione de novo para trazê-la de volta
keymap-toggle-shuffle = Alternar embaralhar
    .description = Liga ou desliga o embaralhamento da fila
keymap-cycle-shuffle-mode = Cycle Shuffle Order
    .description = Step the order shuffle sorts by, random or nearest by sound
keymap-cycle-loop = Alternar repetição
    .description = Passa a repetição de desligada para todas, para uma e volta ao início
keymap-toggle-stop-after = Parar depois
    .description = Deixa a faixa atual terminar e depois pausa. Pressione de novo para desarmar
keymap-toggle-continuation = Toggle Continuation
    .description = Turn continuation off, or back on in whatever strategy it was last using
keymap-sleep-off = Cancel Sleep Timer
    .description = Cancel a running sleep timer, leaving playback alone
keymap-clear-queue = Clear Queue
...
keymap-volume-down = Diminuir volume
    .description = Diminui o volume em um passo
keymap-toggle-crossfade = Toggle Crossfade
    .description = Turn the crossfade off, or back on at the last length it ran at
keymap-toggle-crossfade-albums = Toggle Crossfade Within Albums
    .description = Flip whether the fade takes album-contiguous track boundaries too
keymap-cycle-replaygain-mode = Cycle ReplayGain Mode
    .description = Step the levelling rule the engine reads: off, track, album
keymap-toggle-exclusive-output = Toggle Exclusive Output
    .description = Claim the output device for rox alone, or give it back. Rebuilds the running session
keymap-toggle-eq = Toggle Equalizer
    .description = Flip whether the equalizer shapes the output
keymap-flatten-eq = Flatten Equalizer
    .description = Put every equalizer band back to 0 dB
keymap-close-panel = Fechar painel
    .description = Fecha o painel ativo do grupo de painéis em foco
keymap-new-empty-window = Janela vazia
    .description = Abre uma janela de espaço de trabalho sem nada dentro
keymap-open-signals = Sinais
    .description = Abre a janela de sinais, o conjunto por trás das rotas de cada painel
keymap-import-workspace = Importar espaço de trabalho
    .description = Escolhe um arquivo de espaço de trabalho e o adiciona à coleção
keymap-save-layout = Save Layout
    .description = Name and save the current panel arrangement as a layout preset
keymap-save-workspace = Save Workspace
    .description = Name and save the current look as a workspace bundle
keymap-toggle-quit-to-tray = Alternar continuar na bandeja
    .description = Alterna se fechar a última janela mantém o rox rodando na bandeja
keymap-toggle-design-mode = Alternar modo de design
    .description = Alterna se os painéis podem ser reorganizados no lugar
keymap-toggle-theme = Alternar claro / escuro
    .description = Muda para o outro lado da paleta. Vale em todo lugar, já que todas as janelas compartilham o tema
keymap-toggle-resize-lock = Alternar travar o redimensionamento dos painéis
    .description = Alterna se o redimensionamento dos painéis fica reservado ao modo de design
keymap-toggle-menubar = Alternar ocultar a barra de menus
    .description = Mostra a barra de menus da janela, ou a oculta até que Alt seja segurado
keymap-toggle-decorations = Alternar decorações do sistema
    .description = Alterna as janelas do espaço de trabalho entre a moldura do sistema e a própria do rox
keymap-toggle-art-theming = Alternar tema da música
    .description = Alterna se a capa da faixa atual tinge a paleta
keymap-toggle-seams = Toggle Panel Seams
    .description = Show or hide the dividers between panels
keymap-toggle-readings = Toggle Reading Names
    .description = Flip whether names show their reading rather than the tagged spelling
keymap-toggle-mini = Toggle Mini Layout
    .description = Swap between the mini layout and the primary one
keymap-rescan-library = Reescanear a biblioteca
    .description = Escanear de novo todas as pastas lembradas da biblioteca
keymap-abort-scan = Stop Scan
    .description = Stop a running library scan at the next file. What it already indexed stays
keymap-measure-replaygain = Medir ReplayGain
    .description = Abrir o diálogo que mede o volume das faixas que não o trazem
keymap-analyze-tempo = Analisar o andamento
    .description = Abrir o diálogo que escuta a batida das faixas sem BPM
keymap-build-acoustic = Criar vetores acústicos
    .description = Abrir o diálogo que constrói os vetores que a busca acústica lê
keymap-fill-sort-names = Preencher os nomes de ordenação
    .description = Abrir o diálogo que pede ao MusicBrainz os nomes de ordenação que faltam nos arquivos
keymap-romanize-library = Romanizar a biblioteca
    .description = Abrir o diálogo que lê em letras latinas os títulos, álbuns e artistas que não estão
keymap-find-duplicates = Localizar duplicatas
    .description = Abrir o localizador de duplicatas sobre a biblioteca
keymap-tag-genres = Marcar gêneros
    .description = Abrir o marcador de gêneros sobre as faixas sem gênero
...
panel-catalog-health-widget = Widget de saúde
...
panel-catalog-bookmarks = Marcadores
...
tags-editor-additional-tags = Tags adicionais ({ $count })
tags-editor-remove = remover
tags-editor-replace = substituir
tags-editor-replace-apply = Aplicar
tags-editor-replace-find = Localizar
tags-editor-replace-help = Cada ocorrência é reescrita. Com regex, $1 insere o primeiro grupo. Os resultados são aparados nas bordas.
tags-editor-replace-ignore-case = Ignorar maiúsculas
tags-editor-replace-match-count = { $hits } de { $total } com alteração
tags-editor-replace-regex = Regex
tags-editor-replace-with = Substituir
...
tags-editor-sort-names = Nomes de ordenação
tags-editor-table-view = Tabela
tags-editor-tag-columns = Tags adicionais
tags-editor-tag-field-conflict = o campo { $field } grava esta tag
tags-editor-tag-key-placeholder = Nome da tag
...
tags-matcher-identify = Identificar pelo som
tags-matcher-identify-no-duration = Sem duração da faixa para identificar
...
convert-dialog-choose-folder = Escolha uma pasta de destino
...
convert-dialog-pick-folder = Selecione uma pasta de destino
...
tag-genres-empty = Toda faixa tem gênero. Toque algo para marcar de novo.
tag-genres-heading = Marcar gêneros
tag-genres-input-placeholder = Digite um gênero
tag-genres-keys-hint = 1-8 escolhem uma linha, Shift+1-8 a adicionam à caixa, Ctrl+1-8 aplicam ao álbum inteiro, Enter aplica o que você digitou, L consulta o Last.fm, S pula, Ctrl+Z desfaz
tag-genres-library-loading = A biblioteca ainda está carregando; tente de novo daqui a pouco.
tag-genres-no-file = A biblioteca não tem nenhum arquivo para esta faixa.
tag-genres-no-suggestions = Nada a sugerir; digite um gênero.
tag-genres-progress = { $at } de { $total } sem gênero
tag-genres-skip = Pular
tag-genres-thinking = Lendo a vizinhança...
tag-genres-undo = Desfazer
tag-genres-unwritable = Esta faixa vive dentro de uma imagem cue compartilhada, então o gênero dela não pode ser escrito. Pule.
tag-genres-window-title = rox - Marcar gêneros
tag-genres-looking-up = Consultando o Last.fm...
tag-genres-lookup = Procurar no Last.fm
tag-genres-auto-lookup = Automaticamente
tag-genres-lookup-found = O Last.fm marca { $artist } como: { $tags }
tag-genres-lookup-none = O Last.fm não tem tags para { $artist }.
tag-genres-lookup-off = A busca de artistas online está desligada nas Configurações.
tag-genres-why-acoustic = { $count ->
    [one] { $count } faixa com som parecido
   *[other] { $count } faixas com som parecido
}
tag-genres-why-album = { $count ->
    [one] { $count } faixa neste álbum
   *[other] { $count } faixas neste álbum
}
tag-genres-why-artist = { $count ->
    [one] { $count } faixa deste artista
   *[other] { $count } faixas deste artista
}
tag-genres-why-lookup = Last.fm
tag-genres-album-too = { $count ->
    [one] Marcar o álbum inteiro da faixa e sua { $count } vizinha
   *[other] Marcar o álbum inteiro da faixa e suas { $count } vizinhas
}
tag-genres-apply = Aplicar
tag-genres-begin = Iniciar fila
tag-genres-col-genre = Gênero
tag-genres-col-match = Afinidade
tag-genres-col-why = Por quê
tag-genres-current-genre = Gênero: { $genre }
tag-genres-idle = Nada está tocando. Inicie a fila para percorrer as faixas sem gênero, ou toque algo para marcar de novo.
tag-genres-no-genre = Ainda sem gênero
tag-genres-stop = Parar fila
tag-genres-untagged-count = { $count ->
    [one] { $count } faixa sem gênero
   *[other] { $count } faixas sem gênero
}
tag-genres-write-error = { $name }: { $error }
tag-genres-writing = Gravando { $done } de { $total }...
...
lyrics-look-again = Buscar de novo
lyrics-mark-dots = Pontos
lyrics-mark-note = Nota
lyrics-marked-notice = Marcada sem letra
...
pass-tempo-retry-title = { $count ->
   ...
   *[other] Ouvir de novo { $count } faixas recusadas?
}
...
pass-fill = Preencher
pass-sortnames-body = Cada artista é consultado no MusicBrainz para a grafia latina sob a qual ele é ordenado, para que 米津玄師 caia no Y. O serviço permite uma requisição por segundo, e é isso que dita o ritmo. As respostas vão para o banco de dados da biblioteca; seus arquivos nunca são tocados.
pass-sortnames-scope-all = Consultar também os nomes que já são ordenados em alfabeto latino
pass-romanize = Romanizar
pass-romanize-body = Todo título, álbum e artista que ainda não tem nome de ordenação é lido em letras latinas, para que レモン seja encontrado digitando "lemon". Coreano e chinês não precisam de mais nada. Os kanji japoneses precisam do dicionário em Configurações > Biblioteca, e o IPADIC erra nomes com frequência suficiente para que o editor de tags esteja ali para corrigir. As respostas vão para o banco de dados da biblioteca; seus arquivos nunca são tocados.
pass-romanize-title = { $count ->
    [one] Ler 1 nome em letras latinas?
   *[other] Ler { $count } nomes em letras latinas?
}
pass-romanize-skips-kanji = { $kanji } de { $total } valores são kanji e serão pulados até o dicionário japonês ser instalado. Pegue-o em Configurações > Biblioteca.
pass-sortnames-title = { $count ->
    [one] Consultar 1 artista?
   *[other] Consultar { $count } artistas?
}
...
quick-play-syntax-absent = Linhas sem valor nenhum
    .example = -year
quick-play-syntax-exclude = Tudo menos as correspondências
    .example = -genre:rock
quick-play-syntax-field = Fixa um campo; use aspas em valores com espaços
    .example = artist:"Daft Punk"
quick-play-syntax-free = Casa com o título, o artista, o artista do álbum, o álbum ou o gênero
    .example = daft punk
quick-play-syntax-numeric = Compara um número; plays:0 e added:<90d funcionam igual
    .example = rating:>=4
quick-play-syntax-title = Sintaxe de busca
quick-play-syntax-year = São dígitos, então um prefixo pega a década inteira
    .example = year:199
...
waveform-loudness = Faixa de volume
    .description = Desenhar o nível RMS como uma faixa mais plana dentro da envoltória de picos
waveform-gradient-mode = Origem da cor
    .description = De onde a envoltória e a faixa tiram suas cores: o destaque, o gradiente do tema, a capa, ou um par personalizado
waveform-scrobble-marker = Marca de scrobble
    .description = Uma linha fina onde a faixa conta como scrobble no Last.fm
waveform-bookmarks = Marcadores
    .description = Os marcadores da faixa atual como setas na borda inferior: clique para pular, clique direito para editar
...
waveform-live-mode = Forma ao vivo
    .description = O que a faixa desenha enquanto uma estação de rádio toca: nada, o som da própria estação, ou uma forma que ela mesma desenha
waveform-live-trace = Traço
waveform-live-motion = Movimento
waveform-live-window = Janela ao vivo
    .description = Segundos de uma estação de rádio que o traço rolante abrange; uma janela maior rola em velocidade menor
waveform-live-expression = Expressão de movimento
    .description = x vai de 0 a 1 ao longo da faixa, t são os segundos do relógio do painel; sin cos tan abs sqrt exp ln floor min max clamp mix, com + - * / ^ pi e parênteses
waveform-live-expression-error = { $reason }, então a faixa desenha a forma padrão
waveform-section-live = Ao vivo
...
oscilloscope-channels-overlay = Sobreposto
...
shader-editor-target-screen = Shader da tela
shader-editor-target-backdrop = Shader de fundo
shader-editor-origin-pool = Um shader do workspace: aplicar alcança cada superfície que o usa
shader-editor-origin-pool-file = Um shader do workspace, com a cópia de trabalho em { $path }
shader-editor-origin-file = Vinculado a { $path }, que também é gravado ao aplicar
shader-editor-origin-inline = O código próprio desta superfície
shader-editor-apply = Aplicar
shader-editor-revert = Reverter
shader-editor-close = Fechar
shader-editor-hint-press = Pressione
shader-editor-hint-apply = para aplicar
shader-editor-status-unchecked = Nada para verificar ainda
shader-editor-status-ok = Compila
shader-editor-status-error = Este shader não compilou:
shader-editor-section-uniforms = Uniforms
shader-editor-section-textures = Texturas
shader-editor-section-slots = Slots
shader-editor-section-signals = Sinais
shader-editor-slot-unnamed = Slot { $n }
shader-editor-signals-empty = O pool ainda não tem sinais. Adicione alguns na janela Sinais e eles aparecem aqui com medidores ao vivo.
shader-editor-uniform-time = Segundos que o shader está rodando, congelado enquanto o feed estiver
shader-editor-uniform-delta = Segundos desde o último quadro, 0 no primeiro
shader-editor-uniform-resolution = A superfície em pixels do dispositivo
shader-editor-uniform-mouse = xy o cursor em pixels do dispositivo, z e w os botões
shader-editor-uniform-meta-0 = x volume, y posição na faixa, z tocando, w duração da faixa em segundos
shader-editor-uniform-meta-1 = x brilho da página, y tema claro, z presença do cursor, w forma do conteúdo
shader-editor-texture-screen = O que está sob a superfície neste quadro
shader-editor-texture-prev = O último quadro desta superfície, para rastros
...
metadata-cover-opacity = Opacidade da capa
    .description = O quanto a capa aparece atrás dos campos
...
metadata-field-album-artist-sort = Ordenação de artista do álbum
metadata-field-album-sort = Ordenação de álbum
metadata-field-artist-sort = Ordenação de artista
metadata-field-bit-depth = Profundidade de bits
metadata-field-bitrate = Bitrate
metadata-field-bookmarks = Marcadores
metadata-field-bpm-measured = { $bpm } (medido pelo rox)
metadata-field-codec = Codec
metadata-field-comment = Comentário
metadata-field-copies = Cópias
metadata-field-cover = Capa
metadata-field-source = Origem
...
metadata-field-first-played = Primeira reprodução
metadata-field-folder = Pasta
metadata-field-gain-album = Ganho do álbum
metadata-field-gain-track = Ganho da faixa
metadata-field-last-played = Última reprodução
metadata-field-lastfm-listeners = Ouvintes globais
metadata-field-lastfm-loved = Favorita no Last.fm
metadata-field-lastfm-plays = Reproduções globais
metadata-field-lastfm-tags = Tags do Last.fm
metadata-field-lastfm-user-plays = Seus scrobbles
metadata-field-lyrics = Letra
metadata-field-mb-country = País de lançamento
metadata-field-mb-date = Lançado
metadata-field-mb-first-release = Primeiro lançamento
metadata-field-mb-isrc = ISRC
metadata-field-mb-label = Gravadora
metadata-field-missing = Faltando
metadata-field-rank = Posição na biblioteca
metadata-field-recent-plays = Reproduções (30 dias)
metadata-field-sample-rate = Taxa de amostragem
metadata-field-similar = Faixas parecidas
metadata-field-size = Tamanho
metadata-field-title-sort = Ordenação de título
metadata-field-track = Faixa
metadata-fields = Campos
    .description = Quais campos a ficha lista; um campo sem valor mostra n/d, e um nome de ordenação só aparece onde difere
metadata-find-online = Encontrar metadados online...
metadata-no-library = Sem biblioteca
metadata-romanize = Romanizar
metadata-romanize-needs-dictionary = Um nome em kanji precisa do dicionário japonês. Pegue-o em Configurações > Biblioteca.
metadata-romanize-sort-names = Romanizar os nomes de ordenação
metadata-row-borders-description = O fio de cabelo abaixo de cada linha da tabela
metadata-cover-embedded = Embutida, { $px }
metadata-cover-folder = { $file }, { $px }
metadata-hide-empty = Ocultar campos vazios
    .description = Omitir um campo ligado sem valor em vez de listá-lo como n/d
metadata-loved-no = Não
metadata-loved-yes = Sim
metadata-lyrics-plain = Só texto
metadata-lyrics-synced = Sincronizada
metadata-missing-none = Nada
metadata-rank-value = nº { $rank }
metadata-tags-scope-album = (tags do álbum)
metadata-tags-scope-artist = (tags do artista)
metadata-track-of = { $track } de { $total }
metadata-value-none = n/d
...
history-live-plays-file = Toca a sua própria cópia desta música
history-live-plays-station = Toca a estação; a sua biblioteca não tem esta música
...
folder-tree-collapse-branch = Recolher ramo
...
folder-tree-expand-branch = Expandir ramo
...
art-label-position = Posição do rótulo
    .description = Onde fica a legenda do álbum: no topo, sob a capa, na borda inferior ou oculta
art-letter-rail = Barra de letras
    .description = As iniciais dos artistas na borda da estante; um clique pula para o primeiro álbum da letra
art-layout-section = Layout
art-perspective = Perspectiva
    .description = Girar as capas laterais no ângulo abaixo; desligado elas ficam planas e quadradas, o único modo em que o arredondamento das capas vale
art-recede = Luz da profundidade
    .description = O quanto a capa mais ao fundo fica iluminada; as capas entre ela e o centro dividem a distância por igual
art-spacing = Espaçamento das capas
    .description = A que distância da capa central fica a primeira de cada lado; passando da metade ela libera a capa central e deixa espaço
art-stride = Espaçamento da pilha
    .description = A distância entre as capas atrás da primeira; também define o quanto um arraste percorre por capa
art-visible = Capas visíveis
    .description = Quantas capas ficam de cada lado da central; a última some ao sair
art-tilt = Ângulo de giro
    .description = Quanto as capas laterais giram se afastando de você
...
playlists-export-tooltip = Exportar playlist
...
playlists-import = Importar playlist...
...
## Biography panel
biography-active-between = Ativo de { $from } a { $to }
biography-active-since = Ativo desde { $from }
biography-background = Fundo
    .description = A fanart do artista atrás do texto, escurecida e esmaecendo em direção à base
biography-background-opacity = Opacidade do fundo
    .description = O quanto a fanart aparece atrás do texto
biography-cycle = Alternar imagens do cabeçalho
    .description = Percorrer o banner e a fanart do artista no cabeçalho com uma transição suave, e passar de uma para outra à mão com as setas que aparecem ao passar o mouse
biography-cycle-interval = Intervalo de alternância
    .description = Quanto tempo cada imagem do cabeçalho fica antes de a próxima surgir
...
biography-flag = Bandeira do país
    .description = Mostrar o país como bandeira em vez do código de duas letras
biography-from-lastfm = Do Last.fm
biography-header-banner = Banner
    .description = A faixa larga com o logo que o TheAudioDB guarda do artista, no cabeçalho
biography-header-blur = Ajustar com fundo desfocado
    .description = Com as proporções desligadas, encaixar a imagem inteira na faixa sobre uma versão desfocada dela mesma em vez de cortá-la
biography-header-fanart = Fanart
    .description = As fanarts 16:9 do artista do TheAudioDB, no cabeçalho
biography-header-height = Altura do cabeçalho
    .description = A altura da faixa do cabeçalho em px, e o teto para uma mantida nas próprias proporções
...
biography-header-overlay = Título sobre o cabeçalho
    .description = Colocar o nome, a origem e os anos sobre a base da imagem do cabeçalho em vez de abaixo dela
...
biography-name-source = Nome de
    .description = Qual tag nomeia o artista: o artista da faixa, ou o artista do álbum numa coletânea ou num disco cheio de convidados
...
biography-profile = Origem e anos
    .description = O código do país e os anos em atividade, do TheAudioDB
biography-refresh = Atualizar
biography-seconds = { $count } s
biography-similar-artists = Artistas similares
    .description = Artistas relacionados pelos dados de audição, como chips: um clique abre a ficha deles, e uma lupa nos que a biblioteca tem os seleciona na busca
...
biography-top-tracks = Faixas mais tocadas
    .description = As faixas mais reproduzidas no Last.fm, um clique toca as que a biblioteca tem e o mais as coloca na fila
biography-top-tracks-count = Número de faixas
    .description = Quantas das faixas mais tocadas listar
biography-top-tracks-heading = Faixas mais tocadas
...
## Track columns
columns-album-artist-sort = Ordenação de artista do álbum
columns-album-sort = Ordenação de álbum
columns-artist-sort = Ordenação de artista
columns-bits = Bits
columns-bpm = BPM
columns-codec = Codec
columns-cover = Capa
...
columns-title-sort = Ordenação de título
...
filter-over-cap = { $count } a mais, busque para refinar
...
playback-ab-clear = Limpar A-B
playback-ab-set-a = Marcar A
playback-ab-set-b = Marcar B
playback-ab-tip-a = A em { $a }. Aperte de novo para marcar B
playback-ab-tip-looping = Repetindo de { $a } a { $b }
playback-ab-tip-off = Marque o início do trecho que você quer repetir
...
playback-menu-ab-repeat = Botão repetir A-B
...
track-info-output-resample-exclusive-stream = Esta transmissão é de { $source } kHz e a placa aceitou { $device } kHz, então cada amostra está sendo convertida na saída. O dispositivo não quis rodar na taxa da própria transmissão.
track-info-output-resample-mixer-stream = Esta transmissão é de { $source } kHz e o mixer está rodando a { $device } kHz, então cada amostra está sendo convertida na saída. O modo exclusivo entregaria à placa a taxa da própria transmissão.
...
seek-scrobble-marker = Marca de scrobble
    .description = Uma linha fina onde a faixa conta como scrobble no Last.fm
seek-bookmarks = Marcadores
    .description = Os marcadores da faixa atual como setas sob a linha: clique para pular, clique direito para editar
seek-show-timings = Mostrar os tempos
seek-dash-length = Tamanho do traço
    .description = O tamanho de cada traço da entrada, com um vão do mesmo tamanho depois dele
seek-lead-in = Entrada do buffer
    .description = Como é desenhada a parte do buffer da estação que ainda não encheu, o trecho à esquerda da fita
seek-lead-in-dashed = Tracejada
seek-lead-in-faint = Fraca
seek-lead-in-hidden = Oculta
seek-lead-in-sweep = Varredura da entrada
    .description = Um degradê que percorre a parte que ainda não encheu, como em uma barra de carregamento
seek-section-live = Ao vivo
...
dictionary-summary-lindera-ipadic = O dicionário japonês por trás das leituras dos kanji. Sem ele, kana e hangul continuam sendo romanizados e o chinês continua sendo lido como pinyin, mas um título em kanji é pulado
...
panel-title-milkdrop = Milkdrop
milkdrop-presets = Presets
milkdrop-tuning = Ajustes
milkdrop-roots = Pastas de presets
milkdrop-add-root = Adicionar pasta
milkdrop-remove-root = Remover
milkdrop-folder = Onde o rox procura
milkdrop-filter-presets = Filtrar presets
milkdrop-preset-count = { $count } de { $total } presets
milkdrop-locked = Travar o preset
    .description = Ficar neste: sem troca por tempo, sem corte na batida
milkdrop-duration = Duração do preset
    .description = Quanto tempo um preset segura antes do próximo entrar
milkdrop-beat-sensitivity = Sensibilidade à batida
    .description = Com que facilidade o projectM conta algo como batida. Uma mixagem baixa pede mais do que uma alta
milkdrop-hard-cuts = Cortes secos
    .description = Deixar uma batida forte o bastante cortar direto para o próximo preset
milkdrop-fps = Taxa de quadros
    .description = O que a thread de render busca. 30 corta pela metade o custo de ler cada quadro de volta
milkdrop-scale = Escala de render
    .description = Renderizar abaixo do tamanho do painel e ampliar. Custa nitidez e economiza a mesma fração da leitura
milkdrop-tint = Cor do álbum
    .description = Gira os tons do visual na direção da capa da faixa que está tocando. Zero deixa as cores do preset como estão
milkdrop-fade-duration = Duração do fade
milkdrop-idle = Em repouso
    .description = O que o visual faz enquanto a reprodução está pausada ou parada. Segurar mantém o último quadro na tela. Fade leva ao fundo do painel e traz de volta ao tocar
milkdrop-idle-hold = Segurar
milkdrop-idle-fade = Fade
milkdrop-run-focused = Continuar com foco
    .description = O visual continua se mexendo enquanto o painel tiver foco, tocando ou não. Desligado, um quadro segurado fica parado mesmo com o painel em foco
milkdrop-show-name = Mostrar o nome do preset
    .description = Mostrar o nome do preset no canto por alguns segundos quando ele muda
milkdrop-next = Próximo preset
milkdrop-previous = Preset anterior
milkdrop-random = Preset aleatório
milkdrop-open-folder = Abrir a pasta de presets
milkdrop-rescan = Reanalisar
milkdrop-rotation = Rotação
    .description = Quais presets Próximo, Anterior e a troca por tempo percorrem
milkdrop-rotation-all = Todos os presets
milkdrop-empty = Nenhum preset encontrado.
    .description = Coloque um pacote na pasta abaixo e clique em Reanalisar. Estes são os três que valem a pena, todos em projectM-visualizer no GitHub.
milkdrop-packs-hint = Solte os pacotes de presets aqui. Os três que valem a pena são presets-cream-of-the-crop, presets-milkdrop-original e presets-milkdrop-texture-pack, todos no GitHub sob projectM-visualizer.
milkdrop-no-gl = O Milkdrop não conseguiu iniciar.
milkdrop-still-starting = O Milkdrop ainda está iniciando.
milkdrop-still-starting-detail = Aguardando um contexto OpenGL do driver gráfico.
milkdrop-no-frames = O Milkdrop está rodando, mas nenhum quadro chegou.
milkdrop-no-frames-detail = Renderizando em { $renderer }, { $version }. Os detalhes estão no console.
milkdrop-favorite = Preset favorito
milkdrop-favorite-short = Favoritar
milkdrop-favorited = Favoritado
milkdrop-favorites-only = Só favoritos
milkdrop-rotation-favorites = Favoritos ({ $count })
milkdrop-no-favorites = Nada foi marcado ainda, então isto embaralha a biblioteca inteira. Marque um preset na lista, no menu do painel ou na linha Em exibição.
milkdrop-reveal = Mostrar preset na pasta
milkdrop-reveal-short = Mostrar
milkdrop-current = Em exibição
milkdrop-no-preset = Nada carregado ainda
milkdrop-color = Cor
    .description = Preset mantém as cores do arquivo. Tema as inverte para o claro no tema claro. Paleta as pinta com o fundo e o destaque do tema e deixa a cor do álbum de fora. Capa as pinta com a cor da capa que está tocando, com ou sem tema por música
milkdrop-color-preset = Preset
milkdrop-color-theme = Tema
milkdrop-color-palette = Paleta
milkdrop-color-cover = Capa
milkdrop-name-always = Manter o nome na tela
    .description = Manter o nome na tela o tempo todo em vez de alguns segundos
milkdrop-flip-horizontal = Inverter horizontalmente
    .description = Espelha o visual da esquerda para a direita
milkdrop-flip-vertical = Inverter verticalmente
    .description = Espelha o visual de cima para baixo
milkdrop-choose = Escolher preset
milkdrop-picker-title = Escolher preset
milkdrop-picker-backdrop = Fundo
milkdrop-picker-host = Escolhendo para { $host }
milkdrop-view-tree = Árvore
milkdrop-view-grid = Grade
milkdrop-nested = Aninhado
milkdrop-locate-current = Ir para o ativo
milkdrop-load-preset = Carregar preset
milkdrop-unfavorite = Remover dos favoritos
