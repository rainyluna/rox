...
autoeq-placeholder = ヘッドホンやイヤホンを検索 (例: HD 600, AirPods, Zero)...
autoeq-search = AutoEq を検索
autoeq-searching = AutoEq を検索中...
autoeq-loading = AutoEq データベースを読み込み中...
autoeq-none = 「{ $text }」に一致するプロファイルが見つかりません
autoeq-failed = AutoEq エラー: { $reason }
autoeq-apply = 適用
autoeq-applied = 適用済み
autoeq-import-file = プリセットファイルをインポート
eq-flatten = フラットにする
eq-freq-label = 周波数
eq-gain-label = ゲイン
eq-heading = イコライザー
