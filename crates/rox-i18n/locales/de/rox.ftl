...
bookmark-edit-title = Lesezeichen bearbeiten
bookmark-window-title = rox - { $verb }
bookmark-name = Name
bookmark-name-placeholder = Optional, ohne Namen steht die Zeit dafür
bookmark-position = Bei { $time }
bookmark-color = Farbe
bookmark-color-accent = Akzent des Themas
bookmark-color-custom = Eigene...
bookmark-color-red = Rot
bookmark-color-orange = Orange
bookmark-color-yellow = Gelb
bookmark-color-green = Grün
bookmark-color-teal = Türkis
bookmark-color-blue = Blau
bookmark-color-purple = Violett
bookmark-color-pink = Pink
bookmark-save = Speichern
bookmark-hint-before = Drücke
bookmark-hint-key = Eingabe
bookmark-hint-after = zum Speichern
bookmark-menu-play = Ab hier abspielen
bookmark-menu-rename = Umbenennen...
bookmark-menu-color = Farbe
bookmark-menu-move = Zur Abspielposition verschieben
bookmark-menu-remove = Entfernen
...
panel-copy = Kopieren
panel-copy-title = Titel kopieren
panel-copy-artist = Interpret kopieren
panel-copy-album = Album kopieren
panel-copy-filename = Dateinamen kopieren
panel-copy-path = Pfad kopieren
...
playback-item-ab-repeat = A-B-Schleife
playback-item-favourite = Favorit
playback-item-rating = Bewertung
playback-sleep-15 = Nach 15 Minuten stoppen
playback-sleep-30 = Nach 30 Minuten stoppen
playback-sleep-60 = Nach einer Stunde stoppen
playback-sleep-90 = Nach 90 Minuten stoppen
playback-sleep-off = Kein Sleeptimer
playback-sleep-off-remaining = Sleeptimer abbrechen (noch { $minutes } Min.)
playback-sleep-tip = Sleeptimer
playback-sleep-tip-remaining = Sleeptimer, noch { $minutes } Min.
menubar-button-tasks = Aufgaben-Button
menubar-button-sleep = Sleeptimer-Button
menubar-button-rescan = Rescan-Button
...
library-column-rename = Umbenennen...
library-column-rename-reset = Namen zurücksetzen
library-column-rename-name = Spaltenkopf
library-column-rename-note = Wird anstelle des eingebauten Spaltenkopfs gezeigt; leer bringt ihn zurück, ein einzelnes Leerzeichen lässt den Kopf leer
library-sort-on-click = Klick sortiert
    .description = Sortiert per Klick irgendwo im Spaltenkopf statt auf dem Symbol; das Umsortieren einer Spalte braucht dann Alt und Ziehen
library-group-search-results = Suchergebnisse gruppieren
    .description = Die aktuellen Gruppenköpfe während der Suche beibehalten; ausschalten, um Treffer als flache Liste zu zeigen
...
settings-appearance-milkdrop-beat-sensitivity = Beat-Empfindlichkeit
    .description = Wie schnell projectM etwas als Beat zählt. Ein leiser Mix braucht mehr als ein lauter
settings-appearance-milkdrop-color = Farbe
    .description = Preset behält die Farben der Datei. Thema kehrt sie auf dem hellen Thema ins Helle um. Palette malt sie in Hintergrund und Akzent des Themas. Cover malt sie in der Farbe des laufenden Covers, mit oder ohne Song-Theming
settings-appearance-milkdrop-duration = Preset-Dauer
    .description = Wie lange ein Preset bleibt, bevor das nächste kommt
settings-appearance-milkdrop-enabled = Milkdrop-Hintergrund
    .description = Eine Milkdrop-Visualisierung hinter der ganzen App laufen lassen, solange Musik spielt
settings-appearance-milkdrop-error-title = Der Milkdrop-Hintergrund ließ sich nicht starten
settings-appearance-milkdrop-fade-duration = Blenddauer
    .description = Wie lange die Blende dauert, aus bei Pause oder Stopp und wieder ein bei Wiedergabe
settings-appearance-milkdrop-flip-horizontal = Horizontal spiegeln
    .description = Spiegelt das Visual von links nach rechts
settings-appearance-milkdrop-flip-vertical = Vertikal spiegeln
    .description = Spiegelt das Visual von oben nach unten
settings-appearance-milkdrop-fps = Bildrate
    .description = Was der Render-Thread anpeilt. 30 halbiert die Kosten fürs Zurücklesen jedes Bildes, und ein Hintergrund unter Weichzeichner braucht selten mehr
settings-appearance-milkdrop-hard-cuts = Harte Schnitte
    .description = Ein lauter Beat darf direkt zum nächsten Preset schneiden
settings-appearance-milkdrop-idle = Im Leerlauf
    .description = Was das Bild tut, während die Wiedergabe pausiert oder gestoppt ist. Halten lässt das letzte Bild hinter der App stehen. Ausblenden blendet zum Cover-Hintergrund aus und bei Wiedergabe wieder ein
settings-appearance-milkdrop-locked = Preset sperren
    .description = Beim aktuellen Preset bleiben, über Titel und Neustarts hinweg
settings-appearance-milkdrop-preset = Preset
    .description = Welches Preset der Hintergrund zeigt. Geht auch ohne Wiedergabe und bleibt über einen Neustart erhalten
settings-appearance-milkdrop-rotation = Rotation
    .description = Welche Presets Weiter, Zurück und der Zeitwechsel durchlaufen
settings-appearance-milkdrop-scale = Renderskalierung
    .description = Mit welchem Anteil der Fensterauflösung die Visualisierung rendert. Weniger kostet weniger; ein so weicher Hintergrund braucht selten mehr
settings-appearance-milkdrop-strength = Stärke
    .description = Wie weit die Visualisierung über das unscharfe Cover trägt
...
settings-appearance-section-milkdrop = Milkdrop-Hintergrund
...
settings-application-menu-entry = Eintrag im App-Menü
    .description = Ein Starter-Eintrag und die Dateizuordnungen für dieses AppImage, die immer auf den aktuellen Ort der Datei zeigen
...
settings-integrations-ffmpeg-binary = FFmpeg-Binärdatei
    .description = Welches ffmpeg die Umwandlungen übernimmt; leer lassen für das im PATH oder für einen Build im Datenordner von rox
...
settings-integrations-ffmpeg-missing-note-flatpak = Umwandeln bleibt versteckt. Lege einen statischen ffmpeg-Build im Datenordner von rox ab; ein auf dem System installiertes läuft in der Sandbox nicht.
...
settings-integrations-ffmpeg-reveal = Datenordner zeigen
...
settings-integrations-librefm-intro = Verbinde dein Libre.fm-Konto: autorisiere rox im Browser, und gespielte Titel scrobbeln dorthin, sobald sie die Schwelle überschreiten
settings-integrations-listenbrainz-get-token = Token holen
settings-integrations-listenbrainz-intro = Füge das Benutzer-Token von listenbrainz.org/settings ein. Listens gehen raus, sobald ein Titel die Scrobble-Schwelle überschreitet.
settings-integrations-listenbrainz-token-placeholder = Token
settings-integrations-listenbrainz-token-row = Benutzer-Token
...
settings-integrations-scrobble-connect = Verbinden
settings-integrations-scrobble-disconnect = Trennen
settings-integrations-scrobble-finish-connecting = Verbindung abschließen
settings-integrations-scrobble-reconnect = Neu verbinden
settings-integrations-scrobble-status-checking = Token wird geprüft
settings-integrations-scrobble-status-confirming = Bestätige...
settings-integrations-scrobble-status-connected = Verbunden als { $username }
settings-integrations-scrobble-status-failed = Verbindung fehlgeschlagen: { $error }
settings-integrations-scrobble-status-invalid = { $service } hat dieses Token abgelehnt
settings-integrations-scrobble-status-not-connected = Nicht verbunden
settings-integrations-scrobble-status-rejected = { $service } hat die Sitzung abgelehnt, und sie wurde verworfen. Verbinde erneut, um weiter zu scrobbeln
settings-integrations-scrobble-status-requesting = Fordere ein Token an...
settings-integrations-scrobble-status-waiting = Autorisiere rox im Browser, dann schließe die Verbindung ab
settings-integrations-scrobble-threshold = Scrobble-Schwelle
    .description = Wie viel von einem Titel laufen muss, bevor er scrobbelt, an jeden verbundenen Dienst; die Suchleiste und die Wellenform können die Schwelle markieren
settings-integrations-scrobble-tracks = Titel scrobbeln
    .description = Gespielte Titel an jeden verbundenen Dienst senden, sobald sie die Schwelle überschreiten
settings-integrations-scrobble-working = Arbeite...
...
settings-library-portal-hint = Ersetze /path/to durch den Ort, an dem der Ordner wirklich liegt.
settings-library-portal-note = Das funktioniert, ist für eine Bibliothek aber langsam, und rox kann den Ordner nicht auf Änderungen überwachen. Gib rox den echten Ort des Ordners frei, dann entferne ihn und füge ihn erneut hinzu:
settings-library-portal-title = rox erreicht diesen Ordner über das Dateiportal
...
settings-library-tempo-refused = { $count ->
    [one] . Bei 1 Titel konnte rox keinen Beat zählen, „Fehlende analysieren“ lässt ihn liegen
   *[other] . Bei { $count } Titeln konnte rox keinen Beat zählen, „Fehlende analysieren“ lässt sie liegen
}
settings-library-tempo-retry = Abgelehnte erneut versuchen
settings-library-tempo-status-measured = Alle { $total } eingelesenen Titel haben ein Tempo, { $measured } davon von rox ermittelt
settings-library-tempo-status-measured-some = { $covered } von { $total } eingelesenen Titeln haben ein Tempo, { $measured } davon von rox ermittelt
settings-library-tempo-status-none = { $total ->
    [one] Der eine eingelesene Titel sagt nicht, wie schnell er läuft. „Fehlende analysieren“ ermittelt es
   *[other] Keiner der { $total } eingelesenen Titel sagt, wie schnell er läuft. „Fehlende analysieren“ ermittelt es
}
settings-library-tempo-status-partial = { $covered } von { $total } eingelesenen Titeln haben ein Tempo, { $measured } davon von rox ermittelt. „Fehlende analysieren“ arbeitet die übrigen { $missing } ab
settings-library-tempo-status-tagged = Alle { $total } eingelesenen Titel haben ein Tempo-Tag
settings-library-tempo-status-tagged-some = { $covered } von { $total } eingelesenen Titeln haben ein Tempo-Tag
...
settings-show-readings = Lesungen anzeigen
    .description = Die romanisierte Lesung hinter einen Namen setzen, der in einer Schrift steht, die dieses Alphabet nicht aussprechen kann: 秋ノ風 (Aki no kaze). Die Lesung ist der Sortiername, den der Wert ohnehin trägt, also zeigt ein Name ohne einen nichts, und ein lateinischer Name bekommt nie eine
...
settings-dictionary-download-failed = Das Wörterbuch konnte nicht heruntergeladen werden: { $reason }
settings-dictionary-downloading = Lade das Wörterbuch herunter: { $done } von { $total }
settings-dictionary-heading = Romanisierung
settings-dictionary-stopping = Stoppe den Download des Wörterbuchs...
...
settings-providers-acoustid = AcoustID
    .description = Einen Fingerabdruck des Audios nehmen und acoustid.org fragen, welche Aufnahme das ist; der Erkennen-Knopf im Metadaten-Vergleich findet auch für eine Datei mit völlig falschen Tags die Veröffentlichung
settings-providers-acoustid-key = AcoustID-Schlüssel
settings-providers-acoustid-key-hint = Optional; dieser Build bringt einen eigenen Schlüssel mit
settings-providers-acoustid-key-placeholder = Anwendungsschlüssel
...
settings-storage-looks-layouts = Erscheinungsbilder und Layouts
    .description = Das Erscheinungsbild, das die App gerade verwendet (workspace.json), mit deinen gespeicherten Arbeitsflächen und ausgeworfenen Shader-Dateien daneben. Klein, und jedes Byte davon ist etwas, das du eingerichtet hast
...
tasks-tempo-counted = { $count ->
    [one] 1 Titel hat ein Tempo
   *[other] { $count } Titel haben ein Tempo
}
...
tasks-tempo-refused = { $count ->
    [one] Bei 1 Titel konnte rox keinen Beat zählen
   *[other] Bei { $count } Titeln konnte rox keinen Beat zählen
}
tasks-timing = Zähle { $progress }
tasks-filling = Wird gefüllt { $progress }
tasks-job-sortnames = Sortiernamen
tasks-sortnames-all = Alle { $count } Interpreten haben einen Sortiernamen
tasks-sortnames-non-latin = , davon { $count } nicht in lateinischer Schrift, { $estimate }
tasks-sortnames-nothing = Noch nichts eingelesen zum Nachschlagen
tasks-sortnames-partial = { $missing } von { $total } Interpreten haben keinen Sortiernamen
tasks-start-fill-missing = Fehlende füllen
tasks-job-romanize = Romanisieren
tasks-reading-takes = , das Lesen dauert { $estimate }
tasks-romanize-all = { $count ->
    [one] Der eine Titel, das Album oder der Interpret hat einen Sortiernamen
   *[other] Alle { $count } Titel, Alben und Interpreten haben einen Sortiernamen
}
tasks-romanize-nothing = Noch nichts eingelesen zum Lesen
tasks-romanize-partial = { $missing } von { $total } Titeln, Alben und Interpreten haben keinen Sortiernamen
tasks-romanizing = Wird gelesen { $progress }
tasks-romanize-skipped = { $count } wurden mangels japanischem Wörterbuch übersprungen
tasks-romanize-skipping = { $kanji } davon sind Kanji und brauchen das japanische Wörterbuch unter Einstellungen > Bibliothek
tasks-start-romanize = Romanisieren
tasks-tip = Bibliotheksaufgaben öffnen
tasks-window-title = rox - Aufgaben
tasks-working-out-missing = Ermittle, was fehlt...

## Stats window
stats-bars-daily = Tagesbalken, ein Klick öffnet den Tag
stats-bars-days = { $days }-Tage-Balken, ein Klick öffnet den Zeitraum
stats-bars-hourly = Stundenbalken, die nächste Ansicht
stats-bars-hours = { $hours }-Stunden-Balken, ein Klick öffnet den Tag
stats-bars-weekly = Wochenbalken, ein Klick öffnet die Woche
stats-bucket-listens = { $count ->
    [one] { $count } Hörvorgang, { $ago } ({ $date })
   *[other] { $count } Hörvorgänge, { $ago } ({ $date })
}
stats-chart-end-day = Mitternacht
...
health-caption-art = { $albums } von { $total }, { $tracks }
health-caption-duplicates = { $groups } auf { $tracks }
health-caption-formats = { $unwritable } von { $total }
health-caption-gaps = { $albums } von { $total }
health-caption-missing = { $missing } fehlend von { $total }
health-caption-sort = Albuminterpreten { $album_artists }, Alben { $albums }, Titel { $titles }
health-caption-split = { $tagged } getaggt, { $measured } gemessen, { $missing } fehlend
health-caption-split-refused = { $tagged } getaggt, { $measured } gemessen, { $missing } fehlend, { $refused } ohne Beat
health-checks-menu = Gezählte Tags
    .description = Welche der fünf Kern-Tags die Anzeige zählt; die Liste beim Überfahren zeigt immer alle
health-click-opens = Klick öffnet Bibliothekszustand
health-click-section = Klick
health-complete = Nichts fehlt
health-count-groups = { $count ->
    [one] { $count } Gruppe
   *[other] { $count } Gruppen
}
health-desc-acoustic = Titel ohne akustischen Fingerabdruck, für sie lässt sich also nichts Ähnlichklingendes finden.
health-desc-art = Alben ohne Cover, weder in den Dateien eingebettet noch als Bild daneben.
health-desc-duplicates = Gruppen von Titeln mit gleichem Interpreten, gleichem Titel und ungefähr gleicher Länge.
health-desc-gaps = Alben, deren Titelnummern eine Nummer überspringen oder bei denen ein Titel gar keine hat.
health-desc-genre = Titel, deren Dateien kein Genre tragen.
health-desc-rating = Titel, die du noch nicht bewertet hast.
...
health-fix-duplicates = Duplikate öffnen
health-fix-genres = Genres taggen
health-fix-measure = Fehlende messen
health-fix-fill = Fehlende füllen
health-measuring-art = Prüfe Album-Cover, { $done } von { $total }
health-measuring-duplicates = Gleiche Duplikate ab
health-measuring-formats = Lese Dateiformate
health-measuring-gaps = Prüfe Titelnummern
health-open = Bibliothekszustand öffnen
health-open-on-click = Bei Klick Bibliothekszustand öffnen
    .description = Auf das Widget klicken, um das Fenster mit dem Bibliothekszustand zu öffnen, wo die Abdeckung aufgeschlüsselt wird
health-overview-complete = { $complete } von { $total } vollständig getaggt
health-overview-missing = { $missing } fehlend
health-readout-section = Anzeige
health-running = Läuft
health-section-audio = Audio
health-section-files = Dateien und Struktur
health-section-overview = Übersicht
health-section-tags = Tags
health-show-percent = Prozentsatz anzeigen
    .description = Die Abdeckung neben das Symbol zeichnen; ausgeschaltet bleibt ein nacktes Symbol, die Zahlen kommen beim Überfahren
health-tile-acoustic = Akustische Vektoren
health-tile-album = Album
health-tile-art = Album-Cover
health-tile-artist = Interpret
health-tile-duplicates = Duplikate
health-tile-gaps = Album-Lücken
health-tile-genre = Genre
health-tile-rating = Bewertung
health-tile-replaygain = ReplayGain
health-tile-sort-names = Sortiernamen
health-tile-tempo = Tempo
health-tile-writable = Nicht unterstützt
health-tile-year = Jahr
health-tile-title = Titel
health-tooltip-missing = Fehlende Tags
health-waiting = Wartet
health-widget-title = Zustands-Widget
health-window-title = rox - Bibliothekszustand

## Power search window

search-seed-caption = { $source }: { $count }
search-window-title = rox - Erweiterte Suche
...
welcome-menu-add = Zum App-Menü hinzufügen
welcome-menu-failed = Der Menüeintrag konnte nicht angelegt werden
welcome-menu-not-now = Jetzt nicht
welcome-menu-note = Ein AppImage registriert sich nicht selbst. Das legt einen Starter-Eintrag und die Zuordnungen für Audiodateien an; außerhalb deines Home-Ordners ändert sich nichts.
welcome-menu-title = rox zum App-Menü hinzufügen?
...
autoeq-placeholder = Kopfhörer oder In-Ears suchen (z. B. HD 600, AirPods, Zero)...
autoeq-search = AutoEq durchsuchen
autoeq-searching = AutoEq wird durchsucht...
autoeq-loading = AutoEq-Datenbank wird geladen...
autoeq-none = Keine Kopfhörerprofile stimmen mit „{ $text }“ überein
autoeq-failed = AutoEq-Fehler: { $reason }
...
keymap-open-preset-picker = Hintergrund-Presets
    .description = Die Milkdrop-Preset-Auswahl für den Hintergrund öffnen
...
keymap-open-health = Bibliothekszustand
    .description = Öffnet das Fenster für den Bibliothekszustand, in dem die Tag-Abdeckung und die strukturellen Lücken gezählt werden
keymap-open-power-search = Erweiterte Suche
    .description = Öffnet ein Suchfenster mit eigener Abfrage, sodass eine Suche hier den Arbeitsbereich unberührt lässt
...
keymap-ab-repeat = A-B-Schleife
    .description = A markieren, dann B, dann löschen
keymap-ab-clear = Clear A-B Section
    .description = Drop the A-B section and any half-marked step with it
keymap-bookmark = Lesezeichen setzen
    .description = Ein Lesezeichen an der Abspielposition setzen
keymap-bookmark-named = Benanntes Lesezeichen setzen
    .description = Ein Lesezeichen an der Abspielposition setzen und benennen
keymap-prev-bookmark = Vorheriges Lesezeichen
...
keymap-toggle-mute = Stumm
    .description = Schaltet die Ausgabe stumm, ohne den Pegel zu verlieren. Erneut drücken holt sie zurück
keymap-toggle-shuffle = Zufall umschalten
    .description = Schaltet die Zufallswiedergabe für die Warteschlange ein oder aus
keymap-cycle-shuffle-mode = Cycle Shuffle Order
    .description = Step the order shuffle sorts by, random or nearest by sound
keymap-cycle-loop = Wiederholen durchschalten
    .description = Schaltet die Wiederholung von aus über alle zu eins und wieder zurück
keymap-toggle-stop-after = Stopp danach
    .description = Lässt den laufenden Titel ausspielen und pausiert dann. Erneut drücken hebt es auf
...
keymap-volume-down = Leiser
    .description = Senkt die Lautstärke um eine Stufe
...
keymap-close-panel = Panel schließen
    .description = Schließt das aktive Panel der fokussierten Panelgruppe
keymap-new-empty-window = Leeres Fenster
    .description = Öffnet ein Arbeitsflächenfenster ohne Inhalt
keymap-open-signals = Signale
    .description = Öffnet das Signalfenster, den Pool hinter den Routen jedes Panels
keymap-import-workspace = Arbeitsfläche importieren
    .description = Wählt eine Arbeitsflächendatei aus und fügt sie der Sammlung hinzu
...
keymap-toggle-quit-to-tray = Im Tray bleiben umschalten
    .description = Legt fest, ob rox beim Schließen des letzten Fensters im Tray weiterläuft
keymap-toggle-design-mode = Entwurfsmodus umschalten
    .description = Legt fest, ob Panels direkt im Layout verschoben werden können
keymap-toggle-theme = Hell / Dunkel umschalten
    .description = Wechselt auf die andere Palettenseite. Überall gebunden, da alle Fenster das Thema teilen
keymap-toggle-resize-lock = Panelgrößen sperren umschalten
    .description = Legt fest, ob Panels nur im Entwurfsmodus ihre Größe ändern
keymap-toggle-menubar = Menüleiste ausblenden umschalten
    .description = Zeigt die Menüleiste im Fenster oder blendet sie aus, bis Alt gehalten wird
keymap-toggle-decorations = Systemdekorationen umschalten
    .description = Wechselt die Arbeitsflächenfenster zwischen dem Systemrahmen und dem eigenen von rox
keymap-toggle-art-theming = Songfarben umschalten
    .description = Legt fest, ob das Cover des laufenden Titels die Palette einfärbt
...
keymap-rescan-library = Bibliothek neu einlesen
    .description = Alle gemerkten Bibliotheksordner erneut einlesen
keymap-abort-scan = Stop Scan
    .description = Stop a running library scan at the next file. What it already indexed stays
keymap-measure-replaygain = ReplayGain messen
    .description = Den Dialog öffnen, der die Lautheit der Titel ohne Messwert misst
keymap-analyze-tempo = Tempo analysieren
    .description = Den Dialog öffnen, der in Titeln ohne BPM nach dem Beat hört
keymap-build-acoustic = Akustische Vektoren erstellen
    .description = Den Dialog öffnen, der die Vektoren für die akustische Suche baut
keymap-fill-sort-names = Sortiernamen füllen
    .description = Den Dialog öffnen, der MusicBrainz nach den Sortiernamen fragt, die in den Dateien fehlen
keymap-romanize-library = Bibliothek romanisieren
    .description = Den Dialog öffnen, der nicht-lateinische Titel, Alben und Interpreten in lateinische Buchstaben überträgt
keymap-find-duplicates = Duplikate finden
    .description = Die Duplikatsuche über der Bibliothek öffnen
keymap-tag-genres = Genres taggen
    .description = Den Genre-Tagger über den Titeln ohne Genre öffnen
...
panel-catalog-health-widget = Zustands-Widget
...
tags-editor-additional-tags = Zusätzliche Tags ({ $count })
tags-editor-remove = entfernen
tags-editor-replace = ersetzen
tags-editor-replace-apply = Anwenden
tags-editor-replace-find = Suchen
tags-editor-replace-help = Jeder Treffer wird ersetzt. Mit Regex fügt $1 die erste Gruppe ein. Ergebnisse werden an den Rändern getrimmt.
tags-editor-replace-ignore-case = Groß- und Kleinschreibung ignorieren
tags-editor-replace-match-count = { $hits ->
    [one] { $hits } von { $total } ändert sich
   *[other] { $hits } von { $total } ändern sich
}
tags-editor-replace-regex = Regex
tags-editor-replace-with = Ersetzen
...
tags-editor-sort-names = Sortiernamen
tags-editor-table-view = Tabelle
tags-editor-tag-columns = Zusätzliche Tags
tags-editor-tag-field-conflict = das Feld { $field } schreibt diesen Tag
tags-editor-tag-key-placeholder = Tagname
tags-editor-tag-value-placeholder = Wert
...
tags-matcher-identify = Per Klang erkennen
tags-matcher-identify-no-duration = Keine Titellänge zum Erkennen vorhanden
...
tag-genres-empty = Jeder Titel hat ein Genre. Spiel etwas ab, um es neu zu taggen.
tag-genres-heading = Genres taggen
tag-genres-input-placeholder = Genre eintippen
tag-genres-keys-hint = 1-8 wählen eine Zeile, Umschalt+1-8 fügen sie dem Feld hinzu, Strg+1-8 für das ganze Album, Enter übernimmt das Getippte, L fragt Last.fm, S überspringt, Strg+Z macht rückgängig
tag-genres-library-loading = Die Bibliothek lädt noch; versuch es gleich nochmal.
tag-genres-no-file = Die Bibliothek hat keine Datei zu diesem Titel.
tag-genres-no-suggestions = Kein Vorschlag; tipp ein Genre ein.
tag-genres-progress = { $at } von { $total } ohne Genre
tag-genres-skip = Überspringen
tag-genres-thinking = Nachbarschaft wird gelesen...
tag-genres-undo = Rückgängig
tag-genres-unwritable = Dieser Titel liegt in einem gemeinsamen Cue-Image, sein Genre lässt sich nicht schreiben. Überspring ihn.
tag-genres-window-title = rox - Genres taggen
tag-genres-looking-up = Frage Last.fm...
tag-genres-lookup = Bei Last.fm nachschlagen
tag-genres-auto-lookup = Automatisch
tag-genres-lookup-found = Last.fm taggt { $artist } als: { $tags }
tag-genres-lookup-none = Last.fm hat keine Tags für { $artist }.
tag-genres-lookup-off = Online-Künstlersuche ist in den Einstellungen aus.
tag-genres-why-acoustic = { $count ->
    [one] { $count } Titel, der ähnlich klingt
   *[other] { $count } Titel, die ähnlich klingen
}
tag-genres-why-album = { $count ->
    [one] { $count } Titel auf diesem Album
   *[other] { $count } Titel auf diesem Album
}
tag-genres-why-artist = { $count ->
    [one] { $count } Titel von diesem Künstler
   *[other] { $count } Titel von diesem Künstler
}
tag-genres-why-lookup = Last.fm
tag-genres-album-too = { $count ->
    [one] Das ganze Album des Titels und seinen { $count } Nachbarn taggen
   *[other] Das ganze Album des Titels und seine { $count } Nachbarn taggen
}
tag-genres-apply = Übernehmen
tag-genres-begin = Warteschlange starten
tag-genres-col-genre = Genre
tag-genres-col-match = Treffer
tag-genres-col-why = Warum
tag-genres-current-genre = Genre: { $genre }
tag-genres-idle = Es läuft nichts. Starte die Warteschlange, um die Titel ohne Genre durchzugehen, oder spiel etwas ab, um es neu zu taggen.
tag-genres-no-genre = Noch kein Genre
tag-genres-stop = Warteschlange beenden
tag-genres-untagged-count = { $count ->
    [one] { $count } Titel ohne Genre
   *[other] { $count } Titel ohne Genre
}
tag-genres-write-error = { $name }: { $error }
tag-genres-writing = Schreibe { $done } von { $total }...
...
pass-tempo-retry-title = { $count ->
   ...
   *[other] { $count } abgelehnte Titel noch einmal abhören?
}
...
pass-fill = Füllen
pass-sortnames-body = Jeder Interpret wird bei MusicBrainz nach der lateinischen Schreibweise nachgeschlagen, unter der er einsortiert wird, damit 米津玄師 unter Y landet. Der Dienst erlaubt eine Anfrage pro Sekunde, und die gibt das Tempo vor. Die Antworten landen in der Bibliotheksdatenbank, deine Dateien werden nie angefasst.
pass-sortnames-scope-all = Auch Namen nachschlagen, die schon lateinisch einsortiert werden
pass-romanize = Romanisieren
pass-romanize-body = Jeder Titel, jedes Album und jeder Interpret ohne Sortiernamen wird in lateinische Buchstaben übertragen, damit レモン über "lemon" gefunden wird. Koreanisch und Chinesisch brauchen dafür nichts. Japanische Kanji brauchen das Wörterbuch unter Einstellungen > Bibliothek, und IPADIC liest Namen oft genug falsch, dass der Tag-Editor zum Korrigieren da ist. Die Antworten landen in der Bibliotheksdatenbank, deine Dateien werden nie angefasst.
pass-romanize-title = { $count ->
    [one] 1 Namen in lateinische Buchstaben übertragen?
   *[other] { $count } Namen in lateinische Buchstaben übertragen?
}
pass-romanize-skips-kanji = { $kanji } von { $total } Werten sind Kanji und werden übersprungen, bis das japanische Wörterbuch installiert ist. Zu holen unter Einstellungen > Bibliothek.
pass-sortnames-title = { $count ->
    [one] 1 Interpreten nachschlagen?
   *[other] { $count } Interpreten nachschlagen?
}
...
quick-play-syntax-absent = Zeilen ganz ohne Wert
    .example = -year
quick-play-syntax-exclude = Alles außer den Treffern
    .example = -genre:rock
quick-play-syntax-field = Ein Feld festlegen, Werte mit Leerzeichen in Anführungszeichen
    .example = artist:"Daft Punk"
quick-play-syntax-free = Trifft Titel, Interpret, Album-Interpret, Album oder Genre
    .example = daft punk
quick-play-syntax-numeric = Eine Zahl vergleichen; plays:0 und added:<90d gehen genauso
    .example = rating:>=4
quick-play-syntax-title = Suchsyntax
quick-play-syntax-year = Ziffern, ein Präfix nimmt also das ganze Jahrzehnt
    .example = year:199
...
waveform-loudness = Lautheitsband
    .description = Den RMS-Pegel als flacheres Band innerhalb der Spitzenhüllkurve zeichnen
waveform-gradient-mode = Farbquelle
    .description = Woher Hüllkurve und Band ihre Farben nehmen: die Akzentfarbe, der Verlauf des Farbschemas, das Cover, oder ein eigenes Paar
waveform-scrobble-marker = Scrobble-Marke
    .description = Eine dünne Linie dort, wo der Titel als zu Last.fm gescrobbelt gilt
waveform-bookmarks = Lesezeichen
...
shader-edit-here = Bearbeiten
shader-editor-window-title = rox - Shader-Editor
shader-editor-target-screen = Bildschirm-Shader
shader-editor-target-backdrop = Hintergrund-Shader
shader-editor-origin-pool = Ein Workspace-Shader: ein Anwenden erreicht jede Fläche, die ihn nutzt
shader-editor-origin-pool-file = Ein Workspace-Shader mit Arbeitskopie unter { $path }
shader-editor-origin-file = Verknüpft mit { $path }, das beim Anwenden mitgeschrieben wird
shader-editor-origin-inline = Der eigene Quelltext dieser Fläche
shader-editor-apply = Anwenden
shader-editor-revert = Zurücksetzen
shader-editor-close = Schließen
shader-editor-hint-press = Drücke
shader-editor-hint-apply = zum Anwenden
shader-editor-status-unchecked = Noch nichts zu prüfen
shader-editor-status-ok = Kompiliert
shader-editor-status-error = Dieser Shader hat nicht kompiliert:
shader-editor-section-uniforms = Uniforms
shader-editor-section-textures = Texturen
shader-editor-section-slots = Slots
shader-editor-section-signals = Signale
shader-editor-slot-unnamed = Slot { $n }
shader-editor-signals-empty = Der Pool hat noch keine Signale. Leg welche im Signale-Fenster an, dann erscheinen sie hier mit Live-Pegeln.
shader-editor-uniform-time = Sekunden, die der Shader läuft, eingefroren solange der Feed steht
shader-editor-uniform-delta = Sekunden seit seinem letzten Frame, 0 beim ersten
shader-editor-uniform-resolution = Die Fläche in Gerätepixeln
shader-editor-uniform-mouse = xy der Cursor in Gerätepixeln, z und w die Tasten
shader-editor-uniform-meta-0 = x Lautstärke, y Titelposition, z spielt, w Titellänge in Sekunden
shader-editor-uniform-meta-1 = x Seitenhelligkeit, y helles Theme, z Cursor-Präsenz, w Inhaltsform
shader-editor-texture-screen = Was in diesem Frame unter der Fläche liegt
shader-editor-texture-prev = Der letzte Frame dieser Fläche, für Schweife
...
## Metadata panel
metadata-copy-field = { $field } kopieren
metadata-cover-background = Cover-Hintergrund
    .description = Das Cover des Titels hinter den Feldern
metadata-cover-opacity = Cover-Deckkraft
    .description = Wie stark das Cover hinter den Feldern durchscheint
...
metadata-field-album-artist-sort = Album-Interpreten-Sortierung
metadata-field-album-sort = Albumsortierung
metadata-field-artist-sort = Interpretensortierung
metadata-field-bit-depth = Bittiefe
metadata-field-bitrate = Bitrate
metadata-field-bookmarks = Lesezeichen
metadata-field-bpm-measured = { $bpm } (von rox gemessen)
...
metadata-field-folder = Ordner
metadata-field-gain-album = Album-Gain
metadata-field-gain-track = Titel-Gain
metadata-field-last-played = Zuletzt gespielt
metadata-field-lastfm-listeners = Hörer weltweit
metadata-field-lastfm-loved = Auf Last.fm geliebt
metadata-field-lastfm-plays = Wiedergaben weltweit
metadata-field-lastfm-tags = Last.fm-Tags
metadata-field-lastfm-user-plays = Deine Scrobbles
metadata-field-lyrics = Liedtext
metadata-field-mb-country = Erscheinungsland
metadata-field-mb-date = Erschienen
metadata-field-mb-first-release = Erstveröffentlichung
metadata-field-mb-isrc = ISRC
metadata-field-mb-label = Label
metadata-field-missing = Fehlt
metadata-field-rank = Rang in der Bibliothek
metadata-field-recent-plays = Wiedergaben (30 Tage)
metadata-field-sample-rate = Abtastrate
metadata-field-similar = Ähnliche Titel
metadata-field-size = Größe
metadata-field-title-sort = Titelsortierung
metadata-field-track = Titel
metadata-fields = Felder
    .description = Welche Felder das Blatt auflistet; ein Feld ohne Wert zeigt k. A., und ein Sortiername erscheint nur, wo er abweicht
metadata-find-online = Metadaten online suchen...
metadata-no-library = Keine Bibliothek
metadata-romanize = Romanisieren
metadata-romanize-needs-dictionary = Ein Kanji-Name braucht das japanische Wörterbuch. Zu holen unter Einstellungen > Bibliothek.
metadata-romanize-sort-names = Sortiernamen romanisieren
metadata-row-borders-description = Die Haarlinie unter jeder Zeile der Tabelle
metadata-cover-embedded = Eingebettet, { $px }
metadata-cover-folder = { $file }, { $px }
metadata-hide-empty = Leere Felder ausblenden
    .description = Ein eingeschaltetes Feld ohne Wert weglassen, statt es als k. A. aufzuführen
metadata-loved-no = Nein
metadata-loved-yes = Ja
metadata-lyrics-plain = Nur Text
metadata-lyrics-synced = Synchronisiert
metadata-missing-none = Nichts
metadata-rank-value = Nr. { $rank }
metadata-tags-scope-album = (Album-Tags)
metadata-tags-scope-artist = (Interpreten-Tags)
metadata-track-of = { $track } von { $total }
metadata-value-none = k. A.
...
art-perspective = Perspektive
    .description = Die seitlichen Cover im Winkel darunter drehen; aus bleiben sie flach und quadratisch, der einzige Modus, in dem die Cover-Rundung greift
art-recede = Tiefenhelligkeit
    .description = Wie hell das hinterste Cover im Stapel ist; die Cover davor teilen sich den Weg gleichmäßig
art-spacing = Cover-Abstand
    .description = Wie weit das erste Cover auf jeder Seite vom mittleren sitzt; ab der Hälfte gibt es das mittlere Cover frei und lässt ihm Platz
art-stride = Stapelabstand
    .description = Wie weit die Cover hinter dem ersten auseinanderstehen; das legt auch fest, wie weit ein Ziehen pro Cover läuft
art-visible = Sichtbare Cover
    .description = Wie viele Cover auf jeder Seite des mittleren stehen; das letzte blendet beim Abgang aus
art-tilt = Drehwinkel
    .description = Wie weit sich die seitlichen Cover von dir wegdrehen
...
## Biography panel
biography-active-between = Aktiv { $from } bis { $to }
biography-active-since = Aktiv seit { $from }
biography-background = Hintergrund
    .description = Die Fanart des Interpreten hinter dem Text, gedimmt und nach unten auslaufend
biography-background-opacity = Hintergrund-Deckkraft
    .description = Wie stark die Fanart hinter dem Text durchscheint
biography-cycle = Kopfbilder wechseln
    .description = Banner und Fanart des Interpreten im Kopfbereich mit Überblendung durchlaufen, und mit den Pfeilen, die beim Überfahren erscheinen, von Hand weiterblättern
biography-cycle-interval = Wechselintervall
    .description = Wie lange jedes Kopfbild steht, bevor das nächste einblendet
...
biography-flag = Landesflagge
    .description = Das Land als Flagge zeigen statt als Zwei-Buchstaben-Code
biography-from-lastfm = Von Last.fm
biography-header-banner = Bannerstreifen
    .description = Der breite Logo-Streifen, den TheAudioDB zum Interpreten führt, im Kopfbereich
biography-header-blur = Einpassen mit Weichzeichner
    .description = Bei ausgeschalteten Proportionen das ganze Bild in das Band setzen, über einer weichgezeichneten Fläche seiner selbst, statt es zuzuschneiden
biography-header-fanart = Fanart
    .description = Die 16:9-Fanarts des Interpreten von TheAudioDB, im Kopfbereich
biography-header-height = Kopfbildhöhe
    .description = Die Höhe des Kopfbands in px, und die Obergrenze für eines in eigenen Proportionen
...
biography-header-overlay = Titel auf dem Kopfbild
    .description = Name, Herkunft und Jahre unten über das Kopfbild legen, statt darunter
...
biography-name-source = Name aus
    .description = Welcher Tag den Interpreten nennt: der Interpret des Titels, oder der Album-Interpret bei einer Compilation oder einem Album voller Gäste
...
biography-profile = Herkunft und Jahre
    .description = Ländercode und aktive Jahre, von TheAudioDB
biography-refresh = Aktualisieren
biography-seconds = { $count } s
biography-similar-artists = Ähnliche Interpreten
    .description = Verwandte Interpreten nach Hördaten, als Chips: ein Klick blättert zu ihnen, und ein Suchsymbol an denen, die die Bibliothek hat, wählt sie in der Suche aus
...
biography-top-tracks = Top-Titel
    .description = Die meistgespielten Titel auf Last.fm, ein Klick spielt jeden, den die Bibliothek hat, das Plus reiht ihn ein
biography-top-tracks-count = Anzahl Titel
    .description = Wie viele der Top-Titel gelistet werden
biography-top-tracks-heading = Top-Titel
...
## Track columns
columns-album-artist-sort = Album-Interpreten-Sortierung
columns-album-sort = Albumsortierung
columns-artist-sort = Interpretensortierung
columns-bits = Bits
columns-bpm = BPM
columns-codec = Codec
columns-cover = Cover
...
columns-title-sort = Titelsortierung
...
filter-over-cap = { $count } weitere, zum Eingrenzen suchen
...
playback-ab-clear = A-B löschen
playback-ab-set-a = A setzen
playback-ab-set-b = B setzen
playback-ab-tip-a = A bei { $a }. Nochmal drücken für B
playback-ab-tip-looping = Wiederholt { $a } bis { $b }
playback-ab-tip-off = Den Anfang des Abschnitts markieren, der wiederholt werden soll
...
playback-menu-ab-repeat = A-B-Schleifen-Taste
...
dictionary-summary-lindera-ipadic = Das japanische Wörterbuch hinter den Kanji-Lesungen. Ohne es werden Kana und Hangul weiterhin romanisiert und Chinesisch weiterhin als Pinyin gelesen, ein Titel in Kanji wird aber übersprungen
...
milkdrop-tuning = Feinabstimmung
milkdrop-roots = Preset-Ordner
milkdrop-add-root = Ordner hinzufügen
milkdrop-remove-root = Entfernen
milkdrop-folder = Wo rox sucht
milkdrop-filter-presets = Presets filtern
milkdrop-preset-count = { $count } von { $total } Presets
milkdrop-locked = Preset sperren
    .description = Bei diesem bleiben: kein Wechsel nach Zeit, kein Schnitt auf einen Beat
milkdrop-duration = Preset-Dauer
    .description = Wie lange ein Preset hält, bevor das nächste kommt
milkdrop-beat-sensitivity = Beat-Empfindlichkeit
    .description = Wie schnell projectM etwas als Beat zählt. Ein leiser Mix braucht mehr als ein lauter
milkdrop-hard-cuts = Harte Schnitte
    .description = Ein lauter Beat darf direkt zum nächsten Preset schneiden
milkdrop-fps = Bildrate
    .description = Was der Render-Thread anpeilt. 30 halbiert die Kosten fürs Zurücklesen jedes Bildes
milkdrop-scale = Renderskalierung
    .description = Kleiner als das Panel rendern und hochskalieren. Kostet Schärfe, spart denselben Anteil am Zurücklesen
milkdrop-tint = Albumfarbe
    .description = Dreht die Farbtöne des Bildes zum Cover des laufenden Titels. Null lässt die Farben des Presets, wie sie sind
milkdrop-fade-duration = Blenddauer
milkdrop-idle = Im Leerlauf
    .description = Was das Bild tut, während die Wiedergabe pausiert oder gestoppt ist. Halten lässt das letzte Bild stehen. Ausblenden blendet zum Panel-Hintergrund aus und bei Wiedergabe wieder ein
milkdrop-idle-hold = Halten
milkdrop-idle-fade = Ausblenden
milkdrop-run-focused = Bei Fokus weiterlaufen
    .description = Das Bild läuft weiter, solange das Panel den Fokus hat, ob etwas spielt oder nicht. Aus, bleibt ein gehaltenes Bild auch mit fokussiertem Panel stehen
milkdrop-show-name = Preset-Namen zeigen
    .description = Den Preset-Namen beim Wechsel für ein paar Sekunden in der Ecke zeigen
milkdrop-next = Nächstes Preset
milkdrop-previous = Vorheriges Preset
milkdrop-random = Zufälliges Preset
milkdrop-open-folder = Preset-Ordner öffnen
milkdrop-rescan = Neu einlesen
milkdrop-rotation = Rotation
    .description = Welche Presets Weiter, Zurück und der Zeitwechsel durchlaufen
milkdrop-rotation-all = Alle Presets
milkdrop-empty = Keine Presets gefunden.
    .description = Leg ein Pack in den Ordner unten und klick dann auf Neu einlesen. Das sind die drei, die sich lohnen, alle unter projectM-visualizer auf GitHub.
milkdrop-packs-hint = Preset-Pakete hier ablegen. Die drei lohnenden sind presets-cream-of-the-crop, presets-milkdrop-original und presets-milkdrop-texture-pack, alle auf GitHub unter projectM-visualizer.
milkdrop-no-gl = Milkdrop konnte nicht starten.
milkdrop-still-starting = Milkdrop startet noch.
milkdrop-still-starting-detail = Wartet auf einen OpenGL-Kontext vom Grafiktreiber.
milkdrop-no-frames = Milkdrop läuft, aber es ist noch kein Bild angekommen.
milkdrop-no-frames-detail = Rendert auf { $renderer }, { $version }. Die Details stehen in der Konsole.
milkdrop-favorite = Preset favorisieren
milkdrop-favorite-short = Favorisieren
milkdrop-favorited = Favorit
milkdrop-favorites-only = Nur Favoriten
milkdrop-rotation-favorites = Favoriten ({ $count })
milkdrop-no-favorites = Noch nichts markiert, also mischt das hier die ganze Bibliothek. Markiere ein Preset in der Liste, im Panelmenü oder in der Zeile „Läuft gerade“.
milkdrop-reveal = Preset im Ordner zeigen
milkdrop-reveal-short = Zeigen
milkdrop-current = Läuft gerade
milkdrop-no-preset = Noch nichts geladen
milkdrop-color = Farbe
    .description = Preset behält die Farben der Datei. Thema kehrt sie auf dem hellen Thema ins Helle um. Palette malt sie in Hintergrund und Akzent des Themas und lässt die Albumfarbe weg. Cover malt sie in der Farbe des laufenden Covers, mit oder ohne Song-Theming
milkdrop-color-preset = Preset
milkdrop-color-theme = Thema
milkdrop-color-palette = Palette
milkdrop-color-cover = Cover
milkdrop-name-always = Namen dauerhaft zeigen
    .description = Den Namen dauerhaft stehen lassen statt nur ein paar Sekunden
milkdrop-flip-horizontal = Horizontal spiegeln
    .description = Spiegelt das Visual von links nach rechts
milkdrop-flip-vertical = Vertikal spiegeln
    .description = Spiegelt das Visual von oben nach unten
milkdrop-choose = Preset wählen
milkdrop-picker-title = Preset wählen
milkdrop-picker-backdrop = Hintergrund
milkdrop-picker-host = Auswahl für { $host }
milkdrop-view-tree = Baum
milkdrop-view-grid = Raster
milkdrop-nested = Verschachtelt
milkdrop-locate-current = Zum Aktiven
milkdrop-load-preset = Preset laden
milkdrop-unfavorite = Aus Favoriten entfernen
