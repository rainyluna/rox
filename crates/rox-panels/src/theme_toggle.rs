...
impl ThemeTogglePanel {
    pub fn new(state: AppState, config: ThemeToggleConfig, cx: &mut Context<Self>) -> Self {
        ThemeTogglePanel {
            state,
            config,
...
impl PanelSettings for ThemeTogglePanel {
...
impl EventEmitter<PanelEvent> for ThemeTogglePanel {}

impl Focusable for ThemeTogglePanel {
    fn focus_handle(&self, _cx: &App) -> FocusHandle {
        self.focus.clone()
    }
}

impl Panel for ThemeTogglePanel {
    ...
    fn dropdown_menu(
        ...
        let menu = panel::duplicate_item(
            ...
            |this, _window, cx| {
                ...
                ThemeTogglePanel::new(state, config, cx)
            },
        );
        panel::popout_item(
            menu,
